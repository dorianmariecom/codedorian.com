...
class MastodonOauthTest < ActiveSupport::TestCase
  test "normalizes server origins and rejects unsafe URL components" do
    assert_equal "https://mastodon.social",
                 MastodonOauth.origin(" Mastodon.social ")
    %w[
      http://mastodon.social
      https://user:pass@mastodon.social
      https://mastodon.social/path
      https://mastodon.social?query=1
