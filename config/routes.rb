  ...
  define =
    lambda do
      ...
      resources :programs do
        ...
        collection do
          patch "/schedule_all", to: "program_schedules#schedule_all"
          patch "/reschedule_all", to: "program_reschedules#reschedule_all"
          patch "/unschedule_all", to: "program_unschedules#unschedule_all"
