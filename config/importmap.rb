...
pin "@sentry-internal/browser-utils", to: "@sentry-internal--browser-utils.js" # @10.32.1
pin "@sentry-internal/feedback", to: "@sentry-internal--feedback.js" # @10.32.1
pin "@sentry-internal/replay", to: "@sentry-internal--replay.js" # @10.32.1
pin "@sentry-internal/replay-canvas", to: "@sentry-internal--replay-canvas.js" # @10.32.1
pin "@sentry/browser", to: "@sentry--browser.js" # @10.32.1
pin "@sentry/core", to: "@sentry--core.js" # @10.32.1
