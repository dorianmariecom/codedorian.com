...
pin "@codemirror/commands", to: "@codemirror--commands.js", integrity: true # @6.10.3
pin "@codemirror/language", to: "@codemirror--language.js", integrity: true # @6.12.2
pin "@codemirror/lint", to: "@codemirror--lint.js", integrity: true # @6.9.5
pin "@codemirror/search", to: "@codemirror--search.js", integrity: true # @6.6.0
pin "@codemirror/state", to: "@codemirror--state.js", integrity: true # @6.6.0
pin "@codemirror/view", to: "@codemirror--view.js", integrity: true # @6.40.0
...
pin "@lezer/common", to: "@lezer--common.js", integrity: true # @1.5.1
pin "@lezer/highlight", to: "@lezer--highlight.js", integrity: true # @1.2.3
...
pin "@sentry-internal/feedback",
    to: "@sentry-internal--feedback.js",
    integrity: true # @10.40.0
pin "@sentry-internal/replay",
    to: "@sentry-internal--replay.js",
    integrity: true # @10.40.0
pin "@sentry-internal/replay-canvas",
    to: "@sentry-internal--replay-canvas.js",
    integrity: true # @10.40.0
pin "@sentry/browser", to: "@sentry--browser.js", integrity: true # @10.40.0
pin "@sentry/core", to: "@sentry--core.js", integrity: true # @10.40.0
pin "application", integrity: true
pin "codemirror", integrity: true # @6.0.2
pin "code-lang", integrity: true
...
pin "intl-tel-input", integrity: true # @26.8.0
...
pin "trix", integrity: true # @2.1.16
