...
class SeedLinks < ActiveRecord::Migration[8.1]
  ...
  def links
    [
      ...
      link("navigation", "messages", "messages", 'Current.user.nothing? ? "/guests/me/messages" : "/users/{Current.user.id}/messages"', 4, image_ios: "message.fill", image_android: "chat"),
      ...
      link("navigation", "log in", "se connecter", '"/login/new"', 7, visibility_input: "Current.user.nothing?", image_ios: "person.crop.circle.fill", image_android: "login"),
      link("navigation", "log out", "se déconnecter", '"/session"', 8, visibility_input: "Current.user.something?", image_ios: "rectangle.portrait.and.arrow.right", image_android: "logout", method: "delete"),
      ...
      link("menu", "messages", "messages", 'Current.user.nothing? ? "/guests/me/messages" : "/users/{Current.user.id}/messages"', 4, image_ios: "message.fill", image_android: "chat"),
      ...
      link("menu", "log in", "se connecter", '"/login/new"', 7, visibility_input: "Current.user.nothing?", image_ios: "person.crop.circle.fill", image_android: "login"),
      link("menu", "log out", "se déconnecter", '"/session"', 8, visibility_input: "Current.user.something?", image_ios: "rectangle.portrait.and.arrow.right", image_android: "logout", method: "delete"),
      ...
      link("tabs", "messages", "messages", '"/users/{Current.user.id}/messages"', 3, visibility_input: "Current.user.something? && Current.user.simple?", image_ios: "message.fill", image_android: "chat", default: true),
      ...
      link("tabs", "log in", "se connecter", '"/login/new"', 6, visibility_input: "Current.user.nothing?", image_ios: "person.crop.circle.fill", image_android: "login")
    ]
  end

  def link(kind, title_en, title_fr, path_input, position, visibility_input: nil, image_ios:, image_android:, default: false, method: "get")
    {
      kind: kind,
      title_en: title_en,
      title_fr: title_fr,
