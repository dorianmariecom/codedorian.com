...
class CreateSubmissionPrograms < ActiveRecord::Migration[7.1]
  def change
    ...
    add_index(:submission_programs, :submission_id)
    add_index(:submission_programs, :form_schedule_id)
    add_index(:submission_programs, :form_program_id)
    add_index(:submission_programs, :form_delivery_id)
  end
end
