...
unless Rails.env.test?
  Current.with(user: User.admin.first) do
    ...
    links = [
      ...
      link.call("navigation", "messages", "messages", 'Current.user.nothing? ? "/guests/me/messages" : "/users/{Current.user.id}/messages"', 4, image_ios: "message.fill", image_android: "chat"),
      ...
      link.call("navigation", "log in", "se connecter", '"/login/new"', 7, visibility_input: "Current.user.nothing?", image_ios: "person.crop.circle.fill", image_android: "login"),
      ...
      link.call("menu", "messages", "messages", 'Current.user.nothing? ? "/guests/me/messages" : "/users/{Current.user.id}/messages"', 4, image_ios: "message.fill", image_android: "chat"),
      ...
      link.call("menu", "log in", "se connecter", '"/login/new"', 7, visibility_input: "Current.user.nothing?", image_ios: "person.crop.circle.fill", image_android: "login"),
      ...
      link.call("tabs", "messages", "messages", '"/users/{Current.user.id}/messages"', 3, visibility_input: "Current.user.something? && Current.user.simple?", image_ios: "message.fill", image_android: "chat", default: true),
      ...
      link.call("tabs", "log in", "se connecter", '"/login/new"', 6, visibility_input: "Current.user.nothing?", image_ios: "person.crop.circle.fill", image_android: "login")
    ]
