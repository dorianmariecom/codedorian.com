...
ActiveRecord::Schema[8.1].define(version: 2026_09_11_195702) do
  ...
  create_table "countries", force: :cascade do |t|
    ...
    t.boolean "anonymous"
    t.boolean "anycast"
    t.jsonb "asn", default: {}, null: false
    t.boolean "bogon"
    t.jsonb "carrier", default: {}, null: false
    t.string "city"
    ...
    t.boolean "primary", default: false, null: false
    t.jsonb "privacy", default: {}, null: false
  ...
  create_table "deliveries", force: :cascade do |t|
    ...
    t.jsonb "destination_snapshot", default: {}, null: false
    t.string "error_code"
    ...
    t.index ["subscription_id", "event_key", "delivery_destination_id"], name: "index_delivery_event_destination_uniqueness", unique: true
  ...
  create_table "step_executions", force: :cascade do |t|
    ...
    t.bigint "subscription_execution_id", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "steps", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.text "input"
    t.bigint "offset_seconds", default: 0, null: false
    t.bigint "position", default: 0, null: false
    t.bigint "service_id", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "stripe_invoices", force: :cascade do |t|
    t.bigint "amount_due", default: 0, null: false
  ...
  create_table "subscriptions", force: :cascade do |t|
    ...
    t.jsonb "delivery_pricing", default: {}, null: false
    t.bigint "plan_id", null: false
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.text "description"
    t.string "interface", default: "simple", null: false
    t.string "locale"
