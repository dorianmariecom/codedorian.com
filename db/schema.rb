...
ActiveRecord::Schema[8.1].define(version: 2026_07_28_110000) do
  ...
  create_table "submission_deliveries", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.text "value"
    t.index ["form_delivery_id"], name: "index_submission_deliveries_on_form_delivery_id"
    t.index ["submission_section_id"], name: "index_submission_deliveries_on_submission_section_id"
  end
  ...
  create_table "submission_programs", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.text "value"
    t.index ["form_program_id"], name: "index_submission_programs_on_form_program_id"
    t.index ["submission_section_id"], name: "index_submission_programs_on_submission_section_id"
  end
  ...
  create_table "submission_schedules", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.text "value"
    t.index ["form_schedule_id"], name: "index_submission_schedules_on_form_schedule_id"
    t.index ["submission_section_id"], name: "index_submission_schedules_on_submission_section_id"
  end
