// intl-tel-input/build/js/utils.js@25.5.2 downloaded from https://ga.jspm.io/npm:intl-tel-input@25.5.2/build/js/utils.js
...
(function () {
  ...
  function $($, t) {
    ...
    $[0] in e ||
      ...
      e.execScript("var " + $[0]);
    for (var n; $.length && (n = $.shift()); )
      $.length || void 0 === t
        ? (e = e[n] && e[n] !== Object.prototype[n] ? e[n] : (e[n] = {}))
        : (e[n] = t);
  }
  function t(d, $) {
    function t() {}
  ...
  var n = class {
      constructor(d) {
        if (r !== r) throw Error("SafeUrl is not meant to be built directly");
        this.g = d;
      }
      toString() {
  ...
  function E(d, $) {
    for (var t = S(d.m()), e = 0; e < t.length; e++) {
      var n = t[e],
        r = n.g;
      if (T($, r)) {
        d.g && delete d.g[n.g];
        ...
        if (n.l) {
          n = I($, r);
          for (var o = 0; o < n.length; o++) b(d, r, i ? n[o].clone() : n[o]);
        } else
          (n = y($, r)),
            i ? ((i = y(d, r)) ? E(i, n) : v(d, r, n.clone())) : v(d, r, n);
      }
    }
  }
  m.prototype.clone = function () {
    var d = new this.constructor();
    d != this && ((d.h = {}), d.g && (d.g = {}), E(d, this));
    return d;
  };
  function T(d, $) {
    return null != d.h[$];
  ...
  function y(d, $) {
    ...
    if (d.l) {
      if (!($ in d.g)) {
        ...
        if (null != t)
          if (n.l) {
            for (var r = [], i = 0; i < t.length; i++) r[i] = e.h(n, t[i]);
            t = r;
          } else t = e.h(n, t);
        return (d.g[$] = t);
      }
  ...
  function N(d, $) {
    return d.j[$].l ? (T(d, $) ? d.h[$].length : 0) : T(d, $) ? 1 : 0;
  }
  function v(d, $, t) {
    d.h[$] = t;
    d.g && (d.g[$] = t);
  ...
  function R(d, $) {
    var t,
      e = [];
    for (t in $) 0 != t && e.push(new u(t, $[t]));
    return new C(d, e);
  }
  function G() {}
  G.prototype.g = function (d) {
    new d.h();
    throw Error("Unimplemented");
  };
  G.prototype.h = function (d, $) {
    if (11 == d.h || 10 == d.h)
      return $ instanceof m ? $ : this.g(d.s.prototype.m(), $);
    if (14 == d.h)
  ...
  B.prototype.h = function (d, $) {
    return 8 == d.h ? !!$ : G.prototype.h.apply(this, arguments);
  };
    ...
    d ||
      (F = d =
        R(D, {
          ...
          1: { name: "general_desc", i: 11, type: U },
          2: { name: "fixed_line", i: 11, type: U },
          3: { name: "mobile", i: 11, type: U },
          4: { name: "toll_free", i: 11, type: U },
          5: { name: "premium_rate", i: 11, type: U },
          6: { name: "shared_cost", i: 11, type: U },
          7: { name: "personal_number", i: 11, type: U },
          8: { name: "voip", i: 11, type: U },
          21: { name: "pager", i: 11, type: U },
          25: { name: "uan", i: 11, type: U },
          27: { name: "emergency", i: 11, type: U },
          28: { name: "voicemail", i: 11, type: U },
          29: { name: "short_code", i: 11, type: U },
          30: { name: "standard_rate", i: 11, type: U },
          31: { name: "carrier_specific", i: 11, type: U },
          33: { name: "sms_services", i: 11, type: U },
          24: { name: "no_international_dialling", i: 11, type: U },
    ...
    d ||
      (Z = d =
        R(V, {
          ...
          6: { name: "country_code_source", i: 14, defaultValue: 0, type: H },
          7: { name: "preferred_domestic_carrier_code", i: 9, type: String },
        }));
    return d;
  };
  V.ctor = V;
  V.ctor.m = V.prototype.m;
  var W = {
  ...
  var J = {
    ...
    k = RegExp("[+＋]+"),
    z = RegExp("^[+＋]+"),
    q = RegExp("([0-9０-９٠-٩۰-۹])"),
    dd = RegExp("[+＋0-9０-９٠-٩۰-۹]"),
    $d = /[\\\/] *x/,
    td = RegExp("[^0-9０-９٠-٩۰-۹A-Za-z#]+$"),
    ed = /(?:.*?[A-Za-z]){3}.*/,
    nd = RegExp(
  ...
  var ad = new RegExp("(?:" + od() + ")$", "i"),
    ...
    gd = /^\(?\$1\)?$/;
  function sd(d) {
    return !(2 > d.length) && Ud(ud, d);
  }
  function hd(d) {
    return Ud(ed, d) ? pd(d, Q) : pd(d, J);
  }
  function cd(d) {
    var $ = hd(d.toString());
    x(d);
  ...
  function fd(d) {
    return null != d && (1 != N(d, 9) || -1 != I(d, 9)[0]);
  }
  function pd(d, $) {
    for (var t, e = new O(), n = d.length, r = 0; r < n; ++r)
      (t = d.charAt(r)), (t = $[t.toUpperCase()]), null != t && e.g(t);
    return e.toString();
  }
  function Cd(d) {
    return 0 == d.length || gd.test(d);
  }
  function Sd(d) {
    return null != d && isNaN(d) && d.toUpperCase() in Y;
  }
  j.prototype.format = function (d, $) {
    if (0 == M(d, 2) && T(d, 5)) {
      var t = A(d, 5);
    ...
    t = A(d, 1);
    var e = Ed(d);
    if (0 == $) return Td(t, 0, e, "");
    if (!(t in W)) return e;
    var n = md(this, t, Rd(t));
    d =
      T(d, 3) && 0 != M(d, 3).length
        ? 3 == $
          ? ";ext=" + M(d, 3)
          : T(n, 13)
            ? M(n, 13) + A(d, 3)
        ...
        : "";
    d: {
      n = 0 == I(n, 20).length || 2 == $ ? I(n, 19) : I(n, 20);
      for (var r, i = n.length, o = 0; o < i; ++o) {
        r = n[o];
        var a = N(r, 3);
        if (
          (0 == a || 0 == e.search(M(r, 3, a - 1))) &&
          ((a = new RegExp(M(r, 1))), Ud(a, e))
        ) {
          n = r;
          break d;
        }
  ...
  function Ed(d) {
    if (!T(d, 2)) return "";
    var $ = "" + M(d, 2);
    return T(d, 4) && M(d, 4) && 0 < A(d, 8)
      ? Array(A(d, 8) + 1).join("0") + $
      : $;
  }
  function Td(d, $, t, e) {
    switch ($) {
  ...
  function Nd(d, $) {
    var t = d.length;
    return !(0 < N($, 9) && -1 == I($, 9).indexOf(t)) && Ud(A($, 2), d);
  }
  function vd(d, $) {
    var t = bd(d, $);
    var e = A($, 1);
    var n = md(d, e, t);
    null == n || ("001" != t && e != Gd(d, t))
      ? (n = !1)
      : ((d = Ed($)), (n = -1 != Ad(d, n)));
    return n;
  }
  ...
  function _d(d, $, t, e) {
    var n = yd(t, e),
      r = 0 == N(n, 9) ? I(M(t, 1), 9) : I(n, 9);
    n = I(n, 10);
    if (2 == e) {
      if (!fd(yd(t, 0))) return _d(d, $, t, 1);
      (d = yd(t, 1)),
        fd(d) &&
          ((r = r.concat(0 == N(d, 9) ? I(M(t, 1), 9) : I(d, 9))),
          r.sort(),
          0 == n.length
            ? (n = I(d, 10))
            : ((n = n.concat(I(d, 10))), n.sort()));
    }
    if (-1 == r[0]) return 5;
    $ = $.length;
    if (-1 < n.indexOf($)) return 4;
    t = r[0];
    return t == $
      ? 0
      : t > $
  ...
  function Od(d, $, t, e, n, r) {
    ...
    var o = $.toString();
    if (0 == o.length) i = 20;
    else if (z.test(o)) (o = o.replace(z, "")), x($), $.g(hd(o)), (i = 1);
    else {
      o = new RegExp(i);
      cd($);
      i = $.toString();
      if (0 == i.search(o)) {
        o = i.match(o)[0].length;
        var a = i.substring(o).match(q);
        a && null != a[1] && 0 < a[1].length && "0" == pd(a[1], J)
          ? (i = !1)
          : (x($), $.g(i.substring(o)), (i = !0));
      } else i = !1;
      i = i ? 5 : 20;
    }
    n && v(r, 6, i);
    ...
    if (
      ...
      (a = $.toString()),
      0 == a.lastIndexOf(o, 0) &&
        ((o = new O(a.substring(o.length))),
        (a = M(t, 1)),
        (a = new RegExp(A(a, 2))),
        xd(o, t, null),
        (o = o.toString()),
        (!Ud(a, $.toString()) && Ud(a, o)) || 3 == _d(d, $.toString(), t, -1)))
    )
      return e.g(o), n && v(r, 6, 10), v(r, 1, i), i;
    v(r, 1, 0);
    return 0;
  }
  function xd(d, $, t) {
    ...
    if (0 != n && null != r && 0 != r.length) {
      var i = new RegExp("^(?:" + r + ")");
      if ((n = i.exec(e))) {
        r = new RegExp(A(M($, 1), 2));
        var o = Ud(r, e),
          a = n.length - 1;
        $ = M($, 16);
        null == $ || 0 == $.length || null == n[a] || 0 == n[a].length
          ? (o && !Ud(r, e.substring(n[0].length))) ||
            (null != t && 0 < a && null != n[a] && t.g(n[1]),
            d.set(e.substring(n[0].length)))
          : ((e = e.replace(i, $)), !o || Ud(r, e)) &&
            (null != t && 0 < a && t.g(n[1]), d.set(e));
      }
    }
  }
  function wd(d, $, t) {
    if (!Sd(t) && 0 < $.length && "+" != $.charAt(0))
      throw Error("Invalid country calling code");
    return Pd(d, $, t, !0);
  }
  function Pd(d, $, t, e) {
    ...
    var n = new O();
    var r = $.indexOf(";phone-context=");
    if (-1 === r) r = null;
    else if (((r += 15), r >= $.length)) r = "";
    else {
      var i = $.indexOf(";", r);
      r = -1 !== i ? $.substring(r, i) : $.substring(r);
    }
    var o = r;
    null == o
      ? (i = !0)
      : 0 === o.length
        ? (i = !1)
        : ((i = nd.exec(o)), (o = rd.exec(o)), (i = null !== i || null !== o));
    if (!i)
      throw Error("The string supplied did not seem to be a phone number");
    null != r
      ? ("+" === r.charAt(0) && n.g(r),
    ...
    r = n.toString();
    i = r.indexOf(";isub=");
    0 < i && (x(n), n.g(r.substring(0, i)));
    if (!sd(n.toString()))
      throw Error("The string supplied did not seem to be a phone number");
    r = n.toString();
    if (!(Sd(t) || (null != r && 0 < r.length && z.test(r))))
      throw Error("Invalid country calling code");
    r = new V();
    e && v(r, 5, $);
    d: {
      $ = n.toString();
      i = $.search(ad);
      if (0 <= i && sd($.substring(0, i))) {
        o = $.match(ad);
        for (var a = o.length, u = 1; u < a; ++u)
    ...
    try {
      ...
      if ("Invalid country calling code" != t.message || !z.test(a)) throw t;
      if (((a = a.replace(z, "")), (o = Od(d, a, i, $, e, r)), 0 == o)) throw t;
    }
    0 != o
      ? ((n = Rd(o)), n != t && (i = md(d, o, n)))
      : (cd(n),
        $.g(n.toString()),
        null != t
          ? ((o = A(i, 10)), v(r, 1, o))
    ...
    null != i &&
      ...
      (n = new O($.toString())),
      xd(n, i, t),
      (d = _d(d, n.toString(), i, -1)),
      2 != d &&
        4 != d &&
        5 != d &&
        (($ = n), e && 0 < t.toString().length && v(r, 7, t.toString())));
    e = $.toString();
    d = e.length;
    if (2 > d)
      throw Error("The string supplied is too short to be a phone number");
    ...
    if (1 < e.length && "0" == e.charAt(0)) {
      v(r, 4, !0);
      for (d = 1; d < e.length - 1 && "0" == e.charAt(d); ) d++;
      1 != d && v(r, 8, d);
    }
    v(r, 2, parseInt(e, 10));
    return r;
  ...
  function Ud(d, $) {
    return !(
      !(d = $.match(
        new RegExp("^(?:" + ("string" == typeof d ? d : d.source) + ")$", "i"),
      )) || d[0].length != $.length
    );
  }
  function Kd(d) {
  ...
  function Hd(d) {
    for (var $ = d.j.length, t = 0; t < $; ++t) {
      ...
      var a = r;
      i = A(i, 2);
      var u = "999999999999999".match(o)[0];
      u.length < a.g.h.length
        ? (a = "")
        : ((a = u.replace(new RegExp(o, "g"), i)),
          (a = a.replace(RegExp("9", "g"), " ")));
      0 < a.length ? (r.v.g(a), (r = !0)) : (r = !1);
      if (r) return (d.da = n), (d.ha = Vd.test(M(e, 4))), (d.$ = 0), !0;
    }
    return (d.u = !1);
  }
  function Wd(d, $) {
    for (var t = [], e = $.length - 3, n = d.j.length, r = 0; r < n; ++r) {
      ...
      0 == N(i, 3)
        ? t.push(d.j[r])
        : ((i = M(i, 3, Math.min(e, N(i, 3) - 1))),
          0 == $.search(i) && t.push(d.j[r]));
    }
    d.j = t;
  }
  function Yd(d, $) {
    d.s.g($);
    var t = $;
    q.test(t) || (1 == d.s.h.length && k.test(t))
      ? ("+" == $ ? ((t = $), d.ba.g($)) : ((t = J[$]), d.ba.g(t), d.g.g(t)),
        ($ = t))
      : ((d.u = !1), (d.la = !0));
    if (!d.u) {
      if (!d.la)
    ...
    switch (d.ba.h.length) {
      ...
      case 2:
        return d.s.toString();
      case 3:
        if (!qd(d)) return (d.o = zd(d)), Qd(d);
        d.ea = !0;
      default:
        if (d.ea) return d$(d) && (d.ea = !1), d.h.toString() + d.g.toString();
        if (0 < d.j.length) {
          $ = $$(d, $);
          t = Jd(d);
          if (0 < t.length) return t;
          Wd(d, d.g.toString());
          return Hd(d) ? kd(d) : d.u ? Xd(d, $) : d.s.toString();
        }
        return Qd(d);
    }
  }
  ...
  function Jd(d) {
    for (var $ = d.g.toString(), t = d.j.length, e = 0; e < t; ++e) {
      ...
      if (
        new RegExp("^(?:" + r + ")$").test($) &&
        ((d.ha = Vd.test(M(n, 4))),
        (n = $.replace(new RegExp(r, "g"), M(n, 2))),
        (n = Xd(d, n)),
        pd(n, X) == d.ba)
      )
        return n;
  ...
  function Qd(d) {
    ...
    if (3 <= $.length) {
      for (
        var t =
            d.ca && 0 == d.o.length && 0 < N(d.l, 20) ? I(d.l, 20) : I(d.l, 19),
          e = t.length,
          n = 0;
        n < e;
        ++n
        ...
        var r = t[n];
        (0 < d.o.length && Cd(A(r, 4)) && !M(r, 6) && !T(r, 5)) ||
          ((0 != d.o.length || d.ca || Cd(A(r, 4)) || M(r, 6)) &&
            Fd.test(A(r, 2)) &&
            d.j.push(r));
      }
      Wd(d, $);
      $ = Jd(d);
      return 0 < $.length ? $ : Hd(d) ? kd(d) : d.s.toString();
    }
    return Xd(d, $);
  }
  function kd(d) {
    var $ = d.g.toString(),
      t = $.length;
    if (0 < t) {
      for (var e = "", n = 0; n < t; n++) e = $$(d, $.charAt(n));
      return d.u ? Xd(d, e) : d.s.toString();
    }
    return d.h.toString();
  }
  function zd(d) {
    var $ = d.g.toString(),
      t = 0;
    if (1 != M(d.l, 10)) var e = !1;
    else
      (e = d.g.toString()),
        (e = "1" == e.charAt(0) && "0" != e.charAt(1) && "1" != e.charAt(1));
    e
      ? ((t = 1), d.h.g("1").g(" "), (d.ca = !0))
      : T(d.l, 15) &&
        ((e = new RegExp("^(?:" + M(d.l, 15) + ")")),
        (e = $.match(e)),
        null != e &&
          null != e[0] &&
          0 < e[0].length &&
    ...
    x(d.g);
    d.g.g($.substring(t));
    return $.substring(0, t);
  }
  function qd(d) {
    var $ = d.ba.toString(),
      t = new RegExp("^(?:\\+|" + M(d.l, 11) + ")");
    t = $.match(t);
    return (
      null != t &&
      null != t[0] &&
  ...
  function d$(d) {
    ...
    d.g.g($.toString());
    $ = Rd(t);
    "001" == $ ? (d.l = Id(d.ga, "" + t)) : $ != d.ka && (d.l = Zd(d, $));
    d.h.g("" + t).g(" ");
    d.o = "";
    return !0;
  }
  ...
  const t$ = (d) => {
      d.includes("FIXED_LINE_OR_MOBILE")
        ? (d.includes("MOBILE") || d.push("MOBILE"),
          d.includes("FIXED_LINE") || d.push("FIXED_LINE"))
        : (d.includes("MOBILE") || d.includes("FIXED_LINE")) &&
          d.push("FIXED_LINE_OR_MOBILE");
    },
    e$ = {
      FIXED_LINE: 0,
      MOBILE: 1,
  ...
  $("intlTelInputUtilsTemp.formatNumberAsYouType", (d, $) => {
    try {
      const t = d.replace(/[^+0-9]/g, ""),
        e = new Kd($);
      $ = "";
      for (let d = 0; d < t.length; d++)
        (e.ja = Yd(e, t.charAt(d))), ($ = e.ja);
      return $;
    } catch {
      return d;
    }
  });
  $("intlTelInputUtilsTemp.formatNumber", (d, $, t) => {
    try {
      const n = j.g(),
        r = wd(n, d, $);
      var e = Ld(n, r, -1);
      return 0 == e || 4 == e
        ? n.format(r, "undefined" === typeof t ? 0 : t)
        : d;
    } catch {
      return d;
    }
  });
  $("intlTelInputUtilsTemp.getExampleNumber", (d, $, t, e) => {
    try {
      const a = j.g();
      d: {
        var n = a;
      ...
      return a.format(o, e ? 0 : $ ? 2 : 1);
    } catch {
      return "";
    }
  });
  $("intlTelInputUtilsTemp.getExtension", (d, $) => {
    try {
      return M(wd(j.g(), d, $), 3);
    } catch {
      return "";
  ...
  $("intlTelInputUtilsTemp.getNumberType", (d, $) => {
    try {
      const t = j.g(),
        e = wd(t, d, $);
      return Md(t, e);
  ...
  $("intlTelInputUtilsTemp.getValidationError", (d, $) => {
    if (!$) return 1;
    try {
      const t = j.g(),
        e = wd(t, d, $);
  ...
  $("intlTelInputUtilsTemp.isPossibleNumber", (d, $, t) => {
    try {
      const e = j.g(),
        n = wd(e, d, $);
      if (t) {
        t$(t);
        for (let d of t) if (0 === Ld(e, n, e$[d])) return !0;
        return !1;
      }
      return 0 === Ld(e, n, -1);
    } catch {
  ...
  $("intlTelInputUtilsTemp.getCoreNumber", (d, $) => {
    try {
      return M(wd(j.g(), d, $), 2).toString();
    } catch {
      return "";
    }
  });
  ...
  $("intlTelInputUtilsTemp.numberType", e$);
  ...
  typeof window !== "undefined"
    ...
    : typeof global !== "undefined"
      ...
      : typeof self !== "undefined"
        ? self
        : void 0;
const $ = d.intlTelInputUtilsTemp;
delete d.intlTelInputUtilsTemp;
export { $ as default };
