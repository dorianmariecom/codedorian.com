// intl-tel-input/build/js/utils.js@25.3.1 downloaded from https://ga.jspm.io/npm:intl-tel-input@25.3.1/build/js/utils.js
...
(function () {
  ...
  function fb(d, $, e, i, a, o) {
    ...
    if (0 == g.length) l = 20;
      ...
      if (0 == l.search(g)) {
        ...
        s && null != s[1] && 0 < s[1].length && "0" == O(s[1], nd)
          ? (l = !1)
  ...
  function hb(d, $, e, i) {
    ...
    try {
      ...
      if (((s = s.replace(ad, "")), (g = fb(d, s, l, $, i, o)), 0 == g))
        throw e;
    }
    0 != g
      ? ((a = S(g)), a != e && (l = R(d, g, a)))
  ...
  function pb(d, $) {
    ...
    od.test(e) || (1 == d.s.h.length && id.test(e))
      ? ("+" == $ ? ((e = $), d.ba.g($)) : ((e = nd[$]), d.ba.g(e), d.g.g(e)),
        ($ = e))
      : ((d.u = !1), (d.la = !0));
    if (!d.u) {
      if (!d.la)
    ...
    switch (d.ba.h.length) {
      ...
      case 2:
        return d.s.toString();
      case 3:
        if (!qb(d)) return (d.o = tb(d)), ub(d);
        d.ea = !0;
      default:
        if (d.ea) return rb(d) && (d.ea = !1), d.h.toString() + d.g.toString();
        if (0 < d.j.length) {
          $ = vb(d, $);
          e = wb(d);
          if (0 < e.length) return e;
          ob(d, d.g.toString());
          return nb(d) ? xb(d) : d.u ? Z(d, $) : d.s.toString();
        }
        return ub(d);
    }
  }
  ...
  function ub(d) {
    ...
    if (3 <= $.length) {
      ...
      ob(d, $);
      $ = wb(d);
      return 0 < $.length ? $ : nb(d) ? xb(d) : d.s.toString();
    }
    return Z(d, $);
  }
  function xb(d) {
    var $ = d.g.toString(),
      e = $.length;
    if (0 < e) {
      for (var i = "", a = 0; a < e; a++) i = vb(d, $.charAt(a));
  ...
  function rb(d) {
    ...
    d.g.g($.toString());
    $ = S(e);
    "001" == $ ? (d.l = T(d.ga, "" + e)) : $ != d.ka && (d.l = jb(d, $));
    d.h.g("" + e).g(" ");
    d.o = "";
    return !0;
  }
  ...
  m("intlTelInputUtilsTemp.isValidNumber", (d, $, e) => {
    try {
      const i = K.g(),
        a = Y(i, d, $),
        o = cb(i, a);
      if (e) {
        const d = e.map((d) => Td[d]);
        return o && d.includes($a(i, a));
      }
      return o;
    } catch {
      return !1;
    ...
    try {
      ...
      if (e) {
        e.includes("FIXED_LINE_OR_MOBILE") &&
          (e.includes("MOBILE") || e.push("MOBILE"),
          e.includes("FIXED_LINE") || e.push("FIXED_LINE"));
        for (let d of e) if (0 === X(i, a, Td[d])) return !0;
        return !1;
      }
      return 0 === X(i, a, -1);
    } catch {
