// intl-tel-input/build/js/utils.js@25.14.1 downloaded from https://ga.jspm.io/npm:intl-tel-input@25.14.1/build/js/utils.js
...
(function () {
  ...
  $("intlTelInputUtilsTemp.isPossibleNumber", (d, $, t) => {
    try {
      ...
      if (t) {
        const d = t$(t);
        for (let $ of d) if (0 === Ld(e, n, e$[$])) return !0;
        return !1;
      }
      return 0 === Ld(e, n, -1);
    } catch {
