...
class CompletionContext {
  ...
  addEventListener(e, t, n) {
    if (e == "abort" && this.abortListeners) {
      ...
      n && n.onDocChange && (this.abortOnDocChange = true);
    }
  }
}
function D(e) {
        ...
        : c > -1
          ...
          : m == f
            ...
            : p == f
              ...
              : t.length == 2
                ? null
                : this.result((l[0] ? -700 : 0) - 200 - 1100, l, e);
  }
  result(e, t, n) {
    let s = [],
      l = 0;
...
const pe = x.fromClass(
  class {
      ...
      if (this.composing != 0)
        for (let t of e.transactions)
          t.isUserEvent("input.type")
            ? (this.composing = 2)
            : this.composing == 2 && t.selection && (this.composing = 3);
    }
    startUpdate() {
      this.debounceUpdate = -1;
      this.pendingStart = false;
    ...
    scheduleAccept() {
      this.running.every((e) => e.done !== void 0)
        ? this.accept()
      ...
      for (let o = 0; o < this.running.length; o++) {
        ...
        if (l && l.isPending)
          if (s.done == null) {
            ...
            for (let t of s.updates) e = e.update(t, n);
    ...
    for (let s of e.split(/\r\n?|\n/)) {
      while (
        ...
        let e = n[1] ? +n[1] : null,
          l = n[2] || n[3] || "",
          r = -1;
        let a = l.replace(/\\[{}]/g, (e) => e[1]);
        for (let n = 0; n < t.length; n++)
          (e != null ? t[n].seq != e : !a || t[n].name != a) || (r = n);
        if (r < 0) {
          let n = 0;
          while (
            n < t.length &&
            (e == null || (t[n].seq != null && t[n].seq < e))
          )
            n++;
