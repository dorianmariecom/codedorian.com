// @codemirror/language@6.12.3 downloaded from https://ga.jspm.io/npm:@codemirror/language@6.12.3/dist/index.js
...
import {
  tagHighlighter as ie,
  highlightTree as ae,
  tags as b,
  styleTags as oe,
} from "@lezer/highlight";
import { StyleModule as se } from "style-mod";
var ce;
const x = /* @__PURE__ */ new e();
function S(e) {
  return s.define({ combine: e ? (t) => t.concat(e) : void 0 });
}
...
class Language {
  ...
  findRegions(n) {
    let r = n.facet(E);
    if (r?.data == this.data) return [{ from: 0, to: n.doc.length }];
    if (!r || !r.allowsNesting) return [];
    let i = [],
      a = (n, r) => {
        if (n.prop(x) == this.data) {
          i.push({ from: r, to: r + n.length });
          return;
        }
        let o = n.prop(e.mounted);
        if (o) {
          if (o.tree.prop(x) == this.data) {
            if (o.overlay)
              for (let e of o.overlay)
                i.push({ from: e.from + r, to: e.to + r });
            else i.push({ from: r, to: r + n.length });
            return;
          } else if (o.overlay) {
            let e = i.length;
            if ((a(o.tree, o.overlay[0].from + r), i.length > e)) return;
          }
        }
...
Language.setState = /* @__PURE__ */ l.define();
function ue(e, t, r) {
  let i = e.facet(E),
    a = C(e).topNode;
  if (!i || i.allowsNesting)
    for (let e = a; e; e = e.enter(t, r, n.ExcludeBuffers | n.EnterBracketed))
      e.type.isTop && (a = e);
  return a;
}
class LRLanguage extends Language {
  ...
  static define(e) {
    ...
    return new LRLanguage(
      t,
      e.parser.configure({ props: [x.add((e) => (e.isTop ? t : void 0))] }),
      e.name,
    );
  }
  configure(e, t) {
...
function C(e) {
  let n = e.field(Language.state, !1);
  return n ? n.tree : t.empty;
}
function de(e, t, n = 50) {
  var r;
  let i = (r = e.field(Language.state, !1))?.context;
  if (!i) return null;
  let a = i.viewport;
...
function fe(e, t = e.doc.length) {
  var n;
  return (n = e.field(Language.state, !1))?.context.isDone(t) || !1;
}
...
function me(e) {
  var t;
  return (t = e.plugin(_e))?.isWorking() || !1;
}
class DocInput {
  constructor(e) {
    (this.doc = e),
...
class ParseContext {
  ...
  work(e, n) {
    return (
      ...
      this.tree != t.empty && this.isDone(n ?? this.state.doc.length)
        ? (this.takeTree(), !0)
        : this.withContext(() => {
            var t;
            if (typeof e == `number`) {
              ...
              if (i)
                if (
                  ((this.fragments = this.withoutTempSkipped(
                    r.addTree(i, this.fragments, this.parse.stoppedAt != null),
                  )),
                  (this.treeLen =
                    (t = this.parse.stoppedAt) ?? this.state.doc.length),
                  (this.tree = i),
                  (this.parse = null),
  ...
  takeTree() {
    ...
    this.parse &&
      ...
      (this.tree = t),
      (this.fragments = this.withoutTempSkipped(
        r.addTree(this.tree, this.fragments, !0),
      )),
      (this.parse = null));
  }
  withContext(e) {
  ...
  withoutTempSkipped(e) {
    for (let t; (t = this.tempSkipped.pop()); ) e = he(e, t.from, t.to);
    return e;
  }
  changes(e, n) {
    let { fragments: i, tree: a, treeLen: o, viewport: s, skipped: c } = this;
    if ((this.takeTree(), !e.empty)) {
      let n = [];
      if (
        (e.iterChangedRanges((e, t, r, i) =>
          n.push({ fromA: e, toA: t, fromB: r, toB: i }),
        ),
        (i = r.applyChanges(i, n)),
        (a = t.empty),
        (o = 0),
        ...
        for (let t of this.skipped) {
          let n = e.mapPos(t.from, 1),
            r = e.mapPos(t.to, -1);
          n < r && c.push({ from: n, to: r });
        }
      }
    }
    return new ParseContext(this.parser, n, i, a, o, s, c, this.scheduleOn);
  }
  updateViewport(e) {
    ...
    for (let t = 0; t < this.skipped.length; t++) {
      ...
      n < e.to &&
        r > e.from &&
        ((this.fragments = he(this.fragments, n, r)),
      ...
      createParse(n, r, i) {
        ...
        return {
          ...
          advance() {
            let n = w;
            if (n) {
              for (let e of i) n.tempSkipped.push(e);
              e &&
...
function he(e, t, n) {
  return r.applyChanges(e, [{ fromA: t, toA: n, fromB: t, toB: n }]);
}
class LanguageState {
  constructor(e) {
...
Language.state = /* @__PURE__ */ u.define({
  ...
  update(e, t) {
    ...
    return t.startState.facet(E) == t.state.facet(E)
      ? e.apply(t)
...
const T =
    typeof navigator < `u` && (ce = navigator.scheduling)?.isInputPending
      ...
      work(e) {
        ...
        let a =
            ...
            Math.min(
              this.chunkBudget,
              100,
              e && !T ? Math.max(25, e.timeRemaining() - 5) : 1e9,
            ),
      ...
      for (let n of e)
        for (let e of n.alias) {
          ...
          if (
            r > -1 &&
            (e.length > 2 ||
              (!/\w/.test(t[r - 1]) && !/\w/.test(t[r + e.length])))
          )
            return n;
        }
    return null;
...
function A(e, t) {
  e instanceof c && (e = new IndentContext(e));
  for (let n of e.state.facet(ve)) {
    let r = n(e, t);
    if (r !== void 0) return r;
  }
  let n = C(e.state);
  return n.length >= t ? be(e, n, t) : null;
}
function ye(e, t, n) {
  let r = Object.create(null),
    i = new IndentContext(e, {
  ...
  for (let o = t; o <= n; ) {
    ...
    s != c &&
      ((r[t.from] = n),
      a.push({ from: t.from, to: t.from + s.length, insert: c }));
  }
  return e.changes(a);
}
class IndentContext {
...
const j = /* @__PURE__ */ new e();
function be(e, t, n) {
  let r = t.resolveStack(n),
    i = t.resolveInner(n, -1).resolve(n, 0).enterUnfinishedNodesBefore(n);
  if (i != r.node) {
    let e = [];
    for (
      let t = i;
...
function xe(e, t, n) {
  for (let r = e; r; r = r.next) {
    let e = Ce(r.node);
    if (e) return e(TreeIndentContext.create(t, n, r));
  }
  return 0;
}
function Se(e) {
...
function Ce(t) {
  ...
  let r = t.firstChild,
    i;
  if (r && (i = r.type.prop(e.closedBy))) {
    let e = t.lastChild,
      n = e && i.indexOf(e.name) > -1;
    return (t) => Oe(t, !0, 1, void 0, n && !Se(t) ? e.from : void 0);
  }
  return t.parent == null ? we : null;
}
function we() {
  return 0;
}
class TreeIndentContext extends IndentContext {
  ...
  continue() {
    return xe(this.context.next, this.base, this.pos);
  }
}
function Te(e, t) {
...
function Ee(e) {
  ...
  let i = e.options.simulateBreak,
    ...
    o = i == null || i <= a.from ? a.to : Math.min(a.to, i);
  for (let e = n.to; ; ) {
...
function De({ closing: e, align: t = !0, units: n = 1 }) {
  return (r) => Oe(r, t, n, e);
}
function Oe(e, t, n, r, i) {
  let a = e.textAfter,
    o = a.match(/^\s*/)[0].length,
    s = (r && a.slice(o, o + r.length) == r) || i == e.pos + o,
    c = t ? Ee(e) : null;
  return c
    ? s
      ? e.column(c.from)
      : e.column(c.to)
    : e.baseIndent + (s ? 0 : e.unit * n);
}
const ke = (e) => e.baseIndent;
function Ae({ except: e, units: t = 1 } = {}) {
  return (n) => {
...
const je = 200;
function Me() {
  return c.transactionFilter.of((e) => {
    if (
      !e.docChanged ||
    ...
    for (let { head: e } of o.selection.ranges) {
      ...
      let r = /^\s*/.exec(t.text)[0],
        i = k(o, n);
      r != i && c.push({ from: t.from, to: t.from + r.length, insert: i });
    }
    return c.length ? [e, { changes: c, sequential: !0 }] : e;
  });
}
const Ne = /* @__PURE__ */ s.define(),
  Pe = /* @__PURE__ */ new e();
function Fe(e) {
  let t = e.firstChild,
    n = e.lastChild;
...
function Ie(e, t, n) {
  ...
  for (let o = i; o; o = o.next) {
    ...
    if (a && i.from < t) break;
    let s = i.type.prop(Pe);
    if (s && (i.to < r.length - 50 || r.length == e.doc.length || !Le(i))) {
      let r = s(i, e);
...
const N = /* @__PURE__ */ l.define({ map: Re }),
  P = /* @__PURE__ */ l.define({ map: Re });
function F(e) {
  let t = [];
    ...
    for (let n of t.effects)
      if (n.is(N) && !Be(e, n.value.from, n.value.to)) {
        let { preparePlaceholder: r } = t.state.facet(V),
          i = r
            ? _.replace({ widget: new PreparedFoldWidget(r(t.state, n.value)) })
            : Xe;
...
function ze(e) {
  return e.field(I, !1) || f.empty;
}
function R(e, t, n) {
  var r;
  let i = null;
  return (
    (r = e.field(I, !1))?.between(t, n, (e, t) => {
...
function z(e, t) {
  return e.field(I, !1) ? t : t.concat(l.appendConfig.of(H()));
}
const Ve = (e) => {
    for (let t of F(e)) {
...
function B(e, t, n = !0) {
  ...
  return g.announce.of(
    `${e.state.phrase(n ? `Folded lines` : `Unfolded lines`)} ${r} ${e.state.phrase(`to`)} ${i}.`,
  );
}
const Ue = (e) => {
    let { state: t } = e,
...
const Ke = (e) => {
  ...
  qe = [
    ...
    { key: `Ctrl-Shift-]`, mac: `Cmd-Alt-]`, run: He },
    { key: `Ctrl-Alt-[`, run: Ue },
    { key: `Ctrl-Alt-]`, run: We },
  ],
  Je = { placeholderDOM: null, preparePlaceholder: null, placeholderText: `…` },
  V = /* @__PURE__ */ s.define({
    combine(e) {
      return ee(e, Je);
    },
...
const Xe = /* @__PURE__ */ _.replace({
  widget: /* @__PURE__ */ new (class extends v {
    toDOM(e) {
      return Ye(e, null);
    }
  })(),
...
function Qe(e = {}) {
    ...
    i = h.fromClass(
      class {
        ...
        update(e) {
          (e.docChanged ||
            e.viewportChanged ||
            e.startState.facet(E) != e.state.facet(E) ||
            e.startState.field(I, !1) != e.state.field(I, !1) ||
            C(e.startState) != C(e.state) ||
            t.foldingChanged(e)) &&
        ...
        buildMarkers(e) {
          ...
          for (let i of e.viewportLineBlocks) {
            let a = R(e.state, i.from, i.to)
              ? r
              : M(e.state, i.from, i.to)
                ? n
                : null;
  ...
  return [
    ...
    re({
      ...
      markers(e) {
        var t;
        return (t = e.plugin(i))?.markers || f.empty;
      },
      initialSpacer() {
        return new FoldMarker(t, !1);
      },
      domEventHandlers: {
        ...a,
        click: (e, t, n) => {
...
const U = /* @__PURE__ */ s.define(),
  et = /* @__PURE__ */ s.define({
    combine(e) {
      return e.length ? [e[0]] : null;
    },
  });
...
function tt(e, t) {
  ...
  return (
    e instanceof HighlightStyle &&
      (e.module && n.push(g.styleModule.of(e.module)), (r = e.themeType)),
    t?.fallback
      ? n.push(et.of(e))
      : r
        ? n.push(
            U.computeN([g.darkTheme], (t) =>
              t.facet(g.darkTheme) == (r == `dark`) ? [e] : [],
            ),
          )
        : n.push(U.of(e)),
    n
...
class TreeHighlighter {
  ...
  update(e) {
    ...
    t.length < i.to && !r && t.type == this.tree.type && a >= i.to
      ...
      ae(
        ...
        (e, t, r) => {
          n.add(
            e,
            t,
            this.markCache[r] || (this.markCache[r] = _.mark({ class: r })),
          );
        },
        r,
        i,
...
const rt = /* @__PURE__ */ m.high(
    /* @__PURE__ */ h.fromClass(TreeHighlighter, {
      decorations: (e) => e.decorations,
    }),
  ),
  it = /* @__PURE__ */ HighlightStyle.define([
    ...
    { tag: /* @__PURE__ */ b.definition(b.variableName), color: `#00f` },
    { tag: /* @__PURE__ */ b.local(b.variableName), color: `#30a` },
    ...
    { tag: /* @__PURE__ */ b.definition(b.propertyName), color: `#00c` },
    { tag: b.comment, color: `#940` },
    { tag: b.invalid, color: `#f00` },
  ]),
  at = /* @__PURE__ */ g.baseTheme({
    "&.cm-focused .cm-matchingBracket": { backgroundColor: `#328c8252` },
    "&.cm-focused .cm-nonmatchingBracket": { backgroundColor: `#bb555544` },
  }),
  ot = 1e4,
  st = `()[]{}`,
  ct = /* @__PURE__ */ s.define({
    combine(e) {
      return ee(e, {
        afterCursor: !0,
        brackets: st,
  ...
  lt = /* @__PURE__ */ _.mark({ class: `cm-matchingBracket` }),
  ut = /* @__PURE__ */ _.mark({ class: `cm-nonmatchingBracket` });
function dt(e) {
  let t = [],
    n = e.matched ? lt : ut;
  return (
...
function ft(e) {
  ...
  for (let r of e.selection.ranges) {
    ...
    let i =
      q(e, r.head, -1, n) ||
      (r.head > 0 && q(e, r.head - 1, 1, n)) ||
      (n.afterCursor &&
        (q(e, r.head, 1, n) ||
          (r.head < e.doc.length && q(e, r.head + 1, -1, n))));
      ...
      update(e) {
        (e.docChanged || e.selectionSet || this.paused) &&
          (e.view.composing
            ? ((this.decorations = this.decorations.map(e.changes)),
              (this.paused = !0))
            : ((this.decorations = ft(e.state)), (this.paused = !1)));
      }
    },
    { decorations: (e) => e.decorations },
  ),
...
const ht = /* @__PURE__ */ new e();
function G(t, n, r) {
  let i = t.prop(n < 0 ? e.openedBy : e.closedBy);
  if (i) return i;
  if (t.name.length == 1) {
    let e = r.indexOf(t.name);
    if (e > -1 && e % 2 == (n < 0 ? 1 : 0)) return [r[e + n]];
  }
  return null;
}
function K(e) {
  let t = e.type.prop(ht);
  return t ? t(e.node) : e;
}
function q(e, t, n, r = {}) {
  let i = r.maxScanDistance || ot,
    a = r.brackets || st,
    o = C(e),
    s = o.resolveInner(t, n);
  for (let r = s; r; r = r.parent) {
    let i = G(r.type, n, a);
    if (i && r.from < r.to) {
      let o = K(r);
      if (o && (n > 0 ? t >= o.from && t < o.to : t > o.from && t <= o.to))
        return gt(e, t, n, r, o, i, a);
    }
  }
  return _t(e, t, n, o, s.type, i, a);
}
  ...
  if (u && (n < 0 ? u.childBefore(r.from) : u.childAfter(r.to)))
    do
      if (n < 0 ? u.to <= r.from : u.from >= r.to) {
        ...
        } else if (G(u.type, n, o)) l++;
        else if (G(u.type, -n, o)) {
          if (l == 0) {
            let e = K(u);
            return {
              start: c,
...
function _t(e, t, n, r, i, a, o) {
  ...
  return u.done ? { start: l, matched: !1 } : null;
}
function vt(e, t, n, r = 0, i = 0) {
...
class StringStream {
  ...
  indentation() {
    var e;
    return (e = this.overrideIndent) ?? vt(this.string, null, this.tabSize);
  }
  match(e, t, n) {
    if (typeof e == `string`) {
      let r = (e) => (n ? e.toLowerCase() : e);
      return r(this.string.substr(this.pos, e.length)) == r(e)
...
function yt(e) {
  return {
    ...
    copyState: e.copyState || bt,
    indent: e.indent || (() => null),
    languageData: e.languageData || {},
    tokenTable: e.tokenTable || Y,
...
class StreamLanguage extends Language {
  ...
  getIndent(e) {
    ...
    n && ((t = xt.get(e.state)), t != null && t < e.pos - 1e4 && (t = void 0));
    let r = J(this, e.node.tree, e.node.from, e.node.from, t ?? e.pos),
      i,
      a;
    if (
      (r
        ? ((a = r.state), (i = r.pos + 1))
        : ((a = this.streamParser.startState(e.unit)), (i = e.node.from)),
      e.pos - i > 1e4)
    )
      return null;
    for (; i < e.pos; ) {
      let t = e.state.doc.lineAt(i),
        r = Math.min(e.pos, t.to);
      if (t.length) {
        let i = n ? n(t.from) : -1,
          o = new StringStream(
            t.text,
        ...
        for (; o.pos < r - t.from; ) wt(this.streamParser.token, o, a);
    ...
    return (
      n && t == null && xt.set(e.state, o.from),
      this.streamParser.indent(a, /^\s*(.*)/.exec(o.text)[1], e)
    );
  }
  get allowsNesting() {
    return !1;
...
function J(e, n, r, i, a) {
  let o = r >= i && r + n.length <= a && n.prop(e.stateAfter);
  if (o) return { state: e.streamParser.copyState(o), pos: r + n.length };
  for (let o = n.children.length - 1; o >= 0; o--) {
    let s = n.children[o],
      c = r + n.positions[o],
      l = s instanceof t && c < a && J(e, s, c, i, a);
    if (l) return l;
  }
  return null;
}
function St(e, n, r, i, a) {
  if (a && r <= 0 && i >= n.length) return n;
  !a && r == 0 && n.type == e.topNode && (a = !0);
  for (let o = n.children.length - 1; o >= 0; o--) {
    let s = n.positions[o],
      c = n.children[o],
      l;
    if (s < i && c instanceof t) {
      if (!(l = St(e, c, r - s, i - s, a))) break;
      return a
        ? new t(
            n.type,
            n.children.slice(0, o).concat(l),
...
function Ct(e, n, r, i, a) {
  for (let t of n) {
    let n = t.from + (t.openStart ? 25 : 0),
      a = t.to - (t.openEnd ? 25 : 0),
      o = n <= r && a > r && J(e, t.tree, 0 - t.offset, r, a),
      s;
    if (
      o &&
      o.pos <= i &&
      (s = St(e, t.tree, r + t.offset, o.pos + t.offset, !1))
    )
      return { state: o.state, tree: s };
  }
  return { state: e.streamParser.startState(a ? O(a) : 4), tree: t.empty };
}
class Parse {
  constructor(e, t, n, r) {
    (this.lang = e),
  ...
  advance() {
    let e = ParseContext.get(),
      ...
      n = Math.min(t, this.chunkStart + 512);
...
`);
  ...
  nextLine() {
    ...
    for (let e = this.rangeIndex; ; ) {
      ...
      if (
        r >= n ||
        ((t = t.slice(0, r - (n - t.length))), e++, e == this.ranges.length)
      )
        break;
  ...
  parseLine(e) {
    let { line: t, end: n } = this.nextLine(),
      ...
      a = new StringStream(t, e ? e.state.tabSize : 4, e ? O(e.state) : 2);
    if (a.eol()) i.blankLine(this.state, a.indentUnit);
    else
      for (; !a.eol(); ) {
        let e = wt(i.token, a, this.state);
        if (
          (e &&
            (r = this.emitToken(
              this.lang.tokenTable.resolve(e),
              this.parsedPos + a.start,
              this.parsedPos + a.pos,
              r,
            )),
          a.start > 1e4)
        )
...
const Ot = /* @__PURE__ */ new TokenTable(Y);
function Q(e, t) {
  Et.indexOf(e) > -1 || (Et.push(e), console.warn(t));
}
function kt(e, t) {
  let n = [];
    ...
    for (let n of r.split(`.`)) {
      ...
      r
        ? typeof r == `function`
          ? t.length
            ? (t = t.map(r))
            : Q(n, `Modifier ${n} used at start of tag`)
          : t.length
            ? Q(n, `Tag ${n} used as modifier`)
            : (t = Array.isArray(r) ? r : [r])
        : Q(n, `Unknown highlighting tag ${n}`);
    }
...
const Ft = /* @__PURE__ */ h.fromClass(
  class {
    ...
    update(e) {
      let t =
        e.state.facet($) ||
        e.view.textDirection != y.LTR ||
        e.state.facet(g.perLineTextDirection);
      if (
        (!t && !this.hasRTL && Nt(e.changes) && (this.hasRTL = !0),
        !t && !this.hasRTL)
      )
        return;
      let n = C(e.state);
      (t != this.always ||
        ...
        ((this.tree = n),
        (this.always = t),
        (this.decorations = It(e.view, n, t)));
    }
  },
  {
    provide: (e) => {
      function t(t) {
        var n, r;
        return (r = (n = t.plugin(e))?.decorations) ?? _.none;
      }
      return [g.outerDecorations.of(t), m.lowest(g.bidiIsolatedRanges.of(t))];
    },
  },
);
function It(t, n, r) {
  let i = new p(),
    a = t.visibleRanges;
  r || (a = Lt(a, t.state.doc));
  for (let { from: t, to: r } of a)
    n.iterate({
      enter: (t) => {
        let n = t.type.prop(e.isolate);
        n && i.add(t.from, t.to, Rt[n]);
      },
      from: t,
      to: r,
    });
      ...
      for (
        ...
        if (
          (!n.lineBreak &&
            ...
            (a && a.to > e - 10
              ? (a.to = Math.min(o, t))
              : i.push((a = { from: e, to: Math.min(o, t) }))),
          t >= o)
        )
          break;
        (r = t), n.next();
...
export {
  ...
  TreeIndentContext,
  Pt as bidiIsolates,
  mt as bracketMatching,
  ht as bracketMatchingHandle,
  H as codeFolding,
  Ae as continuedIndent,
  it as defaultHighlightStyle,
  S as defineLanguageFacet,
  De as delimitedIndent,
  de as ensureSyntaxTree,
  ke as flatIndent,
  Ue as foldAll,
  Ve as foldCode,
  N as foldEffect,
  ...
  q as matchBrackets,
  le as sublanguageProp,
  tt as syntaxHighlighting,
  me as syntaxParserRunning,
  C as syntaxTree,
  fe as syntaxTreeAvailable,
  Ke as toggleFold,
  We as unfoldAll,
  He as unfoldCode,
  P as unfoldEffect,
