import {
  ...
  RangeSet as t,
  MapMode as n,
  findClusterBreak as r,
  EditorSelection as i,
  Facet as a,
  StateEffect as o,
  ChangeSet as s,
  Text as c,
  ...
  combineConfig as _,
  StateField as v,
  RangeSetBuilder as y,
  countColumn as b,
} from "@codemirror/state";
import { StyleModule as x } from "style-mod";
import { keyName as S, base as ee, shift as te } from "w3c-keyname";
import C from "crelt";
let w =
    typeof navigator < `u`
      ? navigator
      : { userAgent: ``, vendor: ``, platform: `` },
  ne = typeof document < `u` ? document : { documentElement: { style: {} } };
const re = /* @__PURE__ */ /Edge\/(\d+)/.exec(w.userAgent),
  ie = /* @__PURE__ */ /MSIE \d/.test(w.userAgent),
  ae = /* @__PURE__ */ /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(
    w.userAgent,
  ),
  oe = !!(ie || ae || re),
  se = !oe && /* @__PURE__ */ /gecko\/(\d+)/i.test(w.userAgent),
  ce = !oe && /* @__PURE__ */ /Chrome\/(\d+)/.exec(w.userAgent),
  le = `webkitFontSmoothing` in ne.documentElement.style,
  ue = !oe && /* @__PURE__ */ /Apple Computer/.test(w.vendor),
  de =
    ue &&
    /* @__PURE__ */ (/Mobile\/\w+/.test(w.userAgent) || w.maxTouchPoints > 2);
var T = {
  mac: de || /* @__PURE__ */ /Mac/.test(w.platform),
  windows: /* @__PURE__ */ /Win/.test(w.platform),
  linux: /* @__PURE__ */ /Linux|X11/.test(w.platform),
  ie: oe,
...
function me(e, t, n) {
  ...
  if (
    ...
    return !1;
  for (let a of r)
    if (a != n && (i.indexOf(a) == -1 || e[a] !== t[a])) return !1;
  return !0;
}
function he(e, t) {
...
function ge(e, t, n) {
  ...
  if (t)
    for (let i in t)
      (n && i in n) ||
        ((r = !0),
        i == `style` ? (e.style.cssText = ``) : e.removeAttribute(i));
  if (n)
    for (let i in n)
      (t && t[i] == n[i]) ||
        ((r = !0),
        i == `style` ? (e.style.cssText = n[i]) : e.setAttribute(i, n[i]));
  return r;
}
function _e(e) {
...
class Decoration extends e {
  ...
  static widget(e) {
    ...
    return (
      ...
      new PointDecoration(e, t, t, n, e.widget || null, !1)
    );
  }
  static replace(e) {
    let t = !!e.block,
    ...
    if (e.isBlockGap) (n = -5e8), (r = 4e8);
      ...
      let { start: i, end: a } = ve(e, t);
      (n = (i ? (t ? -3e8 : -1) : 5e8) - 1),
        (r = (a ? (t ? 2e8 : 1) : -6e8) + 1);
    }
    return new PointDecoration(e, n, r, t, e.widget || null, !0);
  }
  static line(e) {
...
class LineDecoration extends Decoration {
  ...
  eq(e) {
    return (
      ...
      me(this.spec.attributes, e.spec.attributes)
    );
  }
  range(e, t = e) {
...
(LineDecoration.prototype.mapMode = n.TrackBefore),
...
class PointDecoration extends Decoration {
  constructor(e, t, r, i, a, o) {
    super(t, r, a, e),
      (this.block = i),
      (this.isReplace = o),
      (this.mapMode = i ? (t <= 0 ? n.TrackBefore : n.TrackAfter) : n.TrackDel);
  }
  get type() {
...
function ve(e, t = !1) {
  ...
  return (
    n == null && (n = e.inclusive),
    r == null && (r = e.inclusive),
    { start: n == null ? t : n, end: r == null ? t : r }
  );
}
function ye(e, t) {
...
class BlockWrapper extends e {
  ...
  eq(e) {
    return (
      e == this ||
      (e instanceof BlockWrapper &&
        this.tagName == e.tagName &&
        me(this.attributes, e.attributes))
    );
  }
  static create(e) {
...
function be(e) {
  let t;
  return (
    (t = e.nodeType == 11 ? (e.getSelection ? e : e.ownerDocument) : e),
    t.getSelection()
  );
}
function xe(e, t) {
...
function k(e) {
  return e.nodeType == 3
    ? F(e, 0, e.nodeValue.length).getClientRects()
    : e.nodeType == 1
      ? e.getClientRects()
      : [];
}
function A(e, t, n, r) {
  return n ? Ce(e, t, n, r, -1) || Ce(e, t, n, r, 1) : !1;
}
function j(e) {
  ...
  for (;;) {
    ...
    if (t == (i < 0 ? 0 : M(e))) {
      ...
      if (
        ...
        e.nodeType == 1 && e.contentEditable == `false`)
      )
        return !1;
      t = i < 0 ? M(e) : 0;
    } else return !1;
  ...
  for (let u = e, d = !1; u && !d; )
    if (u.nodeType == 1) {
      ...
      if (f) e = we(l);
        ...
        if (
          (/^(fixed|sticky)$/.test(getComputedStyle(u).position) && (d = !0),
      ...
      if (i == `nearest`)
        t.top < e.top + o
          ? ((g = t.top - (e.top + o)),
            n > 0 && t.bottom > e.bottom + g && (g = t.bottom - e.bottom + o))
          : t.bottom > e.bottom - o &&
            ((g = t.bottom - e.bottom + o),
            n < 0 && t.top - g < e.top && (g = t.top - (e.top + o)));
      else {
      ...
      if (
        (r == `nearest`
          ? t.left < e.left + a
            ? ((h = t.left - (e.left + a)),
              n > 0 && t.right > e.right + h && (h = t.right - e.right + a))
            : t.right > e.right - a &&
              ((h = t.right - e.right + a),
              n < 0 && t.left < e.left + h && (h = t.left - (e.left + a)))
          : (h =
              (r == `center`
        ...
        if (f) l.scrollBy(h, g);
          ...
          (t = {
            ...
            e && Math.abs(e - h) < 1 && (r = `nearest`),
            n && Math.abs(n - g) < 1 && (i = `nearest`);
        }
      if (f) break;
      (t.top < e.top ||
        t.bottom > e.bottom ||
...
function De(e, t = !0) {
  let n = e.ownerDocument,
    r = null,
    i = null;
  for (let a = e.parentNode; a && !(a == n.body || ((!t || r) && i)); )
    if (a.nodeType == 1)
      !i && a.scrollHeight > a.clientHeight && (i = a),
        t && !r && a.scrollWidth > a.clientWidth && (r = a),
...
class DOMSelectionState {
  ...
  setRange(e) {
    ...
    this.set(
      t,
      Math.min(e.anchorOffset, t ? M(t) : 0),
      n,
      Math.min(e.focusOffset, n ? M(n) : 0),
    );
  }
  set(e, t, n, r) {
    (this.anchorNode = e),
...
let P = null;
T.safari && T.safari_version >= 26 && (P = !1);
function Oe(e) {
  if (e.setActive) return e.setActive();
  if (P) return e.focus(P);
  let t = [];
  for (
    let n = e;
...
let ke;
function F(e, t, n = t) {
  let r = ke || (ke = document.createRange());
...
function je(e, t) {
  ...
  for (r = Math.min(r, M(n)); ; )
    if (r) {
      if (n.nodeType != 1) return !1;
      let e = n.childNodes[r - 1];
      e.contentEditable == `false` ? r-- : ((n = e), (r = M(n)));
    } else if (n == e) return !0;
    else (r = j(n)), (n = n.parentNode);
}
function Me(e) {
  return e instanceof Window
    ? e.pageYOffset >
        Math.max(0, e.document.documentElement.scrollHeight - e.innerHeight - 4)
    : e.scrollTop > Math.max(1, e.scrollHeight - e.clientHeight - 4);
}
function Ne(e, t) {
  for (let n = e, r = t; ; ) {
    ...
    if (n.nodeType == 1 && r > 0) {
      ...
      (n = n.childNodes[r - 1]), (r = M(n));
    } else if (n.parentNode && !Se(n)) (r = j(n)), (n = n.parentNode);
    else return null;
  }
}
function Pe(e, t) {
  for (let n = e, r = t; ; ) {
    ...
    } else if (n.parentNode && !Se(n)) (r = j(n) + 1), (n = n.parentNode);
    else return null;
  }
}
class DOMPos {
  ...
  static before(e, t) {
    return new DOMPos(e.parentNode, j(e), t);
  }
  static after(e, t) {
    return new DOMPos(e.parentNode, j(e) + 1, t);
  }
}
...
function Ue(e, t, n, r, i) {
  for (let a = 0; a <= r.length; a++) {
    let o = a ? r[a - 1].to : t,
      s = a < r.length ? r[a].from : n,
      c = a ? 256 : i;
    for (let t = o, n = c, r = c; t < s; t++) {
      let i = Be(e.charCodeAt(t));
      i == 512 ? (i = n) : i == 8 && r == 4 && (i = 16),
        (B[t] = i == 4 ? 2 : i),
        i & 7 && (r = i),
        (n = i);
    }
    for (let e = o, t = c, r = c; e < s; e++) {
      let i = B[e];
      if (i == 128)
        e < s - 1 && t == B[e + 1] && t & 24 ? (i = B[e] = t) : (B[e] = 256);
      else if (i == 64) {
        let i = e + 1;
        for (; i < s && B[i] == 64; ) i++;
...
function We(e, t, n, r, i) {
  ...
  for (let o = 0, s = 0, c = 0; o <= r.length; o++) {
    ...
    for (let t = l, n, r, o; t < u; t++)
      if ((r = ze[(n = e.charCodeAt(t))]))
        if (r < 0) {
          for (let e = s - 3; e >= 0; e -= 3)
            if (z[e + 1] == -r) {
              let n = z[e + 2],
                r = n & 2 ? i : n & 4 ? (n & 1 ? a : i) : 0;
              r && (B[t] = B[z[e]] = r), (s = e);
              break;
            }
        } else if (z.length == 189) break;
        else (z[s++] = t), (z[s++] = n), (z[s++] = c);
      else if ((o = B[t]) == 2 || o == 1) {
        let e = o == i;
        c = +!e;
  ...
  for (let i = 0, a = r; i <= n.length; i++) {
    ...
    for (let c = o; c < s; ) {
      ...
      if (o == 256) {
        ...
        let l = a == 1,
          u = l == ((o < t ? B[o] : r) == 1) ? (l ? 1 : 2) : r;
        for (let t = o, r = i, a = r ? n[r - 1].to : e; t > c; )
          t == a && ((t = n[--r].from), (a = r ? n[r - 1].to : e)),
            (B[--t] = u);
        c = o;
      } else (a = o), c++;
    }
...
function Ke(e, t, n, r, i, a, o) {
  ...
  if (r % 2 == i % 2)
    for (let c = t, l = 0; c < n; ) {
      ...
      run: for (;;)
        if (l < a.length && p == a[l].from) {
          ...
          l++,
            d
              ? d.push(m)
              : (m.from > c && o.push(new BidiSpan(c, m.from, f)),
                qe(
                  e,
                  (m.direction == R) == !(f % 2) ? r : r + 1,
                  i,
                  m.inner,
                  m.from,
                  m.to,
      ...
      d ? Ke(e, c, p, r + 1, i, d, o) : c < p && o.push(new BidiSpan(c, p, f)),
        (c = p);
    }
  else
    for (let c = n, l = a.length; c > t; ) {
      ...
      run: for (;;)
        if (l && p == a[l - 1].to) {
          ...
          d
            ? d.push(m)
            : (m.to < c && o.push(new BidiSpan(m.to, c, f)),
              qe(
                e,
                (m.direction == R) == !(f % 2) ? r : r + 1,
                i,
      ...
      d ? Ke(e, p, c, r + 1, i, d, o) : p < c && o.push(new BidiSpan(p, c, f)),
        (c = p);
    }
}
function qe(e, t, n, r, i, a, o) {
  let s = t % 2 ? 2 : 1;
  Ue(e, i, a, r, s), We(e, i, a, r, s), Ge(i, a, r, s), Ke(e, i, a, t, n, r, o);
}
function Je(e, t, n) {
  if (!e) return [new BidiSpan(0, 0, +(t == Fe))];
  if (t == R && !n.length && !Ve.test(e)) return Ye(e.length);
  if (n.length) for (; e.length > B.length; ) B[B.length] = 256;
  let r = [],
    i = t == R ? 0 : 1;
  return qe(e, i, i, n, 0, e.length, r), r;
}
function Ye(e) {
...
function Ze(e, t, n, a, o) {
  var s;
  let c = a.head - e.from,
    l = BidiSpan.find(t, c, (s = a.bidiLevel) == null ? -1 : s, a.assoc),
    u = t[l],
    d = u.side(o, n);
  if (c == d) {
    let e = (l += o ? 1 : -1);
    if (e < 0 || e >= t.length) return null;
    (u = t[(l = e)]), (c = u.side(!o, n)), (d = u.side(o, n));
  }
  let f = r(e.text, c, u.forward(o, n));
  (f < u.from || f > u.to) && (f = d),
    (Xe = e.text.slice(Math.min(c, f), Math.max(c, f)));
  let p = l == (o ? t.length - 1 : 0) ? null : t[l + (o ? 1 : -1)];
  return p && f == d && p.level + +!o < u.level
    ? i.cursor(p.side(!o, n) + e.from, p.forward(o, n) ? 1 : -1, p.level)
    : i.cursor(f + e.from, u.forward(o, n) ? -1 : 1, u.level);
}
function Qe(e, t, n) {
  for (let r = t; r < n; r++) {
    let t = Be(e.charCodeAt(r));
    if (t == 1) return R;
    if (t == 2 || t == 4) return Fe;
  }
  return R;
}
const $e = /* @__PURE__ */ a.define(),
  et = /* @__PURE__ */ a.define(),
  tt = /* @__PURE__ */ a.define(),
  nt = /* @__PURE__ */ a.define(),
  rt = /* @__PURE__ */ a.define(),
  it = /* @__PURE__ */ a.define(),
  at = /* @__PURE__ */ a.define(),
  ot = /* @__PURE__ */ a.define(),
  st = /* @__PURE__ */ a.define(),
  ct = /* @__PURE__ */ a.define({ combine: (e) => e.some((e) => e) }),
  lt = /* @__PURE__ */ a.define({ combine: (e) => e.some((e) => e) }),
  ut = /* @__PURE__ */ a.define();
class ScrollTarget {
...
const dt = /* @__PURE__ */ o.define({ map: (e, t) => e.map(t) }),
  ft = /* @__PURE__ */ o.define();
function V(e, t, n) {
  let r = e.facet(nt);
  r.length
    ? r[0](t)
    : (window.onerror && window.onerror(String(t), n, void 0, void 0, t)) ||
      (n ? console.error(n + `:`, t) : console.error(t));
}
const H = /* @__PURE__ */ a.define({ combine: (e) => (e.length ? e[0] : !0) });
let pt = 0;
const U = /* @__PURE__ */ a.define({
  combine(e) {
    return e.filter((t, n) => {
...
class ViewPlugin {
  constructor(e, t, n, r, i) {
    (this.id = e),
      ...
      (this.extension = this.baseExtensions.concat(
        U.of({ plugin: this, arg: void 0 }),
      ));
  }
  of(e) {
    return this.baseExtensions.concat(U.of({ plugin: this, arg: e }));
  }
  static define(e, t) {
    let {
      eventHandlers: n,
    ...
    return new ViewPlugin(pt++, e, n, r, (e) => {
      let t = [];
      return (
        a &&
          t.push(
  ...
  static fromClass(e, t) {
    return ViewPlugin.define((t, n) => new e(t, n), t);
  }
}
class PluginInstance {
    ...
    if (!this.value) {
      if (this.spec)
        try {
          ...
          V(e.state, t, `CodeMirror plugin crashed`), this.deactivate();
        }
      ...
      if (((this.mustUpdate = null), this.value.update))
        try {
          ...
          if ((V(e.state, t, `CodeMirror plugin crashed`), this.value.destroy))
            try {
              this.value.destroy();
            } catch (e) {}
          this.deactivate();
  ...
  destroy(e) {
    var t;
    if ((t = this.value) != null && t.destroy)
      try {
        this.value.destroy();
      } catch (t) {
        V(e.state, t, `CodeMirror plugin crashed`);
      }
  }
  deactivate() {
...
const mt = /* @__PURE__ */ a.define(),
  ht = /* @__PURE__ */ a.define(),
  gt = /* @__PURE__ */ a.define(),
  _t = /* @__PURE__ */ a.define(),
  vt = /* @__PURE__ */ a.define(),
  W = /* @__PURE__ */ a.define(),
  yt = /* @__PURE__ */ a.define();
function bt(e, n) {
  let r = e.state.facet(yt);
  if (!r.length) return r;
  let i = r.map((t) => (t instanceof Function ? t(e) : t)),
    a = [];
  return (
    t.spans(i, n.from, n.to, {
      point() {},
      span(e, t, r, i) {
        let o = e - n.from,
          s = t - n.from,
        ...
        for (let e = r.length - 1; e >= 0; e--, i--) {
          let t = r[e].spec.bidiIsolate,
            a;
          if (
            (t == null && (t = Qe(n.text, o, s)),
            i > 0 &&
              c.length &&
              (a = c[c.length - 1]).to == o &&
              a.direction == t)
            ...
            let e = { from: o, to: s, direction: t, inner: [] };
            c.push(e), (c = e.inner);
          }
        }
      },
...
const xt = /* @__PURE__ */ a.define();
function St(e) {
  let t = 0,
    n = 0,
    r = 0,
    i = 0;
  for (let a of e.state.facet(xt)) {
    let o = a(e);
    o &&
...
class ChangedRange {
  ...
  static extendWithRanges(e, t) {
    ...
    let n = [];
    for (let r = 0, i = 0, a = 0; ; ) {
      let o = r < e.length ? e[r].fromB : 1e9,
        s = i < t.length ? t[i] : 1e9,
        c = Math.min(o, s);
      if (c == 1e9) break;
      let l = c + a,
        u = c,
      ...
      for (;;)
        if (i < t.length && t[i] <= u) {
          let n = t[i + 1];
          (i += 2), (u = Math.max(u, n));
          for (let t = r; t < e.length && e[t].fromB <= u; t++)
            a = e[t].toA - e[t].toB;
          d = Math.max(d, n + a);
      ...
      n.push(new ChangedRange(l, d, c, u));
    }
    return n;
  }
}
...
class Tile {
  ...
  domPosFor(e, t) {
    ...
    return new DOMPos(this.parent.dom, n + +!!r, e == 0 || e == this.length);
  }
  markDirty(e) {
    (this.flags &= -3),
      e && (this.flags |= 4),
  ...
  get root() {
    for (let e = this; e; e = e.parent) if (e instanceof DocTile) return e;
    return null;
  }
  static get(e) {
    return e.cmTile;
...
class CompositeTile extends Tile {
  ...
  sync(e) {
    ...
    let t = this.dom,
      n = null,
      r,
      i = (e == null ? void 0 : e.node) == t ? e : null,
      a = 0;
    for (let o of this.children) {
      if (
        (o.sync(e),
        (a += o.length + o.breakAfter),
        (r = n ? n.nextSibling : t.firstChild),
        i && r != o.dom && (i.written = !0),
        o.dom.parentNode == t)
      )
        for (; r && r != o.dom; ) r = wt(r);
      else t.insertBefore(o.dom, r);
      n = o.dom;
    }
    for (r = n ? n.nextSibling : t.firstChild, i && r && (i.written = !0); r; )
      r = wt(r);
    this.length = a;
  }
}
...
class DocTile extends CompositeTile {
  ...
  blockTiles(e) {
    for (let t = [], n = this, r = 0, i = 0; ; )
      if (r == n.children.length) {
        ...
        let a = n.children[r++];
        if (a instanceof BlockWrapperTile) t.push(r), (n = a), (r = 0);
        else {
          let t = i + a.length,
            n = e(a, i);
  ...
  resolveBlock(e, t) {
    ...
    return (n && t < 0) || !i ? { tile: n, offset: r } : { tile: i, offset: a };
  }
}
class BlockWrapperTile extends CompositeTile {
  ...
  static of(e, t) {
    let n = new BlockWrapperTile(t || document.createElement(e.tagName), e);
...
class LineTile extends CompositeTile {
  ...
  static start(e, t, n) {
    let r = new LineTile(t || document.createElement(`div`), e);
  ...
  resolveInline(e, t, n) {
    ...
    function s(e, c) {
      for (let l = 0, u = 0; l < e.children.length && u <= c; l++) {
        ...
        f >= c &&
          (d.isComposite()
            ? s(d, c - u)
            : (!a || (a.isHidden && (t > 0 || (n && Et(a, d))))) &&
                (f > c || d.flags & 32)
              ? ((a = d), (o = c - u))
              : (u < c || (d.flags & 16 && !d.isHidden)) &&
                ((r = d), (i = c - u))),
          (u = f);
      }
    }
    s(this, e);
    let c = (t < 0 ? r : a) || r || a;
    return c ? { tile: c, offset: c == r ? i : o } : null;
  }
  coordsIn(e, t) {
    let n = this.resolveInline(e, t, !0);
    return n ? n.tile.coordsIn(Math.max(0, n.offset), t) : Tt(this);
  }
  domIn(e, t) {
    ...
    if (n) {
      ...
      if (this.dom.contains(e.dom))
        return e.isText()
          ? new DOMPos(e.dom, Math.min(e.dom.nodeValue.length, r))
          : e.domPosFor(r, e.flags & 16 ? 1 : e.flags & 32 ? -1 : t);
      let i = n.tile.parent,
        a = !1;
      for (let e of i.children) {
        if (a) return new DOMPos(e.dom, 0);
        e == n.tile && (a = !0);
      }
    }
...
class MarkTile extends CompositeTile {
  ...
  static of(e, t) {
    let n = new MarkTile(t || document.createElement(e.tagName), e);
    return t || (n.flags |= 4), n;
  }
}
class TextTile extends Tile {
  ...
  coordsIn(e, t) {
    ...
    let r = e,
      ...
      a = 0;
    (e == 0 && t < 0) || (e == n && t >= 0)
      ? T.chrome || T.gecko || (e ? (r--, (a = 1)) : i < n && (i++, (a = -1)))
      : t < 0
        ? r--
        : i < n && i++;
    let o = F(this.dom, r, i).getClientRects();
    ...
    return (
      T.safari &&
        !a &&
        s.width == 0 &&
        (s = Array.prototype.find.call(o, (e) => e.width) || s),
      a ? N(s, a < 0) : s || null
    );
  }
  static of(e, t) {
    let n = new TextTile(t || document.createTextNode(e), e);
...
class WidgetTile extends Tile {
  ...
  coordsInWidget(e, t, n) {
    ...
    if (r) return r;
    if (n)
      return N(this.dom.getBoundingClientRect(), this.length ? e == 0 : t <= 0);
    {
  ...
  static of(e, t, n, r, i) {
    return (
      i || ((i = e.toDOM(t)), e.editable || (i.contentEditable = `false`)),
      new WidgetTile(i, n, e, r)
    );
  }
}
...
class TilePointer {
  ...
  advance(e, t, n) {
    ...
    for (; e || t > 0; )
      if (!r.isComposite())
        if (i == r.length)
          (a = !!r.breakAfter), ({ tile: r, index: i } = o.pop()), i++;
        else if (e) {
        ...
        n && n.leave(r),
          (a = !!r.breakAfter),
          ({ tile: r, index: i } = o.pop()),
          i++;
      } else {
        let s = r.children[i],
          c = s.breakAfter;
        (t > 0 ? s.length <= e : s.length < e) &&
        (!n || n.skip(s, 0, s.length) !== !1 || !s.isComposite)
          ? ((a = !!c), i++, (e -= s.length))
          : (o.push({ tile: r, index: i }),
            (r = s),
            (i = 0),
            n && s.isComposite() && n.enter(s));
      }
...
class TileBuilder {
  ...
  addText(e, t, n, r) {
    var i;
    this.flushBuffer();
    let a = this.ensureMarks(t, n),
      o = a.lastChild;
    if (o && o.isText() && !(o.flags & 8) && o.length + e.length < 512) {
      this.cache.reused.set(o, 2);
      let t = (a.children[a.children.length - 1] = new TextTile(
        o.dom,
        o.text + e,
      ));
      t.parent = a;
      ...
      a.append(
        r ||
          TextTile.of(
            e,
            (i = this.cache.find(TextTile)) == null ? void 0 : i.dom,
          ),
      );
  ...
  addComposition(e, t) {
    let n = this.curLine;
    n.dom != t.line.dom &&
      (n.setDOM(this.cache.reused.has(t.line) ? Nt(t.line.dom) : t.line.dom),
      this.cache.reused.set(t.line, 2));
    let r = n;
    for (let e = t.marks.length - 1; e >= 0; e--) {
      let n = t.marks[e],
        i = r.lastChild;
      if (i instanceof MarkTile && i.mark.eq(n.mark))
        i.dom != n.dom && i.setDOM(Nt(n.dom)), (r = i);
      else {
        if (this.cache.reused.get(n)) {
          let e = Tile.get(n.dom);
          e && e.setDOM(Nt(n.dom));
        }
        let e = MarkTile.of(n.mark, n.dom);
        r.append(e), (r = e);
      }
      this.cache.reused.set(n, 2);
    }
    let i = Tile.get(e.text);
    i && this.cache.reused.set(i, 2);
    let a = new TextTile(e.text, e.text.nodeValue);
  ...
  addInlineWidget(e, t, n) {
    ...
    !r && !(e.flags & 16) && i.append(this.getBuffer(1)),
      i.append(e),
      (this.pos += e.length),
      (this.afterWidget = e);
  }
  ...
  addLineStart(e, t) {
    var n;
    e || (e = At);
    let r = LineTile.start(
      e,
      t || ((n = this.cache.find(LineTile)) == null ? void 0 : n.dom),
      !!t,
    );
  ...
  ensureMarks(e, t) {
    ...
    for (let i = e.length - 1; i >= 0; i--) {
      let a = e[i],
        o;
      if (t > 0 && (o = r.lastChild) && o instanceof MarkTile && o.mark.eq(a))
        (r = o), t--;
      else {
        let e = MarkTile.of(
          a,
          (n = this.cache.find(MarkTile, (e) => e.mark.eq(a))) == null
            ? void 0
            : n.dom,
        );
        r.append(e), (r = e), (t = 0);
  ...
  endLine() {
    if (this.curLine) {
      ...
      (!e ||
        ...
        (e.dom.nodeName != `BR` &&
          e.isWidget() &&
          !(T.ios && Ot(this.curLine, !0)))) &&
        this.curLine.append(
          this.cache.findWidget(Pt, 0, 32) ||
            new WidgetTile(Pt.toDOM(), 0, Pt, 32),
        ),
    ...
    for (let e = this.blockWrappers; e.value && e.from <= this.pos; e.next())
      if (e.to >= this.pos) {
        let t = e.rank * 102 + e.value.rank,
          n = new OpenWrapper(e.from, e.to, e.value, t),
          r = this.wrappers.length;
        for (
          ;
          r > 0 &&
  ...
  getBlockPos() {
    ...
    for (let n of this.wrappers) {
      ...
      if (
        n.from < this.pos &&
        r instanceof BlockWrapperTile &&
        r.wrapper.eq(n.wrapper)
      )
        t = r;
      else {
        let r = BlockWrapperTile.of(
          n.wrapper,
          (e = this.cache.find(BlockWrapperTile, (e) =>
            e.wrapper.eq(n.wrapper),
          )) == null
            ? void 0
            : e.dom,
        );
  ...
  getBuffer(e) {
    let t = 2 | (e < 0 ? 16 : 32),
      n = this.cache.find(WidgetBufferTile, void 0, 1);
    return n && (n.flags = t), n || new WidgetBufferTile(t);
  }
  flushBuffer() {
    this.afterWidget &&
...
class TextStream {
  ...
  next(e) {
    ...
    let t = Math.min(this.text.length, this.textOff + e),
      n = this.text.slice(this.textOff, t);
...
for (let e = 0; e < Dt.length; e++) Dt[e].bucket = e;
class TileCache {
  constructor(e) {
    (this.view = e),
      (this.buckets = Dt.map(() => [])),
  ...
  add(e) {
    ...
    n.length < 6
      ? n.push(e)
      : (n[(this.index[t] = (this.index[t] + 1) % 6)] = e);
  }
  find(e, t, n = 2) {
    let r = e.bucket,
      i = this.buckets[r],
    ...
    for (let e = i.length - 1; e >= 0; e--) {
      ...
      if ((!t || t(s)) && !this.reused.has(s))
        return (
          i.splice(o, 1), o < a && this.index[r]--, this.reused.set(s, n), s
        );
    }
    return null;
  }
      ...
      for (let i = 0, a = 0; ; i++) {
        ...
        if (
          ...
          return (
            ...
            o.widget == e && o.length == t && (o.flags & 497) == n
              ? (this.reused.set(o, 1), o)
              : (this.reused.set(o, 2),
                new WidgetTile(o.dom, t, e, (o.flags & -498) | n))
          );
      }
  }
  reuse(e) {
...
class TileUpdate {
  constructor(e, n, r, i, a) {
    (this.view = e),
      (this.decorations = i),
      (this.disallowBlockEffectsFor = a),
      (this.openWidget = !1),
      (this.openMarks = 0),
      (this.cache = new TileCache(e)),
      (this.text = new TextStream(e.state.doc)),
      (this.builder = new TileBuilder(
        this.cache,
        new DocTile(e, e.contentDOM),
        t.iter(r),
      )),
      this.cache.reused.set(n, 2),
      (this.old = new TilePointer(n)),
      (this.reuseWalker = {
        skip: (e, t, n) => {
  ...
  run(e, t) {
    ...
    for (let r = 0, i = 0, a = 0; ; ) {
      let o = a < e.length ? e[a++] : null,
        s = o ? o.fromA : this.old.root.length;
      if (s > r) {
        let e = s - r;
        this.preserve(e, !a, !o), (r = s), (i += e);
      }
      if (!o) break;
      t && o.fromA <= t.range.fromA && o.toA >= t.range.toA
        ? (this.forward(
            o.fromA,
            t.range.fromA,
        ...
        : (this.forward(o.fromA, o.toA), this.emit(i, o.toB)),
        (i = o.toB),
        (r = o.toA);
    }
    ...
    this.old.advance(e, n ? 1 : -1, {
          ...
          if (this.openWidget) this.builder.continueWidget(n - t);
            ...
            let a =
              n > 0 || t < e.length
                ...
                : this.cache.reuse(e);
            a.flags & 256
              ? ((a.flags &= -2), this.builder.addBlockWidget(a))
              : (this.builder.ensureLine(null),
                this.builder.addInlineWidget(a, r, i),
                (i = r.length));
          }
        else if (e.isText())
          this.builder.ensureLine(null),
            !t && n == e.length && !this.cache.reused.has(e)
              ? this.builder.addText(e.text, r, i, this.cache.reuse(e))
              : (this.cache.add(e),
                this.builder.addText(e.text.slice(t, n), r, i)),
            (i = r.length);
        else if (e.isLine())
          (e.flags &= -2), this.cache.reused.set(e, 1), this.builder.addLine(e);
        else if (e instanceof WidgetBufferTile) this.cache.add(e);
        else if (e instanceof MarkTile)
          this.builder.ensureLine(null),
            this.builder.addMark(e, r, i),
      ...
      enter: (e) => {
        e.isLine()
          ...
          : (this.cache.add(e), e instanceof MarkTile && r.unshift(e.mark)),
          (this.openWidget = !1);
      },
      leave: (e) => {
        e.isLine()
          ? r.length && (r.length = i = 0)
          : e instanceof MarkTile && (r.shift(), (i = Math.min(i, r.length)));
      },
      break: () => {
  ...
  emit(e, n) {
    let r = null,
      i = this.builder,
      a = 0,
      o = t.spans(this.decorations, e, n, {
        point: (e, t, n, o, s, c) => {
          if (n instanceof PointDecoration) {
            ...
            if (((a = o.length), s > o.length)) i.continueWidget(t - e);
            else {
              let a =
                  n.widget || (n.block ? NullWidget.block : NullWidget.inline),
                c = kt(n),
                l =
                  this.cache.findWidget(a, t - e, c) ||
                  WidgetTile.of(a, this.view, t - e, c);
              n.block
                ? (n.startSide > 0 && i.addLineStartIfNotCovered(r),
                  i.addBlockWidget(l))
                : (i.ensureLine(r), i.addInlineWidget(l, o, s));
            }
            r = null;
          } else r = jt(r, n);
        ...
        span: (e, t, n, a) => {
          for (let o = e; o < t; ) {
            ...
            s == null
              ? (i.addLineStartIfNotCovered(r), i.addBreak(), o++)
              : (i.ensureLine(r),
                i.addText(s, n, o == e ? a : n.length),
                (o += s.length)),
              (r = null);
          }
        },
      });
    i.addLineStartIfNotCovered(r),
      (this.openWidget = o > a),
      (this.openMarks = o);
  }
  forward(e, t, n = 1) {
  ...
  getCompositionContext(e) {
    ...
    for (let r = e.parentNode; ; r = r.parentNode) {
      ...
      e instanceof MarkTile
        ? t.push(e)
        : e != null && e.isLine()
          ? (n = e)
          : e instanceof BlockWrapperTile ||
            (r.nodeName == `DIV` && !n && r != this.view.contentDOM
              ? (n = new LineTile(r, At))
              : n ||
                t.push(
                  MarkTile.of(
...
function Ot(e, t) {
  let n = (e) => {
    for (let r of e.children)
      if ((t ? r.isText() : r.length) || n(r)) return !0;
    return !1;
  };
  return n(e);
}
...
const At = { class: `cm-line` };
function jt(e, t) {
  let n = t.spec.attributes,
    r = t.spec.class;
  return !n && !r
    ? e
    : (e || (e = { class: `cm-line` }),
...
function Mt(e) {
  ...
  for (let n = e.parents.length; n > 1; n--) {
    ...
    r instanceof MarkTile && t.push(r.mark);
  }
  return t;
}
function Nt(e) {
...
const Pt = /* @__PURE__ */ new (class extends WidgetType {
  toDOM() {
...
class DocView {
  constructor(e) {
    (this.view = e),
      ...
      this.updateDeco(),
      (this.tile = new DocTile(e, e.contentDOM)),
      this.updateInner([new ChangedRange(0, 0, 0, e.state.doc.length)], null);
  }
  update(e) {
    var t;
    ...
    this.view.inputState.composing >= 0 &&
      ...
      ((t = this.domChanged) != null && t.newSel
        ? (r = this.domChanged.newSel.head)
        : !Wt(e.changes, this.hasComposition) &&
          !e.selectionSet &&
          (r = e.state.selection.main.head));
    let i = r > -1 ? Rt(this.view, e.changes, r) : null;
    ...
    let a = this.decorations,
      o = this.blockWrappers;
    this.updateDeco();
    let s = Vt(a, this.decorations, e.changes);
    s.length && (n = ChangedRange.extendWithRanges(n, s));
    let c = Ht(o, this.blockWrappers, e.changes);
    return (
      c.length && (n = ChangedRange.extendWithRanges(n, c)),
      i &&
        !n.some((e) => e.fromA <= i.range.fromA && e.toA >= i.range.toA) &&
        (n = i.range.addToSet(n.slice())),
      this.tile.flags & 2 && n.length == 0
        ? !1
        : (this.updateInner(n, i),
  ...
  updateInner(e, t) {
    ...
    n.ignore(() => {
      if (t || e.length) {
        ...
        t && Tile.get(t.text) && r.cache.reused.set(Tile.get(t.text), 2),
          (this.tile = r.run(e, t)),
          Ft(n, r.cache.reused);
      }
      ...
      this.tile.sync(r),
        r &&
          (r.written ||
            n.selectionRange.focusNode != r.node ||
    ...
    if (
      ...
      for (let e of this.tile.children)
        e.isWidget() && e.widget instanceof BlockGapWidget && r.push(e.dom);
    n.updateGaps(r);
  }
  updateEditContextFormatting(e) {
    ...
    for (let t of e.transactions)
      for (let e of t.effects)
        e.is(ft) && (this.editContextFormatting = e.value);
  }
  updateSelection(e = !1, t = !1) {
    ...
    let { dom: n } = this.tile,
      ...
      a =
        !i &&
        !(this.view.state.facet(H) || n.tabIndex > -1) &&
        O(n, this.view.observer.selectionRange) &&
        !(r && n.contains(r));
    if (!(i || t || a)) return;
    ...
    if (
      (s.empty
        ? (l = c = this.inlineDOMNearPos(s.anchor, s.assoc || 1))
        : ((l = this.inlineDOMNearPos(s.head, s.head == s.from ? 1 : -1)),
          (c = this.inlineDOMNearPos(s.anchor, s.anchor == s.from ? 1 : -1))),
      T.gecko && s.empty && !this.hasComposition && It(c))
    ) {
    ...
    (o ||
      !u.focusNode ||
      ((!A(c.node, c.offset, u.anchorNode, u.anchorOffset) ||
        !A(l.node, l.offset, u.focusNode, u.focusOffset)) &&
        !this.suppressWidgetCursorChange(u, s))) &&
      (this.view.observer.ignore(() => {
        T.android &&
          T.chrome &&
          n.contains(u.focusNode) &&
          Ut(u.focusNode, n) &&
          (n.blur(), n.focus({ preventScroll: !0 }));
        let e = be(this.view.root);
        if (e)
          if (s.empty) {
            if (T.gecko) {
              let e = zt(c.node, c.offset);
              if (e && e != 3) {
                let t = (e == 1 ? Ne : Pe)(c.node, c.offset);
                t && (c = new DOMPos(t.node, t.offset));
              }
            }
            e.collapse(c.node, c.offset),
              s.bidiLevel != null &&
                e.caretBidiLevel !== void 0 &&
                (e.caretBidiLevel = s.bidiLevel);
          } else if (e.extend) {
            e.collapse(c.node, c.offset);
            try {
      ...
      (this.impreciseAnchor = c.precise
        ? null
        : new DOMPos(u.anchorNode, u.anchorOffset)),
      (this.impreciseHead = l.precise
        ? null
        : new DOMPos(u.focusNode, u.focusOffset));
  }
  suppressWidgetCursorChange(e, t) {
    return (
      this.hasComposition &&
      t.empty &&
      A(e.focusNode, e.focusOffset, e.anchorNode, e.anchorOffset) &&
  ...
  posFromDOM(e, t) {
    ...
    if (n.isComposite()) {
      ...
      for (; i && !Tile.get(i); ) i = i.nextSibling;
  ...
  coordsForChar(e) {
    ...
    function i(e, t) {
      if (e.isComposite())
        ...
        let n = r(e.text, t);
        if (n == t) return null;
        let i = F(e.dom, t, n).getClientRects();
        for (let e = 0; e < i.length; e++) {
          let t = i[e];
          if (e == i.length - 1 || (t.top < t.bottom && t.left < t.right))
            return t;
        }
      }
      return null;
  ...
  measureVisibleLineHeights(e) {
    let t = [],
      ...
      a = i > Math.max(this.view.scrollDOM.clientWidth, this.minWidth) + 1,
      o = -1,
      s = this.view.textDirection == L.LTR,
      c = 0,
      l = (e, u, d) => {
        for (let f = 0; f < e.children.length && !(u > r); f++) {
          let r = e.children[f],
            p = u + r.length,
            m = r.dom.getBoundingClientRect(),
            { height: h } = m;
          if ((d && !f && (c += m.top - d.top), r instanceof BlockWrapperTile))
            p > n && l(r, u, m);
            ...
            if (t.length) {
              let e = t[t.length - 1],
                n = s ? e.right - m.left : m.right - e.left;
              n > o &&
                ((o = n),
                (this.minWidth = i),
                (this.minWidthFrom = u),
          ...
          d && f == e.children.length - 1 && (c += d.bottom - m.bottom),
            (u = p + r.breakAfter);
        }
      };
  ...
  measureTextSize() {
    ...
    return (
      ...
      this.view.observer.ignore(() => {
        ...
        let e = k(t.firstChild)[0];
        (n = t.getBoundingClientRect().height),
          (r = e && e.width ? e.width / 27 : 7),
          (i = e && e.height ? e.height : n),
          t.remove();
      }),
  ...
  computeBlockGapDeco() {
    ...
    for (let n = 0, r = 0; ; r++) {
      let i = r == t.viewports.length ? null : t.viewports[r],
        a = i ? i.from - 1 : this.view.state.doc.length;
      if (a > n) {
        let r =
          (t.lineBlockAt(a).bottom - t.lineBlockAt(n).top) / this.view.scaleY;
        e.push(
          Decoration.replace({
            widget: new BlockGapWidget(r),
            block: !0,
            inclusive: !0,
            isBlockGap: !0,
          }).range(n, a),
  ...
  updateDeco() {
    let e = 1,
      n = this.view.state
        .facet(gt)
        .map((t) =>
          (this.dynamicDecorationMap[e++] = typeof t == `function`)
            ? t(this.view)
            : t,
        ),
      r = !1,
      i = this.view.state.facet(vt).map((e, t) => {
        let n = typeof e == `function`;
        return n && (r = !0), n ? e(this.view) : e;
      });
    for (
      i.length && ((this.dynamicDecorationMap[e++] = r), n.push(t.join(i))),
        this.decorations = [
    ...
    this.blockWrappers = this.view.state
      .facet(_t)
      .map((e) => (typeof e == `function` ? e(this.view) : e));
  }
  scrollIntoView(e) {
    var t;
    if (e.isSnapshot) {
    ...
    for (let t of this.view.state.facet(ut))
      try {
        if (t(this.view, e.range, e)) return !0;
      } catch (e) {
        V(this.view.state, e, `scroll handler`);
      }
    let { range: n } = e,
      r = this.coordsAt(
        n.head,
        (t = n.assoc) == null ? (n.empty ? 0 : n.head > n.anchor ? -1 : 1) : t,
      ),
      i;
    if (!r) return;
    !n.empty &&
    ...
    let a = St(this.view),
      ...
      { offsetWidth: s, offsetHeight: c } = this.view.scrollDOM;
    if (
      (Ee(
        this.view.scrollDOM,
        o,
        ...
        e.x,
        e.y,
        Math.max(Math.min(e.xMargin, s), -s),
        Math.max(Math.min(e.yMargin, c), -c),
        this.view.textDirection == L.LTR,
      ),
      ...
      let e = this.view.docView.lineAt(n.head, 1);
...
function Lt(e, t) {
  ...
  let r = Ne(n.focusNode, n.focusOffset),
    i = Pe(n.focusNode, n.focusOffset),
    a = r || i;
  if (i && r && i.node != r.node) {
    let t = Tile.get(i.node);
    if (!t || (t.isText() && t.text != i.node.nodeValue)) a = i;
    else if (e.docView.lastCompositionAfterCursor) {
      let e = Tile.get(r.node);
...
function Rt(e, t, n) {
  let r = Lt(e, n);
  if (!r) return null;
  let { node: i, from: a, to: o } = r,
    s = i.nodeValue;
  if (/[\n\r]/.test(s) || e.state.doc.sliceString(r.from, r.to) != s)
    return null;
  let c = t.invertedDesc;
  return { range: new ChangedRange(c.mapPos(a), c.mapPos(o), a, o), text: i };
}
function zt(e, t) {
  return e.nodeType == 1
    ? (t && e.childNodes[t - 1].contentEditable == `false` ? 1 : 0) |
        (t < e.childNodes.length && e.childNodes[t].contentEditable == `false`
          ? 2
          : 0)
    : 0;
}
let Bt = class DecorationComparator {
  constructor() {
    this.changes = [];
  }
  compareRange(e, t) {
...
function Vt(e, n, r) {
  let i = new Bt();
  return t.compare(e, n, r, i), i.changes;
}
...
function Gt(e, t, n = 1) {
  let a = e.charCategorizer(t),
    o = e.doc.lineAt(t),
    s = t - o.from;
  if (o.length == 0) return i.cursor(t);
  s == 0 ? (n = 1) : s == o.length && (n = -1);
  let c = s,
    l = s;
  n < 0 ? (c = r(o.text, s, !1)) : (l = r(o.text, s));
  let u = a(o.text.slice(c, l));
  for (; c > 0; ) {
    let e = r(o.text, c, !1);
    if (a(o.text.slice(e, c)) != u) break;
    c = e;
  }
  for (; l < o.length; ) {
    let e = r(o.text, l);
    if (a(o.text.slice(l, e)) != u) break;
    l = e;
  }
  return i.undirectionalRange(c + o.from, l + o.from);
}
function Kt(e, t, n, r, i) {
  ...
  if (e.lineWrapping && n.height > e.defaultLineHeight * 1.5) {
    let t = e.viewState.heightOracle.textHeight,
      r = Math.floor((i - n.top - (e.defaultLineHeight - t) * 0.5) / t);
    a += r * e.viewState.heightOracle.lineLength;
  }
  let o = e.state.sliceDoc(n.from, n.to);
  return n.from + l(o, a, e.state.tabSize);
}
function qt(e, t, n) {
...
function Jt(e, t, n, r) {
  let a = qt(e, t.head, t.assoc || -1),
    o =
      !r || a.type != E.Text || !(e.lineWrapping || a.widgetLineBreaks)
        ? null
  ...
  if (o) {
    ...
    if (s != null) return i.cursor(s, n ? -1 : 1);
  }
  return i.cursor(n ? a.to : a.from, n ? -1 : 1);
}
function Yt(e, t, n, r) {
...
function Xt(e, t, n) {
  ...
  return (e) => {
    let t = r(e);
    return i == u.Space && (i = t), i == t;
  };
}
function Zt(e, t, n, r) {
  let a = t.head,
    o = n ? 1 : -1;
  if (a == (n ? e.state.doc.length : 0)) return i.cursor(a, t.assoc);
  let s = t.goalColumn,
    c,
    ...
    d = e.documentTop;
  if (u) s == null && (s = u.left - l.left), (c = o < 0 ? u.top : u.bottom);
  else {
    let t = e.viewState.lineBlockAt(a);
    s == null &&
      (s = Math.min(l.right - l.left, e.defaultCharacterWidth * (a - t.from))),
      (c = (o < 0 ? t.top : t.bottom) + d);
  }
  let f = l.left + s,
    p = e.viewState.heightOracle.textHeight >> 1,
    m = r == null ? p : r;
  for (let t = 0; ; t += p) {
    let r = c + (m + t) * o,
      a = en(e, { x: f, y: r }, !1, o);
    if (n ? r > l.bottom : r < l.top) return i.cursor(a.pos, a.assoc);
    let u = e.coordsAtPos(a.pos, a.assoc),
      d = u ? (u.top + u.bottom) / 2 : 0;
    if (!u || (n ? d > c : d < c)) return i.cursor(a.pos, a.assoc, void 0, s);
  }
}
function K(e, t, n) {
  for (;;) {
...
function Qt(e, t) {
  ...
  for (let r = 0; r < t.ranges.length; r++) {
    ...
    if (a.empty) {
      let t = K(e, a.from, 0);
      t != a.from && (o = i.cursor(t, -1));
    } else {
      let t = K(e, a.from, -1),
        n = K(e, a.to, 1);
      (t != a.from || n != a.to) &&
        (o = a.undirectional
          ? i.undirectionalRange(a.from, a.to)
          : i.range(a.from == a.anchor ? t : n, a.from == a.head ? t : n));
    }
...
function en(e, t, n, r) {
  let i = e.contentDOM.getBoundingClientRect(),
    a = i.top + e.viewState.paddingTop,
    { x: o, y: s } = t,
    c = s - a,
    l;
  for (;;) {
    if (c < 0) return new PosAssoc(0, 1);
    if (c > e.viewState.docHeight) return new PosAssoc(e.state.doc.length, -1);
  ...
  if (e.viewport.from >= l.to || e.viewport.to <= l.from) {
    ...
    if (l.type == E.Text) {
      let t = Kt(e, i, l, o, s);
      return new PosAssoc(t, t == l.from ? 1 : -1);
    }
  }
  if (l.type != E.Text)
    return c < (l.top + l.bottom) / 2
      ? new PosAssoc(l.from, 1)
      : new PosAssoc(l.to, -1);
  let u = e.docView.lineAt(l.from, 2);
  return (
    (!u || u.length != l.length) && (u = e.docView.lineAt(l.from, -2)),
    new InlineCoordsScan(e, o, s, e.textDirectionAt(l.from)).scanTile(u, l.from)
  );
}
class InlineCoordsScan {
  ...
  baseDirAt(e, t) {
    ...
    return r[BidiSpan.find(r, e - n.from, -1, t)].level == this.baseDir;
  }
  dirAt(e, t) {
    let { line: n, spans: r } = this.bidiSpansAt(e);
    return r[BidiSpan.find(r, e - n.from, -1, t)].dir;
  }
  bidiIn(e, t) {
    let { spans: n, line: r } = this.bidiSpansAt(e);
    return (
      n.length > 1 ||
      (n.length && (n[0].level != this.baseDir || n[0].to + r.from < t))
    );
  }
  scan(e, t, n = !1) {
    let r = 0,
          ...
          if (!(n.width == 0 && p.length > 1)) {
            if (n.bottom < this.y)
              ...
              let e =
                ...
                t = Math.abs(e);
              t < u && ((l = f), (u = t), (d = n)),
                e && (a = e < 0 == (this.baseDir == L.LTR) ? -1 : 1);
            }
            a == -1 && (!o || this.baseDirAt(e[f], 1))
              ? (i = f)
              : a == 1 && (!o || this.baseDirAt(e[f + 1], -1)) && (r = f + 1);
          }
        }
    }
    if (!d) {
      if (!c && !s) return { i: e[0], after: !1 };
      let n = s && (!c || this.y - s.bottom < c.top - this.y) ? s : c;
      return (this.y = (n.top + n.bottom) / 2), this.scan(e, t, !0);
    }
    if (u && !n) {
      let { top: n, bottom: r } = d;
      if (s && s.bottom > (n + n + r) / 3)
        return (this.y = s.bottom - 1), this.scan(e, t, !0);
      if (c && c.top < (n + r + r) / 3)
        return (this.y = c.top + 1), this.scan(e, t, !0);
    }
    let f = (o ? this.dirAt(e[l], 1) : this.baseDir) == L.LTR;
    return { i: l, after: this.x > (d.left + d.right) / 2 == f };
  }
  scanText(e, t) {
    let n = [];
    for (let i = 0; i < e.length; i = r(e.text, i)) n.push(t + i);
    n.push(t + e.length);
    let i = this.scan(n, (r) => {
      let i = n[r] - t,
        a = n[r + 1] - t;
      return F(e.dom, i, a).getClientRects();
    });
    return i.after ? new PosAssoc(n[i.i + 1], -1) : new PosAssoc(n[i.i], 1);
  }
  scanTile(e, t) {
    if (!e.length) return new PosAssoc(t, 1);
...
class DOMReader {
  constructor(e, t) {
    (this.points = e),
      (this.view = t),
      (this.text = ``),
      (this.lineSeparator = t.state.facet(d.lineSeparator));
  }
  append(e) {
    this.text += e;
  }
  ...
  readRange(e, t) {
    ...
    for (let r = e; ; ) {
      ...
      (i && o
        ...
        : (i ? i.breakAfter : Se(r)) ||
          (Se(a) &&
            (r.nodeName != `BR` || (i != null && i.isWidget())) &&
            this.text.length > e)) &&
        !rn(a, t) &&
        this.lineBreak(),
        (r = a);
    ...
    for (let n = 0, r = this.lineSeparator ? null : /\r\n?|\n/g; ; ) {
      ...
      if (
        (this.lineSeparator
          ...
          : (o = r.exec(t)) && ((i = o.index), (a = o[0].length)),
  ...
  findPointInside(e, t) {
    for (let n of this.points)
      (e.nodeType == 3 ? n.node == e : e.contains(n.node)) &&
        (n.pos = this.text.length + (nn(e, n.node, n.offset) ? t : 0));
  }
}
function nn(e, t, n) {
  for (;;) {
...
class DOMChange {
  constructor(e, t, n, r) {
    ...
    if (e.state.readOnly && t > -1) this.newSel = null;
    else if (t > -1 && (this.bounds = an(e.docView.tile, t, n, 0))) {
      let t = a || o ? [] : un(e),
        n = new DOMReader(t, e);
      n.readRange(this.bounds.startDOM, this.bounds.endDOM),
        (this.text = n.text),
        (this.newSel = dn(t, this.bounds.from));
    } else {
      let t = e.observer.selectionRange,
        n =
          (a && a.node == t.focusNode && a.offset == t.focusOffset) ||
          !xe(e.contentDOM, t.focusNode)
            ? s.main.head
            : e.docView.posFromDOM(t.focusNode, t.focusOffset),
        r =
          (o && o.node == t.anchorNode && o.offset == t.anchorOffset) ||
          !xe(e.contentDOM, t.anchorNode)
            ? s.main.anchor
      ...
      if (
        (T.ios || T.chrome) &&
        n != r &&
        Math.min(n, r) <= s.main.from &&
        Math.max(n, r) >= s.main.to &&
      ...
      if (e.inputState.composing > -1 && s.ranges.length > 1)
        this.newSel = s.replaceRange(i.range(r, n));
      else if (
        e.lineWrapping &&
        r == n &&
        !(s.main.empty && s.main.head == n) &&
        e.inputState.lastTouchTime > Date.now() - 100
      ) {
        let t = e.coordsAtPos(n, -1),
          r = 0;
        t && (r = e.inputState.lastTouchY <= t.bottom ? -1 : 1),
          (this.newSel = i.create([i.cursor(n, r)]));
...
function an(e, t, n, r) {
  if (e.isComposite()) {
    ...
    for (let c = 0, l = r, u = r; c < e.children.length; c++) {
      let r = e.children[c],
        d = l + r.length;
      if (l < t && d > n) return an(r, t, n, l);
      if (
        (d >= t && i == -1 && ((i = c), (a = l)),
        l > n && r.dom.parentNode == e.dom)
      ) {
        (o = c), (s = u);
        break;
      }
...
function on(e, t) {
  let n,
    ...
    s =
      e.inputState.lastKeyTime > Date.now() - 100
        ...
        : -1;
  if (t.bounds) {
    let { from: e, to: r } = t.bounds,
      i = o.from,
      l = null;
    (s === 8 || (T.android && t.text.length < r - e)) &&
      ((i = o.to), (l = `end`));
    let u = a.doc.sliceString(e, r, `￿`),
      d,
      f;
    !o.empty &&
    o.from >= e &&
    o.to <= r &&
    (t.typeOver || u != t.text) &&
    u.slice(0, o.from - e) == t.text.slice(0, o.from - e) &&
    u.slice(o.to - e) ==
      t.text.slice((d = t.text.length - (u.length - (o.to - e))))
      ? (n = {
          from: o.from,
          to: o.to,
          insert: c.of(t.text.slice(o.from - e, d).split(`￿`)),
        })
      : (f = ln(u, t.text, i - e, l)) &&
        (T.chrome &&
          s == 13 &&
          f.toB == f.from + 2 &&
          t.text.slice(f.from, f.toB) == `￿￿` &&
          f.toB--,
        (n = {
          from: e + f.from,
          to: e + f.toA,
          insert: c.of(t.text.slice(f.from, f.toB).split(`￿`)),
        }));
  } else r && ((!e.hasFocus && a.facet(H)) || fn(r, o)) && (r = null);
  if (!n && !r) return !1;
  if (
    ((T.mac || T.android) &&
    n &&
    ...
    e.contentDOM.getAttribute(`autocorrect`) == `off`
      ? (r &&
          n.insert.length == 2 &&
          (r = i.single(r.main.anchor - 1, r.main.head - 1)),
        (n = {
          from: n.from,
          to: n.to,
          insert: c.of([n.insert.toString().replace(`.`, ` `)]),
        }))
      : a.doc.lineAt(o.from).to < o.to &&
          e.docView.lineHasWidget(o.to) &&
          e.inputState.insertingTextAt > Date.now() - 50
        ? (n = {
            from: o.from,
            to: o.to,
            insert: a.toText(e.inputState.insertingText),
          })
        : T.chrome &&
          n &&
          n.from == n.to &&
 ...
 ` &&
          e.lineWrapping &&
          (r && (r = i.single(r.main.anchor - 1, r.main.head - 1)),
          (n = { from: o.from, to: o.to, insert: c.of([` `]) })),
    n)
  )
    return sn(e, n, r, s);
  if (r && !fn(r, o)) {
    ...
    return (
      e.inputState.lastSelectionTime > Date.now() - 50 &&
        (e.inputState.lastSelectionOrigin == `select` && (t = !0),
...
function sn(e, t, n, r = -1) {
  if (T.ios && e.inputState.flushIOSKey(t)) return !0;
  let i = e.state.selection.main;
  if (
    T.android &&
    ((t.to == i.to &&
      (t.from == i.from ||
        (t.from == i.from - 1 && e.state.sliceDoc(t.from, i.from) == ` `)) &&
      t.insert.length == 1 &&
      t.insert.lines == 2 &&
      I(e.contentDOM, `Enter`, 13)) ||
      (((t.from == i.from - 1 && t.to == i.to && t.insert.length == 0) ||
        (r == 8 && t.insert.length < t.to - t.from && t.to > i.head)) &&
        I(e.contentDOM, `Backspace`, 8)) ||
      (t.from == i.from &&
        t.to == i.to + 1 &&
        t.insert.length == 0 &&
        I(e.contentDOM, `Delete`, 46)))
  )
    return !0;
  ...
  let o,
    s = () => o || (o = cn(e, t, n));
  return (
    e.state.facet(it).some((n) => n(e, t.from, t.to, a, s)) || e.dispatch(s()),
    !0
  );
}
function cn(e, t, n) {
  ...
  if (s > -1)
    r = { changes: t, selection: i.cursor(t.from + t.insert.length, -1) };
  else if (
    t.from >= o.from &&
    t.to <= o.to &&
    ...
    r = a.replaceSelection(
      e.state.toText(
        n + t.insert.sliceString(0, void 0, e.state.lineBreak) + i,
      ),
    );
  } else {
    let s = a.changes(t),
      c = n && n.main.to <= s.newLength ? n.main : void 0;
    if (
      ...
      let l = e.state.sliceDoc(t.from, t.to),
        u,
        d = n && Lt(e, n.main.head);
      if (d) {
        let e = t.insert.length - (t.to - t.from);
        u = { from: d.from, to: d.to - e };
      } else u = e.state.doc.lineAt(o.head);
      let f = o.to - t.to;
      r = a.changeByRange((n) => {
        if (n.from == o.from && n.to == o.to)
          return { changes: s, range: c || n.map(s) };
        let r = n.to - f,
          d = r - l.length;
        if (e.state.sliceDoc(d, r) != l || (r >= u.from && d <= u.to))
          return { range: n };
        let p = a.changes({ from: d, to: r, insert: t.insert }),
          m = n.to - o.to;
        return {
          changes: p,
          range: c
            ? i.range(Math.max(0, c.anchor + m), Math.max(0, c.head + m))
            : n.map(p),
        };
      });
    } else r = { changes: s, selection: c && a.selection.replaceRange(c) };
  }
  let c = `input.type`;
  return (
    (e.composing ||
      ...
      e.inputState.compositionFirstChange &&
        ((c += `.start`), (e.inputState.compositionFirstChange = !1))),
    a.update(r, { userEvent: c, scrollIntoView: !0 })
  );
}
function ln(e, t, n, r) {
  ...
  let o = e.length,
    s = t.length;
  for (; o > 0 && s > 0 && e.charCodeAt(o - 1) == t.charCodeAt(s - 1); )
    o--, s--;
  if (r == `end`) {
...
function un(e) {
  ...
  return (
    n &&
      (t.push(new DOMPoint(n, r)),
      (i != n || a != r) && t.push(new DOMPoint(i, a))),
    t
  );
}
function dn(e, t) {
...
class InputState {
  ...
  constructor(e) {
    (this.view = e),
      ...
      T.gecko && Kn(e.contentDOM.ownerDocument);
  }
  handleEvent(e) {
    !Tn(this.view, e) ||
  ...
  ensureHandlers(e) {
    ...
    for (let e in t)
      if (e != `scroll`) {
        ...
        a &&
          i != !a.handlers.length &&
          (r.removeEventListener(e, this.handleEvent), (a = null)),
          a || r.addEventListener(e, this.handleEvent, { passive: i });
      }
    for (let e in n)
      e != `scroll` && !t[e] && r.removeEventListener(e, this.handleEvent);
    this.handlers = t;
  }
  keydown(e) {
    if (
    ...
    if (
      ...
      !e.altKey &&
      !e.metaKey &&
      ((gn.some((t) => t.keyCode == e.keyCode) && !e.ctrlKey) ||
        (_n.indexOf(e.key) > -1 && e.ctrlKey))
    ) {
      let t = {
        ctrlKey: e.ctrlKey,
        altKey: e.altKey,
  ...
  flushIOSKey(e) {
    ...
    return !t ||
      ...
      ? !1
      : ((this.pendingIOSKey = void 0),
        I(this.view.contentDOM, t.key, t.keyCode, t.mods));
  }
...
function hn(e) {
  ...
  for (let t of e) {
    ...
    if (r)
      for (let e in r) {
        let i = r[e];
        i && n(e).handlers.push(mn(t.value, i));
      }
    if (i)
      for (let e in i) {
        let r = i[e];
        r && n(e).observers.push(mn(t.value, r));
      }
  }
  for (let e in q) n(e).handlers.push(q[e]);
  for (let e in J) n(e).observers.push(J[e]);
  return t;
}
const gn = [
...
class MouseSelection {
  constructor(e, t, n, r) {
    (this.view = e),
      ...
      (this.scrolling = -1),
      (this.lastEvent = t),
      (this.scrollParents = De(e.contentDOM)),
      (this.atoms = e.state.facet(W).map((t) => t(e)));
    ...
    i.addEventListener(`mousemove`, (this.move = this.move.bind(this))),
      ...
      (this.multiple = e.state.facet(d.allowMultipleSelections) && Sn(e, t)),
      (this.dragging = wn(e, t) && Fn(t) == 1 ? null : !1);
  }
  start(e) {
  ...
  move(e) {
    ...
    if (this.dragging || (this.dragging == null && xn(this.startEvent, e) < 10))
      return;
    ...
    let t = 0,
      ...
      o = this.view.win.innerHeight;
    this.scrollParents.x &&
      ({ left: r, right: a } = this.scrollParents.x.getBoundingClientRect()),
      this.scrollParents.y &&
        ({ top: i, bottom: o } = this.scrollParents.y.getBoundingClientRect());
    let s = St(this.view);
    e.clientX - s.left <= r + 6
      ? (t = -bn(r - e.clientX))
      : e.clientX + s.right >= a - 6 && (t = bn(e.clientX - a)),
      e.clientY - s.top <= i + 6
        ? (n = -bn(i - e.clientY))
        : e.clientY + s.bottom >= o - 6 && (n = bn(e.clientY - o)),
  ...
  select(e) {
    let { view: t } = this,
      n = Qt(this.atoms, this.style.get(e, this.extend, this.multiple));
...
function Sn(e, t) {
  ...
  return n.length ? n[0](t) : T.mac ? t.metaKey : t.ctrlKey;
}
function Cn(e, t) {
  let n = e.state.facet(et);
  return n.length ? n[0](t) : T.mac ? !t.altKey : !t.ctrlKey;
}
function wn(e, t) {
...
const q = /* @__PURE__ */ Object.create(null),
  ...
  En = (T.ie && T.ie_version < 15) || (T.ios && T.webkit_version < 604);
function Dn(e) {
...
function kn(e, t) {
  ...
  if (
    ...
    let e = -1;
    r = n.changeByRange((r) => {
      let c = n.doc.lineAt(r.from);
      if (c.from == e) return { range: r };
      e = c.from;
      let l = n.toText((s ? o.line(a++).text : t) + n.lineBreak);
      return {
        changes: { from: c.from, insert: l },
        range: i.cursor(r.from + l.length),
      };
    });
  } else
    r = s
...
(J.scroll = (e) => {
  ...
  (J.touchstart = (e, t) => {
    ...
    (n.lastTouchTime = Date.now()),
      r && ((n.lastTouchX = r.clientX), (n.lastTouchY = r.clientY)),
      n.setSelectionOrigin(`select.pointer`);
  }),
  (J.touchmove = (e) => {
  ...
  (q.mousedown = (e, t) => {
    if ((e.observer.flush(), e.inputState.lastTouchTime > Date.now() - 2e3))
      return !1;
    let n = null;
    for (let r of e.state.facet(tt)) if (((n = r(e, t)), n)) break;
    if ((!n && t.button == 0 && (n = In(e, t)), n)) {
      let r = !e.hasFocus;
      e.inputState.startMouseSelection(new MouseSelection(e, t, n, r)),
        r &&
          e.observer.ignore(() => {
            Oe(e.contentDOM);
...
function An(e, t, n, r) {
  ...
  if (r == 2) return Gt(e.state, t, n);
  {
    let r = e.docView.lineAt(t, n),
      a = e.state.doc.lineAt(r ? r.posAtEnd : t),
      o = r ? r.posAtStart : a.from,
      s = r ? r.posAtEnd : a.to;
    return (
      s < e.state.doc.length && s == a.to && s++, i.undirectionalRange(o, s)
    );
  }
}
const jn = T.ie && T.ie_version <= 11;
let Mn = null,
  Nn = 0,
  Pn = 0;
function Fn(e) {
  if (!jn) return e.detail;
  let t = Mn,
    n = Pn;
  return (
    (Mn = e),
...
function In(e, t) {
  let n = e.posAndSideAtCoords({ x: t.clientX, y: t.clientY }, !1),
    r = Fn(t),
    a = e.state.selection;
  return {
    update(e) {
      e.docChanged &&
        ((n.pos = e.changes.mapPos(n.pos)), (a = a.map(e.changes)));
    },
    get(t, o, s) {
      let c = e.posAndSideAtCoords({ x: t.clientX, y: t.clientY }, !1),
        l,
        u = An(e, c.pos, c.assoc, r);
      if (n.pos != c.pos && !o) {
        let t = An(e, n.pos, n.assoc, r),
          a = Math.min(t.from, u.from),
          o = Math.max(t.to, u.to);
        u = a < u.from ? i.range(a, o, u.assoc) : i.range(o, a, u.assoc);
      }
      return o
        ? a.replaceRange(a.main.extend(u.from, u.to, u.assoc))
        : s && r == 1 && a.ranges.length > 1 && (l = Ln(a, c.pos))
          ? l
          : s
            ? a.addRange(u)
            : i.create([u]);
  ...
  for (let n = 0; n < e.ranges.length; n++) {
    ...
    if (r <= t && a >= t)
      return i.create(
        ...
        e.mainIndex == n ? 0 : e.mainIndex - +(e.mainIndex > n),
      );
  }
  return null;
}
(q.dragstart = (e, t) => {
  ...
  if (t.target.draggable) {
    ...
    if (r && r.isWidget()) {
      let e = r.posAtStart,
        t = e + r.length;
      (e >= n.to || t <= n.from) && (n = i.undirectionalRange(e, t));
    }
  }
  let { inputState: r } = e;
  return (
    ...
    t.dataTransfer &&
      (t.dataTransfer.setData(
        `Text`,
        On(e.state, st, e.state.sliceDoc(n.from, n.to)),
      ),
      (t.dataTransfer.effectAllowed = `copyMove`)),
    !1
  );
}),
  (q.dragend = (e) => ((e.inputState.draggedContent = null), !1));
function Rn(e, t, n, r) {
  if (((n = On(e.state, ot, n)), !n)) return;
  let i = e.posAtCoords({ x: t.clientX, y: t.clientY }, !1),
    { draggedContent: a } = e.inputState,
    o = r && a && Cn(e, t) ? { from: a.from, to: a.to } : null,
    s = { from: i, insert: n },
...
(q.drop = (e, t) => {
  ...
  if (n && n.length) {
    let r = Array(n.length),
      ...
      a = () => {
        ++i == n.length &&
          Rn(e, t, r.filter((e) => e != null).join(e.state.lineBreak), !1);
      };
  ...
  (q.paste = (e, t) => {
    if (e.state.readOnly) return !0;
    e.observer.flush();
    let n = En ? null : t.clipboardData;
    return n
      ? (kn(e, n.getData(`text/plain`) || n.getData(`text/uri-list`)), !0)
      : (Dn(e), !1);
  });
function zn(e, t) {
...
function Bn(e) {
  ...
  if (!t.length) {
    ...
    for (let { from: r } of e.selection.ranges) {
      ...
      a.number > i &&
        (t.push(a.text),
        n.push({ from: a.from, to: Math.min(e.doc.length, a.to + 1) })),
        (i = a.number);
    }
    r = !0;
  }
  return { text: On(e, st, t.join(e.lineBreak)), ranges: n, linewise: r };
}
let Vn = null;
q.copy = q.cut = (e, t) => {
  if (!O(e.contentDOM, e.observer.selectionRange)) return !1;
  let { text: n, ranges: r, linewise: i } = Bn(e.state);
  if (!n && !i) return !1;
  (Vn = i ? n : null),
    t.type == `cut` &&
      !e.state.readOnly &&
      e.dispatch({ changes: r, scrollIntoView: !0, userEvent: `delete.cut` });
  let a = En ? null : t.clipboardData;
  return a ? (a.clearData(), a.setData(`text/plain`, n), !0) : (zn(e, n), !1);
};
const Hn = /* @__PURE__ */ f.define();
function Un(e, t) {
  let n = [];
  for (let r of e.facet(at)) {
    let i = r(e, t);
    i && n.push(i);
  }
  return n.length ? e.update({ effects: n, annotations: Hn.of(!0) }) : null;
}
function Wn(e) {
  setTimeout(() => {
    let t = e.hasFocus;
...
(J.focus = (e) => {
  ...
  (J.blur = (e) => {
    e.observer.clearSelectionRange(), Wn(e);
  }),
  ...
  (q.beforeinput = (e, t) => {
    ...
    if (
      ...
      t.inputType == `insertReplacementText` && e.observer.editContext)
    ) {
      let r = (n = t.dataTransfer) == null ? void 0 : n.getData(`text/plain`),
        i = t.getTargetRanges();
      if (r && i.length) {
        let t = i[0];
        return (
    ...
    if (
      T.chrome &&
      T.android &&
      (i = gn.find((e) => e.inputType == t.inputType)) &&
      ...
      setTimeout(() => {
        var n;
        (((n = window.visualViewport) == null ? void 0 : n.height) || 0) >
          t + 10 &&
          e.hasFocus &&
    ...
    return (
      T.ios && t.inputType == `deleteContentForward` && e.observer.flushSoon(),
      T.safari &&
        t.inputType == `insertText` &&
        e.inputState.composing >= 0 &&
        setTimeout(() => J.compositionend(e, t), 20),
      !1
    );
  });
...
class HeightOracle {
  ...
  mustRefreshForWrapping(e) {
    return qn.indexOf(e) > -1 != this.lineWrapping;
  }
  ...
  refresh(e, t, n, r, i, a) {
    let o = qn.indexOf(e) > -1,
      s = Math.abs(t - this.lineHeight) > 0.3 || this.lineWrapping != o;
    if (
      ((this.lineWrapping = o),
      (this.lineHeight = t),
      (this.charWidth = n),
...
class HeightMap {
  ...
  setHeight(e) {
    this.height != e &&
      (Math.abs(this.height - e) > Yn && (Y = !0), (this.height = e));
  }
  replace(e, t, n) {
  ...
  applyChanges(e, t, n, r) {
    ...
    for (let o = r.length - 1; o >= 0; o--) {
      let { fromA: s, toA: c, fromB: l, toB: u } = r[o],
        d = i.lineAt(s, X.ByPosNoHeight, n.setDoc(t), 0, 0),
        f = d.to >= c ? d : i.lineAt(c, X.ByPosNoHeight, n, 0, 0);
      for (u += f.to - c, c = f.to; o > 0 && d.from <= r[o - 1].toA; )
        (s = r[o - 1].fromA),
          (l = r[o - 1].fromB),
          o--,
          s < d.from && (d = i.lineAt(s, X.ByPosNoHeight, n, 0, 0));
      (l += d.from - s), (s = d.from);
      let p = NodeBuilder.build(n.setDoc(a), e, l, u);
      i = Xn(i, i.replace(s, c, p));
    }
  ...
  static of(e) {
    ...
    let a = 0;
    return (
      e[t - 1] == null ? ((a = 1), t--) : e[t] == null && ((a = 1), n++),
      new HeightMapBranch(
        HeightMap.of(e.slice(0, t)),
        a,
        HeightMap.of(e.slice(n)),
      )
    );
  }
}
function Xn(e, t) {
  return e == t ? e : (e.constructor != t.constructor && (Y = !0), t);
}
HeightMap.prototype.size = 1;
const Zn = /* @__PURE__ */ Decoration.replace({});
class HeightMapBlock extends HeightMap {
  ...
  blockAt(e, t, n, r) {
    return this.spaceAbove && e < n + this.spaceAbove
      ? new BlockInfo(r, 0, n, this.spaceAbove, Zn)
      : this.mainBlock(n, r);
  }
  lineAt(e, t, n, r, i) {
  ...
  forEachLine(e, t, n, r, i, a) {
    e <= i + this.length && t >= i && a(this.lineAt(0, X.ByPos, n, r, i));
  }
  setMeasuredHeight(e) {
  ...
  replace(e, t, n) {
    ...
    return n.length == 1 &&
      (r instanceof HeightMapText ||
        (r instanceof HeightMapGap && r.flags & 4)) &&
      Math.abs(this.length - r.length) < 10
      ? (r instanceof HeightMapGap
          ? (r = new HeightMapText(r.length, this.height, this.spaceAbove))
...
class HeightMapGap extends HeightMap {
  ...
  heightMetrics(e, t) {
    ...
    if (e.lineWrapping) {
      ...
      (a = t / i),
        this.length > i + 1 && (o = (this.height - t) / (this.length - i - 1));
    } else a = this.height / i;
    return { firstLine: n, lastLine: r, perLine: a, perChar: o };
  }
  blockAt(e, t, n, r) {
    let {
      firstLine: i,
    ...
    if (t.lineWrapping) {
      let i =
        ...
        c = o + a.length * s,
        l = Math.max(n, e - c / 2);
      return new BlockInfo(a.from, a.length, l, c, 0);
    } else {
      let r = Math.max(0, Math.min(a - i, Math.floor((e - n) / o))),
        { from: s, length: c } = t.doc.line(i + r);
      return new BlockInfo(s, c, n + o * r, o, 0);
    }
  }
  lineAt(e, t, n, r, i) {
    if (t == X.ByHeight) return this.blockAt(e, n, r, i);
    if (t == X.ByPosNoHeight) {
      let { from: t, to: r } = n.doc.lineAt(e);
      return new BlockInfo(t, r - t, 0, 0, 0);
    }
    let { firstLine: a, perLine: o, perChar: s } = this.heightMetrics(n, i),
      c = n.doc.lineAt(e),
      l = o + c.length * s,
      u = c.number - a,
      d = r + o * u + s * (c.from - i - u);
    return new BlockInfo(
      c.from,
      c.length,
  ...
  forEachLine(e, t, n, r, i, a) {
    ...
    for (let l = e, u = r; l <= t; ) {
      ...
      let r = s + c * t.length;
      a(new BlockInfo(t.from, t.length, u, r, 0)), (u += r), (l = t.to + 1);
    }
  }
  replace(e, t, n) {
    let r = this.length - t;
    if (r > 0) {
      ...
      e instanceof HeightMapGap
        ? (n[n.length - 1] = new HeightMapGap(e.length + r))
        : n.push(null, new HeightMapGap(r - 1));
    }
    if (e > 0) {
      let t = n[0];
      t instanceof HeightMapGap
        ? (n[0] = new HeightMapGap(e + t.length))
        : n.unshift(new HeightMapGap(e - 1), null);
    }
    return HeightMap.of(n);
  }
  decomposeLeft(e, t) {
  ...
  updateHeight(e, t = 0, n = !1, r) {
    ...
    if (r && r.from <= t + this.length && r.more) {
      ...
      for (
        r.from > t &&
        n.push(new HeightMapGap(r.from - t - 1).updateHeight(e, t));
        a <= i && r.more;
        ...
        let i = r.heights[r.index++],
          s = 0;
        i < 0 && ((s = -i), (i = r.heights[r.index++])),
          o == -1 ? (o = i) : Math.abs(i - o) >= Yn && (o = -2);
        let c = new HeightMapText(t, i, s);
        (c.outdated = !1), n.push(c), (a += t + 1);
      }
      a <= i && n.push(null, new HeightMapGap(i - a).updateHeight(e, a));
      let s = HeightMap.of(n);
      return (
        (o < 0 ||
          Math.abs(s.height - this.height) >= Yn ||
          Math.abs(o - this.heightMetrics(e, t).perLine) >= Yn) &&
          (Y = !0),
        Xn(this, s)
      );
    } else
...
class HeightMapBranch extends HeightMap {
  ...
  lineAt(e, t, n, r, i) {
    let a = r + this.left.height,
      ...
      s = t == X.ByHeight ? e < a : e < o,
      c = s
        ? this.left.lineAt(e, t, n, r, i)
        : this.right.lineAt(e, t, n, a, o);
    if (this.break || (s ? c.to < o : c.from > o)) return c;
    let l = t == X.ByPosNoHeight ? X.ByPosNoHeight : X.ByPos;
    return s
      ? c.join(this.right.lineAt(o, l, n, a, o))
      : this.left.lineAt(o, l, n, r, i).join(c);
  }
  forEachLine(e, t, n, r, i, a) {
    let o = r + this.left.height,
      s = i + this.left.length + this.break;
    if (this.break)
      e < s && this.left.forEachLine(e, t, n, r, i, a),
        t >= s && this.right.forEachLine(e, t, n, o, s, a);
    else {
      let c = this.lineAt(s, X.ByPos, n, r, i);
      e < c.from && this.left.forEachLine(e, c.from - 1, n, r, i, a),
        c.to >= e && c.from <= t && a(c),
        t > c.to && this.right.forEachLine(c.to + 1, t, n, o, s, a);
    }
  }
  replace(e, t, n) {
    ...
    if ((e > 0 && Qn(i, a - 1), t < this.length)) {
      let e = i.length;
      this.decomposeRight(t, i), Qn(i, e);
    }
  ...
  balanced(e, t) {
    return e.size > 2 * t.size || t.size > 2 * e.size
      ...
      : ((this.left = Xn(this.left, e)),
        (this.right = Xn(this.right, t)),
  ...
  updateHeight(e, t = 0, n = !1, r) {
    let { left: i, right: a } = this,
      o = t + i.length + this.break,
      s = null;
    return (
      r && r.from <= t + i.length && r.more
        ? (s = i = i.updateHeight(e, t, n, r))
        : i.updateHeight(e, t, n),
      r && r.from <= o + a.length && r.more
        ? (s = a = a.updateHeight(e, o, n, r))
        : a.updateHeight(e, o, n),
      s
        ? this.balanced(i, a)
...
function Qn(e, t) {
  let n, r;
  e[t] == null &&
    (n = e[t - 1]) instanceof HeightMapGap &&
    (r = e[t + 1]) instanceof HeightMapGap &&
    e.splice(t - 1, 3, new HeightMapGap(n.length + 1 + r.length));
}
const $n = 5;
class NodeBuilder {
  constructor(e, t) {
    ...
    if (this.lineStart > -1) {
      ...
      n instanceof HeightMapText
        ...
        : (e > this.pos || !this.isCovered) &&
          this.nodes.push(new HeightMapText(e - this.pos, -1, 0)),
        (this.writtenTo = e),
        t > e &&
  ...
  point(e, t, n) {
    if (e < t || n.heightRelevant) {
      ...
      let a = t - e;
      n.block
        ? this.addBlock(new HeightMapBlock(a, r, n))
        : (a || i || r >= 5) && this.addLineDeco(r, i, a);
  ...
  enterLine() {
    ...
    (this.lineStart = e),
      ...
      this.pos > e && this.nodes.push(new HeightMapText(this.pos - e, -1, 0)),
  ...
  finish(e) {
    ...
    this.lineStart > -1 && !(t instanceof HeightMapText) && !this.isCovered
      ? this.nodes.push(new HeightMapText(0, -1, 0))
      : (this.writtenTo < this.pos || t == null) &&
        this.nodes.push(this.blankContent(this.writtenTo, this.pos));
    let n = e;
    for (let e of this.nodes)
      e instanceof HeightMapText && e.updateHeight(this.oracle, n),
        (n += e ? e.length : 1);
    return this.nodes;
  }
  static build(e, n, r, i) {
    let a = new NodeBuilder(r, e);
    return t.spans(n, r, i, a, 0), a.finish(r);
  }
}
function er(e, n, r) {
  let i = new DecorationComparator();
  return t.compare(e, n, r, i, 0), i.changes;
}
...
function tr(e, t) {
  let n = e.getBoundingClientRect(),
    ...
    s = Math.max(0, n.top),
    c = Math.min(i.innerHeight, n.bottom);
  ...
  draw(e, t) {
    return Decoration.replace({
      widget: new LineGapWidget(
        this.displaySize * (t ? e.scaleY : e.scaleX),
        t,
      ),
...
class ViewState {
  constructor(e, t) {
    (this.view = e),
      ...
      (this.defaultTextDirection = L.LTR),
      (this.visibleRanges = []),
  ...
  update(e, t = null) {
    ...
    this.stateDeco = lr(this.state);
    let r = e.changedRanges,
      i = ChangedRange.extendWithRanges(
        r,
        er(n, this.stateDeco, e ? e.changes : s.empty(this.state.doc.length)),
      ),
      a = this.heightMap.height,
      o = this.scrolledToBottom ? null : this.scrollAnchorAt(this.scrollOffset);
    Jn(),
      ...
      (this.heightMap.height != a || Y) && (e.flags |= 2),
      o
    ...
    let l = c.from != this.viewport.from || c.to != this.viewport.to;
    (this.viewport = c),
      (e.flags |= this.updateForViewport()),
      (l || !e.changes.empty || e.flags & 2) && this.updateViewportLines(),
  ...
  measure() {
    ...
    this.scrollOffset != m &&
      ((this.scrollAnchorHeight = -1), (this.scrollOffset = m)),
      (this.scrolledToBottom = Me(this.scrollParent || e.win));
    let h = (this.printing ? rr : tr)(t, this.paddingTop),
      g = h.top - this.pixelViewport.top,
      _ = h.bottom - this.pixelViewport.bottom;
    this.pixelViewport = h;
    let v =
      this.pixelViewport.bottom > this.pixelViewport.top &&
      this.pixelViewport.right > this.pixelViewport.left;
    if (
      (v != this.inView && ((this.inView = v), v && (s = !0)),
      !this.inView && !this.scrollTarget && !nr(e.dom))
    )
      return 0;
    let y = o.width;
    if (
      ...
      if (
        (r.mustRefreshForHeights(t) && (a = !0),
        a ||
          (r.lineWrapping && Math.abs(y - this.contentDOMWidth) > r.charWidth))
      ) {
        let {
          lineHeight: n,
          charWidth: o,
        ...
        (a = n > 0 && r.refresh(i, n, o, s, Math.max(5, y / o), t)),
          a && ((e.docView.minWidth = 0), (l |= 16));
      }
      g > 0 && _ > 0
        ? (u = Math.max(g, _))
        : g < 0 && _ < 0 && (u = Math.min(g, _)),
        Jn();
      for (let n of this.viewports) {
        ...
        this.heightMap = (
          a
            ...
            : this.heightMap
        ).updateHeight(r, 0, a, new MeasuredHeights(n.from, i));
      }
      Y && (l |= 2);
    }
    let b =
    ...
    return (
      b &&
        (l & 2 && (l |= this.updateScaler()),
        (this.viewport = this.getViewport(u, this.scrollTarget)),
        (l |= this.updateForViewport())),
      (l & 2 || b) && this.updateViewportLines(),
      (this.lineGaps.length || this.viewport.to - this.viewport.from > 4e3) &&
        this.updateLineGaps(this.ensureLineGaps(a ? [] : this.lineGaps, e)),
  ...
  getViewport(e, t) {
    let n = 0.5 - Math.max(-0.5, Math.min(0.5, e / 1e3 / 2)),
      ...
      s = new Viewport(
        r.lineAt(a - n * 1e3, X.ByHeight, i, 0, 0).from,
        r.lineAt(o + (1 - n) * 1e3, X.ByHeight, i, 0, 0).to,
      );
    if (t) {
      let { head: e } = t.range;
      if (e < s.from || e > s.to) {
        let n = Math.min(
          ...
          a = r.lineAt(e, X.ByPos, i, 0, 0),
          o;
        (o =
          t.y == `center`
            ? (a.top + a.bottom) / 2 - n / 2
            : t.y == `start` || (t.y == `nearest` && e < s.from)
              ? a.top
              : a.bottom - n),
          (s = new Viewport(
            r.lineAt(o - 1e3 / 2, X.ByHeight, i, 0, 0).from,
            r.lineAt(o + n + 1e3 / 2, X.ByHeight, i, 0, 0).to,
          ));
      }
    }
    return s;
  ...
  mapViewport(e, t) {
    let n = t.mapPos(e.from, -1),
      r = t.mapPos(e.to, 1);
    return new Viewport(
      this.heightMap.lineAt(n, X.ByPos, this.heightOracle, 0, 0).from,
      this.heightMap.lineAt(r, X.ByPos, this.heightOracle, 0, 0).to,
    );
  }
  viewportIsAppropriate({ from: e, to: t }, n = 0) {
    if (!this.inView) return !0;
    let { top: r } = this.heightMap.lineAt(e, X.ByPos, this.heightOracle, 0, 0),
      ...
      { visibleTop: a, visibleBottom: o } = this;
    return (
      (e == 0 || r <= a - Math.max(10, Math.min(-n, 250))) &&
      (t == this.state.doc.length || i >= o + Math.max(10, Math.min(n, 250))) &&
      r > a - 2 * 1e3 &&
      i < o + 2 * 1e3
    );
  }
  mapLineGaps(e, t) {
    ...
    for (let r of e)
      t.touchesRange(r.from, r.to) ||
        n.push(
          new LineGap(t.mapPos(r.from), t.mapPos(r.to), r.size, r.displaySize),
        );
    return n;
  }
  ensureLineGaps(e, t) {
      ...
      c = (r, o, l, u) => {
        ...
        if (!p) {
          if (
            ...
            t &&
            n &&
            t.visibleRanges.some((e) => e.from <= o && e.to >= o)
          ) {
            let e = t.moveToLineBoundary(i.cursor(o), !1, !0).head;
            e > r && (o = e);
          }
          let e = this.gapSize(l, r, o, u);
          p = new LineGap(r, o, e, n || e < 2e6 ? e : 2e6);
        }
        s.push(p);
      },
      l = (t) => {
        if (t.length < o || t.type != E.Text) return;
        let i = ir(t.from, t.to, this.stateDeco);
        if (i.total < o) return;
        ...
        if (n) {
          ...
          if (a != null) {
            let r = or(i, a),
              s = ((this.visibleBottom - this.visibleTop) / 2 + e) / t.height;
            (n = r - s), (o = r + s);
          } else
            (n = (this.visibleTop - t.top - e) / t.height),
              (o = (this.visibleBottom - t.top + e) / t.height);
          (s = ar(i, n)), (l = ar(i, o));
        } else {
          ...
          if (n > 2e6)
            for (let n of e)
              n.from >= t.from &&
                ...
                n.from * this.heightOracle.charWidth + c <
                  this.pixelViewport.left &&
                (c = n.size - n.displaySize);
          let u = this.pixelViewport.left + c,
            d = this.pixelViewport.right + c,
            f,
            p;
          if (a != null) {
            let e = or(i, a),
              t = ((d - u) / 2 + o) / n;
            (f = e - t), (p = e + t);
          } else (f = (u - o) / n), (p = (d + o) / n);
          (s = ar(i, f)), (l = ar(i, p));
        }
        s > t.from && c(t.from, s, t, i), l < t.to && c(l, t.to, t, i);
      };
  ...
  computeVisibleRanges(e) {
    ...
    let i = 0;
    if (r.length != this.visibleRanges.length) i = 12;
    else
      for (let t = 0; t < r.length && !(i & 8); t++) {
        let n = this.visibleRanges[t],
          a = r[t];
        (n.from != a.from || n.to != a.to) &&
          ((i |= 4),
          (e && e.mapPos(n.from, -1) == a.from && e.mapPos(n.to, 1) == a.to) ||
            (i |= 8));
      }
  ...
  lineBlockAt(e) {
    return (
      ...
      ur(
        this.heightMap.lineAt(e, X.ByPos, this.heightOracle, 0, 0),
        this.scaler,
      )
    );
  }
  ...
  return (
    t.spans(
      ...
      n,
      {
        span() {},
        point(e, t) {
          e > a && (i.push({ from: a, to: e }), (o += e - a)), (a = t);
        },
      },
      20,
    ),
    a < n && (i.push({ from: a, to: n }), (o += n - a)),
    { total: o, ranges: i }
  );
}
function ar({ total: e, ranges: t }, n) {
...
function lr(e) {
  let n = e.facet(gt).filter((e) => typeof e != `function`),
    r = e.facet(vt).filter((e) => typeof e != `function`);
  return r.length && n.push(t.join(r)), n;
}
class BigScaler {
  constructor(e, t, n) {
    let r = 0,
    ...
    (this.viewports = n.map(({ from: n, to: i }) => {
      let a = t.lineAt(n, X.ByPos, e, 0, 0).top,
        o = t.lineAt(i, X.ByPos, e, 0, 0).bottom;
      return (
        (r += o - a),
        { from: n, to: i, top: a, bottom: o, domTop: 0, domBottom: 0 }
      );
    })),
...
function ur(e, t) {
  ...
  return new BlockInfo(
    ...
    n,
    r - n,
    Array.isArray(e._content) ? e._content.map((e) => ur(e, t)) : e._content,
  );
}
const dr = /* @__PURE__ */ a.define({ combine: (e) => e.join(` `) }),
  fr = /* @__PURE__ */ a.define({ combine: (e) => e.indexOf(!0) > -1 }),
  pr = /* @__PURE__ */ x.newName(),
  mr = /* @__PURE__ */ x.newName(),
  hr = /* @__PURE__ */ x.newName(),
  gr = { "&light": `.` + mr, "&dark": `.` + hr };
function _r(e, t, n) {
  return new x(t, {
    finish(t) {
...
class DOMObserver {
  constructor(e) {
    (this.view = e),
      ...
      window.EditContext &&
        ...
        ((this.editContext = new EditContextManager(e)),
        e.state.facet(H) &&
      ...
      typeof ResizeObserver == `function` &&
        ((this.resizeScroll = new ResizeObserver(() => {
          var e;
          ((e = this.view.docView) == null ? void 0 : e.lastUpdate) <
  ...
  onSelectionChange(e) {
    ...
    if (n.state.facet(H) ? n.root.activeElement != this.dom : !O(this.dom, r))
      return;
    ...
    r.focusNode &&
    A(r.focusNode, r.focusOffset, r.anchorNode, r.anchorOffset)
      ? this.flushSoon()
      : this.flush(!1);
  }
  readSelectionRange() {
  ...
  start() {
    this.active ||
      (this.observer.observe(this.dom, yr),
      br &&
    ...
    if (!this.delayedAndroidKey) {
      let e = () => {
        ...
        e &&
          ...
          !this.flush() && e.force && I(this.dom, e.key, e.keyCode));
      };
    ...
    (!this.delayedAndroidKey || e == `Enter`) &&
      (this.delayedAndroidKey = {
        ...
        force:
          ...
          !!((n = this.delayedAndroidKey) != null && n.force),
      });
  }
  ...
  readChange() {
    let { from: e, to: t, typeOver: n } = this.processRecords(),
      r = this.selectionChanged && O(this.dom, this.selectionRange);
    if (e < 0 && !r) return null;
    e > -1 && (this.lastChange = Date.now()),
      (this.view.inputState.lastFocusTime = 0),
      (this.selectionChanged = !1);
    let i = new DOMChange(this.view, e, t, n);
    return (
  ...
  flush(e = !0) {
    ...
    return (
      this.view.state == n &&
        (t.domChanged ||
          (t.newSel && !fn(this.view.state.selection, t.newSel.main))) &&
        this.view.update([]),
      r
    );
  }
  readMutation(e) {
    ...
    if ((t.markDirty(e.type == `attributes`), e.type == `childList`)) {
      let n = xr(t, e.previousSibling || e.target.previousSibling, -1),
        r = xr(t, e.nextSibling || e.target.nextSibling, 1);
      return {
  ...
  update(e) {
    this.editContext &&
      ...
      e.startState.facet(H) != e.state.facet(H) &&
        (e.view.contentDOM.editContext = e.state.facet(H)
  ...
  destroy() {
    var e, t, n;
    this.stop(),
      (e = this.intersection) == null || e.disconnect(),
      (t = this.gapIntersection) == null || t.disconnect(),
      (n = this.resizeScroll) == null || n.disconnect();
    for (let e of this.scrollTargets)
      e.removeEventListener(`scroll`, this.onScroll);
    this.removeWindowListeners(this.win),
...
function Sr(e, t) {
  let n = t.startContainer,
    ...
    i = t.endContainer,
    a = t.endOffset,
    o = e.docView.domAtPos(e.state.selection.main.anchor, 1);
  return (
    A(o.node, o.offset, i, a) && ([n, r, i, a] = [i, a, n, r]),
  ...
  constructor(e) {
    ...
    (this.handlers.textupdate = (n) => {
      let r = e.state.selection.main,
        { anchor: a, head: o } = r,
        s = this.toEditorPos(n.updateRangeStart),
        l = this.toEditorPos(n.updateRangeEnd);
      e.inputState.composing >= 0 &&
        !this.composing &&
        (this.composing = {
      ...
      let u = l - s > n.text.length;
      s == this.from && a < this.from
        ? (s = a)
        : l == this.to && a > this.to && (l = a);
      let d = ln(
        e.state.sliceDoc(s, l),
        n.text,
        (u ? r.from : r.to) - s,
        u ? `end` : null,
      );
      if (!d) {
        ...
        fn(t, r) || e.dispatch({ selection: t, userEvent: `select` });
        return;
      }
      let f = {
        from: d.from + s,
        to: d.toA + s,
        insert: c.of(
          n.text.slice(d.from, d.toB).split(`
`),
        ),
      };
      if (
        ((T.mac || T.android) &&
          ...
          /^\. ?$/.test(n.text) &&
          e.contentDOM.getAttribute(`autocorrect`) == `off` &&
          (f = { from: s, to: l, insert: c.of([n.text.replace(`.`, ` `)]) }),
        (this.pendingContextChange = f),
        !e.state.readOnly)
      ) {
        let t = this.to - this.from + (f.to - f.from + f.insert.length);
        sn(
          e,
          f,
          i.single(
        ...
        for (let e of t.getTextFormats()) {
          ...
          if (!/none/i.test(t) && !/none/i.test(r)) {
            let i = this.toEditorPos(e.rangeStart),
              a = this.toEditorPos(e.rangeEnd);
            if (i < a) {
              let e = `text-decoration: underline ${/^[a-z]/.test(t) ? t + ` ` : t == `Dashed` ? `dashed ` : t == `Squiggle` ? `wavy ` : ``}${/thin/i.test(r) ? 1 : 2}px`;
              n.push(Decoration.mark({ attributes: { style: e } }).range(i, a));
            }
          }
        }
        e.dispatch({ effects: ft.of(Decoration.set(n)) });
      }),
  ...
  applyEdits(e) {
    ...
    return (
      e.changes.iterChanges((i, a, o, s, c) => {
        ...
        if (((i += t), (a += t), a <= this.from))
          (this.from += l), (this.to += l);
        else if (i < this.to) {
          if (
            i < this.from ||
            a > this.to ||
            this.to - this.from + c.length > 3e4
          ) {
            n = !0;
            return;
          }
...
class EditorView {
  ...
  constructor(e = {}) {
    ...
    (this.dispatchTransactions =
      ...
      (this._root = e.root || Ae(e.parent) || document),
      (this.viewState = new ViewState(this, e.state || d.create(e))),
      e.scrollTo &&
        e.scrollTo.is(dt) &&
        (this.viewState.scrollTarget = e.scrollTo.value.clip(
          this.viewState.state,
        )),
      (this.plugins = this.state.facet(U).map((e) => new PluginInstance(e)));
  ...
  update(e) {
    ...
    let o = this.hasFocus,
      s = 0,
      c = null;
    e.some((e) => e.annotation(Hn))
      ? ((this.inputState.notifiedFocused = o), (s = 1))
      : o != this.inputState.notifiedFocused &&
        ((this.inputState.notifiedFocused = o), (c = Un(a, o)), c || (s = 1));
    ...
    if (
      (l
        ? (this.observer.clearDelayedAndroidKey(),
          ...
          ((u && !this.state.doc.eq(a.doc)) ||
            !this.state.selection.eq(a.selection)) &&
            (u = null))
        : this.observer.clear(),
      a.facet(d.phrases) != this.state.facet(d.phrases))
    )
      return this.setState(a);
    (r = ViewUpdate.create(this, a, e)), (r.flags |= s);
    let f = this.viewState.scrollTarget;
    try {
      this.updateState = 2;
      for (let t of e) {
        if ((f && (f = f.map(t.changes)), t.scrollIntoView)) {
          let { main: e } = t.state.selection,
            { x: n, y: r } = this.state.facet(EditorView.cursorScrollMargin);
          f = new ScrollTarget(
            e.empty ? e : i.cursor(e.head, e.head > e.anchor ? -1 : 1),
            `nearest`,
            `nearest`,
            r,
            n,
        ...
        for (let e of t.effects) e.is(dt) && (f = e.value.clip(this.state));
      }
      this.viewState.update(r, f),
        (this.bidiCache = CachedOrder.update(this.bidiCache, r.changes)),
        r.empty || (this.updatePlugins(r), this.inputState.update(r)),
        (t = this.docView.update(r)),
        this.state.facet(G) != this.styleModules && this.mountStyles(),
        (n = this.updateAttrs()),
    ...
    if (
      ...
      for (let e of this.state.facet(rt))
        try {
          e(r);
        } catch (e) {
          V(this.state, e, `update listener`);
        }
    (c || u) &&
      Promise.resolve().then(() => {
        c && this.state == c.startState && this.dispatch(c),
          u && !on(this, u) && l.force && I(this.contentDOM, l.key, l.keyCode);
      });
  }
  setState(e) {
    if (this.updateState != 0)
    ...
    try {
      ...
      (this.viewState = new ViewState(this, e)),
        (this.plugins = e.facet(U).map((e) => new PluginInstance(e))),
  ...
  updatePlugins(e) {
    let t = e.startState.facet(U),
      n = e.state.facet(U);
    if (t != n) {
      let r = [];
      for (let i of n) {
        let n = t.indexOf(i);
        if (n < 0) r.push(new PluginInstance(i));
        else {
    ...
    for (let e of this.plugins) {
      ...
      if (t && t.docViewUpdate)
        try {
          ...
          V(this.state, e, `doc view update listener`);
        }
    }
  }
  measure(e = !0) {
    ...
    let t = null,
      n = this.viewState.scrollParent,
      r = this.viewState.getScrollOffset(),
      { scrollAnchorPos: i, scrollAnchorHeight: a } = this.viewState;
    Math.abs(r - this.viewState.scrollOffset) > 1 && (a = -1),
    ...
    try {
      for (let e = 0; ; e++) {
        ...
        if (
          ...
          !l.viewportChanged && this.measureRequests.length == 0)
        ) {
            ...
            if (this.viewState.scrollTarget) {
              ...
              let e =
                ((i < 0
                  ...
                  : this.viewState.lineBlockAt(i).top) -
                  a) /
                this.scaleY;
              if (
                (e > 1 || e < -1) &&
                ...
                (r += e),
                  n ? (n.scrollTop += e) : this.win.scrollBy(0, e),
                  (a = -1);
                continue;
              }
            }
    ...
    if (t && !t.empty) for (let e of this.state.facet(rt)) e(t);
  }
  get themeClasses() {
    return (
      pr + ` ` + (this.state.facet(fr) ? hr : mr) + ` ` + this.state.facet(dr)
    );
  }
  updateAttrs() {
    let e = Er(this, mt, {
      ...
      t = {
        ...
        translate: `no`,
        contenteditable: this.state.facet(H) ? `true` : `false`,
        class: `cm-content`,
        style: `${T.tabSize}: ${this.state.tabSize}`,
        role: `textbox`,
        "aria-multiline": `true`,
      };
    this.state.readOnly && (t[`aria-readonly`] = `true`), Er(this, ht, t);
    let n = this.observer.ignore(() => {
      let n = ge(this.contentDOM, this.contentAttrs, t),
        r = ge(this.dom, this.editorAttrs, e);
      return n || r;
    });
  ...
  mountStyles() {
    this.styleModules = this.state.facet(G);
    let e = this.state.facet(EditorView.cspNonce);
    x.mount(
      this.root,
      this.styleModules.concat(vr).reverse(),
      e ? { nonce: e } : void 0,
    );
  }
  readMeasured() {
  ...
  moveByChar(e, t, n) {
    return $t(this, e, Yt(this, e, t, n));
  }
  moveByGroup(e, t) {
    return $t(
      this,
      e,
      Yt(this, e, t, (t) => Xt(this, e.head, t)),
    );
  }
  visualLineSide(e, t) {
    let n = this.bidiSpans(e),
      ...
      a = n[t ? n.length - 1 : 0];
    return i.cursor(a.side(t, r) + e.from, a.forward(!t, r) ? 1 : -1);
  }
  moveToLineBoundary(e, t, n = !0) {
    return Jt(this, e, t, n);
  }
  moveVertically(e, t, n) {
    return $t(this, e, Zt(this, e, t, n));
  }
  domAtPos(e, t = 1) {
  ...
  coordsAtPos(e, t = 1) {
    ...
    let r = this.state.doc.lineAt(e),
      i = this.bidiSpans(r),
      a = i[BidiSpan.find(i, e - r.from, -1, t)];
    return N(n, (a.dir == L.LTR) == t > 0);
  }
  coordsForChar(e) {
  ...
  bidiSpans(e) {
    if (e.length > wr) return Ye(e.length);
    ...
    for (let r of this.bidiCache)
      if (
        r.from == e.from &&
        r.dir == t &&
        (r.fresh || He(r.isolates, (n = bt(this, e))))
      )
        return r.order;
    n || (n = bt(this, e));
    let r = Je(e.text, t, n);
    return this.bidiCache.push(new CachedOrder(e.from, e.to, t, n, !0, r)), r;
  }
  get hasFocus() {
    var e;
    return (
      (this.dom.ownerDocument.hasFocus() ||
        (T.safari &&
          ((e = this.inputState) == null ? void 0 : e.lastContextMenu) >
            Date.now() - 3e4)) &&
  ...
  focus() {
    this.observer.ignore(() => {
      Oe(this.contentDOM), this.docView.updateSelection();
    });
  }
  setRoot(e) {
    this._root != e &&
  ...
  static scrollIntoView(e, t = {}) {
    ...
    return dt.of(
      new ScrollTarget(
        typeof e == `number` ? i.cursor(e) : e,
        (n = t.y) == null ? `nearest` : n,
        (r = t.x) == null ? `nearest` : r,
        (a = t.yMargin) == null ? 5 : a,
        (o = t.xMargin) == null ? 5 : o,
      ),
    );
  }
  scrollSnapshot() {
    ...
    return dt.of(
      new ScrollTarget(i.cursor(n.from), `start`, `start`, n.top - e, t, !0),
    );
  }
  setTabFocusMode(e) {
    e == null
  ...
  static theme(e, t) {
    let n = x.newName(),
      r = [dr.of(n), G.of(_r(`.${n}`, e))];
    return t && t.dark && r.push(fr.of(!0)), r;
  }
  static baseTheme(e) {
    return m.lowest(G.of(_r(`.` + pr, e, gr)));
  }
  static findFromDOM(e) {
    var t;
    let n = e.querySelector(`.cm-content`),
      r = (n && Tile.get(n)) || Tile.get(e);
    return (
      ((t = r == null ? void 0 : r.root) == null ? void 0 : t.view) || null
    );
  }
}
(EditorView.styleModule = G),
  (EditorView.inputHandler = it),
  (EditorView.clipboardInputFilter = ot),
  (EditorView.clipboardOutputFilter = st),
  (EditorView.scrollHandler = ut),
  (EditorView.focusChangeEffect = at),
  (EditorView.perLineTextDirection = ct),
  (EditorView.exceptionSink = nt),
  (EditorView.updateListener = rt),
  (EditorView.editable = H),
  (EditorView.mouseSelectionStyle = tt),
  (EditorView.dragMovesSelection = et),
  (EditorView.clickAddsSelectionRange = $e),
  (EditorView.decorations = gt),
  (EditorView.blockWrappers = _t),
  (EditorView.outerDecorations = vt),
  (EditorView.atomicRanges = W),
  (EditorView.bidiIsolatedRanges = yt),
  (EditorView.cursorScrollMargin = /* @__PURE__ */ a.define({
    combine: (e) => {
      let t = 5,
        n = 5;
      for (let r of e)
        typeof r == `number` ? (t = n = r) : ({ x: t, y: n } = r);
      return { x: t, y: n };
    },
  })),
  (EditorView.scrollMargins = xt),
  (EditorView.darkTheme = fr),
  (EditorView.cspNonce = /* @__PURE__ */ a.define({
    combine: (e) => (e.length ? e[0] : ``),
  })),
  (EditorView.contentAttributes = ht),
  (EditorView.editorAttributes = mt),
  (EditorView.lineWrapping = /* @__PURE__ */ EditorView.contentAttributes.of({
    class: `cm-lineWrapping`,
  })),
  (EditorView.announce = /* @__PURE__ */ o.define());
const wr = 4096,
  Tr = {};
class CachedOrder {
  ...
  static update(e, t) {
    ...
    let n = [],
      r = e.length ? e[e.length - 1].dir : L.LTR;
    for (let i = Math.max(0, e.length - 10); i < e.length; i++) {
      let a = e[i];
      a.dir == r &&
        !t.touchesRange(a.from, a.to) &&
        n.push(
          new CachedOrder(
            t.mapPos(a.from, 1),
            t.mapPos(a.to, -1),
...
function Er(e, t, n) {
  for (let r = e.state.facet(t), i = r.length - 1; i >= 0; i--) {
    let t = r[i],
      a = typeof t == `function` ? t(e) : t;
    a && fe(a, n);
  }
  return n;
}
const Dr = T.mac ? `mac` : T.windows ? `win` : T.linux ? `linux` : `key`;
function Or(e, t) {
  let n = e.split(/-(?!$)/),
    r = n[n.length - 1];
  r == `Space` && (r = ` `);
...
const Ar = /* @__PURE__ */ m.default(
    /* @__PURE__ */ EditorView.domEventHandlers({
      keydown(e, t) {
        return Rr(Nr(t.state), e, t, `editor`);
      },
    }),
  ),
  jr = /* @__PURE__ */ a.define({ enables: Ar }),
  Mr = /* @__PURE__ */ new WeakMap();
function Nr(e) {
  let t = e.facet(jr),
    n = Mr.get(t);
  return n || Mr.set(t, (n = Ir(t.reduce((e, t) => e.concat(t), [])))), n;
}
function Pr(e, t, n) {
  return Rr(Nr(e.state), t, e, n);
}
let Z = null;
const Fr = 4e3;
function Ir(e, t = Dr) {
    ...
    a = (e, r, a, o, s) => {
        ...
        i(n, !0),
          u[n] ||
            (u[n] = {
              ...
              run: [
                (t) => {
                  let r = (Z = { view: t, prefix: n, scope: e });
                  return (
                    setTimeout(() => {
                      Z == r && (Z = null);
                    }, 4e3),
      ...
      let p =
        ...
        (u[f] = {
          ...
          stopPropagation: !1,
          run:
            ((l = (c = u._any) == null ? void 0 : c.run) == null
              ? void 0
              : l.slice()) || [],
        });
      a && p.run.push(a),
        o && (p.preventDefault = !0),
        s && (p.stopPropagation = !0);
    };
  for (let r of e) {
    ...
    if (r.any)
      for (let t of e) {
        ...
        e._any ||
          (e._any = { preventDefault: !1, stopPropagation: !1, run: [] });
        let { any: i } = r;
        for (let t in e) e[t].run.push((e) => i(e, Lr));
      }
    let i = r[t] || r.key;
    if (i)
      for (let t of e)
...
function Rr(e, t, n, r) {
  ...
  Z &&
    Z.view == n &&
    Z.scope == r &&
    ((o = Z.prefix + ` `), vn.indexOf(t.keyCode) < 0 && ((c = !0), (Z = null)));
  let u = /* @__PURE__ */ new Set(),
    d = (e) => {
      if (e) {
        for (let t of e.run)
          if (!u.has(t) && (u.add(t), t(n)))
            return e.stopPropagation && (l = !0), !0;
        ...
        : a &&
          ...
          ? (d(f[o + kr(p, t, !0)]) ||
              (t.shiftKey &&
                ...
                d(f[o + kr(m, t, !1)]))) &&
            (s = !0)
          : a && t.shiftKey && d(f[o + kr(i, t, !0)]) && (s = !0),
      !s && d(f._any) && (s = !0)),
    c && (s = !0),
    s && l && t.stopPropagation(),
    (Lr = null),
    s
  );
}
...
function Br(e, t, n, r) {
  ...
  let a = e.dom.getBoundingClientRect(),
    o = (i.top + i.bottom) / 2,
    s = e.posAtCoords({ x: a.left + 1, y: o }),
    c = e.posAtCoords({ x: a.right - 1, y: o });
...
function Vr(e, t, n) {
  ...
  let r = Math.max(n.from, e.viewport.from),
    ...
    a = e.textDirection == L.LTR,
    o = e.contentDOM,
    s = o.getBoundingClientRect(),
    c = zr(e),
    l = o.querySelector(`.cm-line`),
    u = l && window.getComputedStyle(l),
    d =
      s.left +
      (u ? parseInt(u.paddingLeft) + Math.min(0, parseInt(u.textIndent)) : 0),
    f = s.right - (u ? parseInt(u.paddingRight) : 0),
    p = qt(e, r, 1),
    m = qt(e, i, -1),
    h = p.type == E.Text ? p : null,
    g = m.type == E.Text ? m : null;
  if (
    (h && (e.lineWrapping || p.widgetLineBreaks) && (h = Br(e, r, 1, h)),
    g && (e.lineWrapping || m.widgetLineBreaks) && (g = Br(e, i, -1, g)),
    h && g && h.from == g.from && h.to == g.to)
  )
    return v(y(n.from, n.to, h));
  {
    let t = h ? y(n.from, null, h) : b(p, !1),
      r = g ? y(null, n.to, g) : b(m, !0),
      i = [];
    return (
      ...
      (p.widgetLineBreaks > 1 && t.bottom + e.defaultLineHeight / 2 < r.top)
        ...
        : t.bottom < r.top &&
          e.elementAtHeight((t.bottom + r.top) / 2).type == E.Text &&
  ...
  function y(t, n, r) {
    ...
    function c(t, n, c, l, u) {
      let p = e.coordsAtPos(t, t == r.to ? -2 : 2),
        m = e.coordsAtPos(c, c == r.from ? 2 : -2);
      !p ||
        !m ||
        ((i = Math.min(p.top, m.top, i)),
        (o = Math.max(p.bottom, m.bottom, o)),
        u == L.LTR
          ? s.push(a && n ? d : p.left, a && l ? f : m.right)
          : s.push(!a && l ? d : m.left, !a && n ? f : p.right));
    }
    let l = t == null ? r.from : t,
      u = n == null ? r.to : n;
    ...
    return (
      s.length == 0 && c(l, t == null, u, n == null, e.textDirection),
      { top: i, bottom: o, horizontal: s }
    );
  }
  function b(e, t) {
...
class LayerView {
  ...
  update(e) {
    e.startState.facet(Ur) != e.state.facet(Ur) && this.setOrder(e.state),
...
const Ur = /* @__PURE__ */ a.define();
function Wr(e) {
  return [ViewPlugin.define((t) => new LayerView(t, e)), Ur.of(e)];
}
const Q = /* @__PURE__ */ a.define({
  combine(e) {
    return _(
      e,
...
function Gr(e = {}) {
  return [Q.of(e), Jr, Xr, Zr, lt.of(!0)];
}
function Kr(e) {
  return e.facet(Q);
}
function qr(e) {
  return e.startState.facet(Q) != e.state.facet(Q);
}
const Jr = /* @__PURE__ */ Wr({
  above: !0,
  markers(e) {
    let { state: t } = e,
      n = t.facet(Q),
    ...
    for (let a of t.selection.ranges) {
      ...
      if (
        a.empty ||
        (n.drawRangeCursor && !(o && T.ios && n.iosSelectionHandles))
      ) {
        let t = o
            ? `cm-cursor cm-cursor-primary`
            : `cm-cursor cm-cursor-secondary`,
          n = a.empty ? a : i.cursor(a.head, a.assoc);
        for (let i of RectangleMarker.forRange(e, t, n)) r.push(i);
      }
    }
    return r;
  },
  update(e, t) {
    ...
    let n = qr(e);
    return n && Yr(e.state, t), e.docChanged || e.selectionSet || n;
  },
  mount(e, t) {
    Yr(t.state, e);
  },
...
function Yr(e, t) {
  t.style.animationDuration = e.facet(Q).cursorBlinkRate + `ms`;
}
const Xr = /* @__PURE__ */ Wr({
    above: !1,
    markers(e) {
      let t = [],
        { main: n, ranges: r } = e.state.selection;
      for (let n of r)
        if (!n.empty)
          for (let r of RectangleMarker.forRange(
            e,
            `cm-selectionBackground`,
            n,
          ))
            t.push(r);
      if (T.ios && !n.empty && e.state.facet(Q).iosSelectionHandles) {
        for (let r of RectangleMarker.forRange(
          e,
    ...
    update(e, t) {
      return e.docChanged || e.selectionSet || e.viewportChanged || qr(e);
    },
    class: `cm-selectionLayer`,
  }),
  Zr = /* @__PURE__ */ m.highest(
  ...
  $r = /* @__PURE__ */ v.define({
    ...
    update(e, t) {
      return (
        e != null && (e = t.changes.mapPos(e)),
        t.effects.reduce((e, t) => (t.is(Qr) ? t.value : e), e)
      );
    },
  }),
  ei = /* @__PURE__ */ ViewPlugin.fromClass(
    class {
      constructor(e) {
        (this.view = e),
          (this.cursor = null),
        ...
        if (this.cursor) {
          ...
          e
            ? ((this.cursor.style.left = e.left / t + `px`),
              ...
              (this.cursor.style.height = e.height / n + `px`))
      ...
      setDropPos(e) {
        this.view.state.field($r) != e &&
          this.view.dispatch({ effects: Qr.of(e) });
      }
    },
    {
      eventObservers: {
...
function ni(e, t, n, r, i) {
  t.lastIndex = 0;
  for (let a = e.iterRange(n, r), o = n, s; !a.next().done; o += a.value.length)
    if (!a.lineBreak) for (; (s = t.exec(a.value)); ) i(o + s.index, s);
}
function ri(e, t) {
...
class MatchDecorator {
  ...
  createDeco(e) {
    let t = new y(),
      n = t.add.bind(t);
    for (let { from: t, to: r } of ri(e, this.maxLength))
      ni(e.state.doc, this.regexp, t, r, (t, r) => this.addMatch(r, e, t, n));
    return t.finish();
  }
  updateDeco(e, t) {
    let n = 1e9,
    ...
    for (let i of e.visibleRanges) {
      ...
      if (o >= a) {
        ...
        if (n == r)
          ...
          ni(e.state.doc, this.regexp, s, c, (t, n) =>
...
function ci() {
  var e;
  if (si == null && typeof document < `u` && document.body) {
    let t = document.body.style;
    si = ((e = t.tabSize) == null ? t.MozTabSize : e) != null;
  }
  return si || !1;
}
const li = /* @__PURE__ */ a.define({
  combine(e) {
    let t = _(e, { render: null, specialChars: ai, addSpecialChars: null });
    return (
      (t.replaceTabs = !ci()) &&
        (t.specialChars = RegExp(`	|` + t.specialChars.source, ii)),
      t.addSpecialChars &&
...
function fi() {
  return (
    di ||
    (di = ViewPlugin.fromClass(
      class {
        constructor(e) {
          (this.view = e),
            (this.decorations = Decoration.none),
            (this.decorationCache = Object.create(null)),
            (this.decorator = this.makeDecorator(e.state.facet(li))),
          ...
          return new MatchDecorator({
            ...
            decoration: (t, n, r) => {
              ...
              return (
                ...
                (this.decorationCache[a] = Decoration.replace({
                  widget: new SpecialCharWidget(e, a),
                }))
              );
            },
        ...
        update(e) {
          let t = e.state.facet(li);
          e.startState.facet(li) == t
...
const pi = `•`;
function mi(e) {
  return e >= 32 ? `•` : e == 10 ? `␤` : String.fromCharCode(9216 + e);
}
  ...
  toDOM(e) {
    let t = mi(this.code),
      n =
        ...
        ` ` +
        (oi[this.code] || `0x` + this.code.toString(16)),
      r = this.options.render && this.options.render(this.code, n, t);
    if (r) return r;
...
const hi = /* @__PURE__ */ ViewPlugin.fromClass(
  class {
    constructor() {
    ...
    update(e) {
      let { view: t } = e,
        n =
          t.viewState.editorHeight -
          t.defaultLineHeight -
          t.documentPadding.top -
          0.5;
      n >= 0 &&
        n != this.height &&
        ((this.height = n), (this.attrs = { style: `padding-bottom: ${n}px` }));
    }
  },
);
function gi() {
  return [
    ...
    ht.of((e) => {
      var t;
      return ((t = e.plugin(hi)) == null ? void 0 : t.attrs) || null;
    }),
  ];
}
function _i() {
...
const vi = /* @__PURE__ */ Decoration.line({ class: `cm-activeLine` }),
  yi = /* @__PURE__ */ ViewPlugin.fromClass(
    class {
      constructor(e) {
      ...
      getDeco(e) {
        ...
        for (let r of e.state.selection.ranges) {
          ...
          i.from > t && (n.push(vi.range(i.from)), (t = i.from));
        }
...
class Placeholder extends WidgetType {
  ...
  coordsAt(e) {
    let t = e.firstChild ? k(e.firstChild) : [];
    if (!t.length) return null;
    let n = window.getComputedStyle(e.parentNode),
      r = N(t[0], n.direction != `rtl`),
      i = parseInt(n.lineHeight);
    return r.bottom - r.top > i * 1.5
      ? { left: r.left, right: r.right, top: r.top, bottom: r.top + i }
      : r;
  }
  ignoreEvent() {
    return !1;
...
function bi(e) {
  ...
  return typeof e == `string`
    ? [t, EditorView.contentAttributes.of({ "aria-placeholder": e })]
    : t;
}
const xi = 2e3;
function Si(e, t, n) {
  let r = Math.min(t.line, n.line),
    ...
    o = [];
  if (t.off > xi || n.off > xi || t.col < 0 || n.col < 0) {
    let s = Math.min(t.off, n.off),
      c = Math.max(t.off, n.off);
    for (let t = r; t <= a; t++) {
      let n = e.doc.line(t);
      n.length <= c && o.push(i.range(n.from + s, n.to + c));
    }
  } else {
    let s = Math.min(t.col, n.col),
      c = Math.max(t.col, n.col);
    for (let t = r; t <= a; t++) {
      let n = e.doc.line(t),
        r = l(n.text, s, e.tabSize, !0);
      if (r < 0) o.push(i.cursor(n.to));
      else {
        let t = l(n.text, c, e.tabSize);
        o.push(i.range(n.from + r, n.from + t));
      }
    }
  }
  return o;
  ...
  let n = e.posAtCoords({ x: t.clientX, y: t.clientY }, !1),
    ...
    a =
      i > xi
        ...
        : i == r.length
          ? Ci(e, t.clientX)
          : b(r.text, e.state.tabSize, n - r.from);
  ...
  return n
    ? {
        ...
        get(t, a, o) {
          let s = wi(e, t);
          if (!s) return r;
          let c = Si(e.state, n, s);
          return c.length
            ? o
              ? i.create(c.concat(r.ranges))
              : i.create(c)
            : r;
        },
      }
...
function Ei(e) {
  let t =
    (e == null ? void 0 : e.eventFilter) || ((e) => e.altKey && e.button == 0);
  return EditorView.mouseSelectionStyle.of((e, n) => (t(n) ? Ti(e, n) : null));
}
const Di = {
    Alt: [18, (e) => !!e.altKey],
  ...
  Oi = { style: `cursor: crosshair` };
function ki(e = {}) {
  let [t, n] = Di[e.key || `Alt`],
  ...
  return [
    ...
    EditorView.contentAttributes.of((e) => {
      var t;
      return (t = e.plugin(r)) != null && t.isDown ? Oi : null;
    }),
  ];
}
const Ai = `-10000px`;
class TooltipViewManager {
  ...
  update(e, t) {
    ...
    for (let e of this.tooltipViews)
      a.indexOf(e) < 0 &&
        (this.removeTooltipView(e), (n = e.destroy) == null || n.call(e));
    return (
...
const Ni = /* @__PURE__ */ a.define({
    combine: (e) => {
      var t, n, r;
      return {
        position: T.ios
          ? `absolute`
          : ((t = e.find((e) => e.position)) == null ? void 0 : t.position) ||
            `fixed`,
        parent:
          ((n = e.find((e) => e.parent)) == null ? void 0 : n.parent) || null,
        tooltipSpace:
          ((r = e.find((e) => e.tooltipSpace)) == null
            ? void 0
            : r.tooltipSpace) || Mi,
      };
    },
  ...
  Fi = /* @__PURE__ */ ViewPlugin.fromClass(
    class {
      constructor(e) {
        (this.view = e),
          (this.above = []),
      ...
      destroy() {
        ...
        for (let t of this.manager.tooltipViews)
          t.dom.remove(), (e = t.destroy) == null || e.call(t);
        this.parent && this.container.remove(),
      ...
      readMeasure() {
        ...
        if (this.position == `fixed` && this.manager.tooltipViews.length) {
          ...
          if (T.safari) {
            ...
            n =
              !!e.offsetParent &&
              e.offsetParent != this.container.ownerDocument.body;
        }
        ...
        return {
          ...
          space: this.view.state.facet(Ni).tooltipSpace(this.view),
          scaleX: e,
          scaleY: t,
          makeAbsolute: n,
        };
      ...
      writeMeasure(e) {
        ...
        let { visible: n, space: r, scaleX: i, scaleY: a } = e,
          o = [];
        for (let s = 0; s < this.manager.tooltips.length; s++) {
          let c = this.manager.tooltips[s],
            l = this.manager.tooltipViews[s],
            { dom: u } = l,
            d = e.pos[s],
            f = e.size[s];
          if (
          ...
          let p = c.arrow ? l.dom.querySelector(`.cm-tooltip-arrow`) : null,
            m = p ? 7 : 0,
            h = f.right - f.left,
            g = (t = Pi.get(l)) == null ? f.bottom - f.top : t,
            _ = l.offset || Ri,
            v = this.view.textDirection == L.LTR,
            y =
              f.width > r.right - r.left
                ...
                : v
                  ? Math.max(
                      r.left,
                      Math.min(d.left - (p ? 14 : 0) + _.x, r.right - h),
                    )
                  : Math.min(
                      Math.max(r.left, d.left - h + (p ? 14 : 0) - _.x),
                      r.right - h,
                    ),
            b = this.above[s];
          !c.strictSide &&
            (b
              ? d.top - g - m - _.y < r.top
              : d.bottom + g + m + _.y > r.bottom) &&
            b == r.bottom - d.bottom > d.top - r.top &&
            (b = this.above[s] = !b);
          let x = (b ? d.top - r.top : r.bottom - d.bottom) - m;
          if (x < g && l.resize !== !1) {
            if (x < this.view.defaultLineHeight) {
              u.style.top = Ai;
              continue;
            }
            Pi.set(l, g), (u.style.height = (g = x) / a + `px`);
          } else u.style.height && (u.style.height = ``);
          let S = b ? d.top - g - m - _.y : d.bottom + m + _.y,
            ee = y + h;
          if (l.overlap !== !0)
            for (let e of o)
              e.left < ee &&
                ...
                e.top < S + g &&
                e.bottom > S &&
                (S = b ? e.top - g - 2 - m : e.bottom + m + 2);
          if (
            (this.position == `absolute`
              ? ((u.style.top = (S - e.parent.top) / a + `px`),
                Ii(u, (y - e.parent.left) / i))
              : ((u.style.top = S / a + `px`), Ii(u, y / i)),
            p)
          ) {
          ...
          l.overlap !== !0 &&
            o.push({ left: y, top: S, right: ee, bottom: S + g }),
            u.classList.toggle(`cm-tooltip-above`, b),
            u.classList.toggle(`cm-tooltip-below`, !b),
      ...
      maybeMeasure() {
        if (
          ...
          for (let e of this.manager.tooltipViews) e.dom.style.top = Ai;
      }
    },
    {
      eventObservers: {
...
const Li = /* @__PURE__ */ EditorView.baseTheme({
  ...
  Ri = { x: 0, y: 0 },
  zi = /* @__PURE__ */ a.define({ enables: [Fi, Li] }),
  Bi = /* @__PURE__ */ a.define({
...
const Vi = /* @__PURE__ */ zi.compute([Bi], (e) => {
    let t = e.facet(Bi);
    return t.length === 0
      ? null
      : {
...
class HoverPlugin {
  ...
  startHover() {
    ...
    let { view: e, lastMove: t } = this,
      n = e.docView.tile.nearest(t.target);
    if (!n) return;
    let r,
      i = 1;
    ...
    let i = this.source(e, t, n),
      a = (t) => {
        if (t && !(Array.isArray(t) && !t.length)) {
          ...
          r && this.locked.set(n, r),
            e.dispatch({ effects: this.setHover.of(n) });
        }
      };
    if (i && `then` in i) {
      ...
      i.then(
        ...
        (t) => V(e.state, t, `hover tooltip`),
      );
    } else a(i);
  }
  get tooltip() {
    let e = this.view.plugin(Fi),
      t = e
        ? e.manager.tooltips.findIndex(
            (e) => e.create == HoverTooltipHost.create,
          )
        : -1;
  ...
  mousemove(e) {
    ...
    if (
      (r.length && !this.locked.has(r) && i && !Wi(i.dom, e)) ||
      this.pending
    ) {
      let { pos: i } = r[0] || this.pending,
        a = (n = (t = r[0]) == null ? void 0 : t.end) == null ? i : n;
      (i == a
        ? this.view.posAtCoords(this.lastMove) != i
        : !Gi(this.view, i, a, e.clientX, e.clientY)) &&
...
const Ui = 4;
function Wi(e, t) {
  let { left: n, right: r, top: i, bottom: a } = e.getBoundingClientRect(),
    o;
  ...
  let r = o.define(),
    ...
    a = v.define({
      ...
      update(e, o) {
        ...
        if (
          (e.length &&
            ((t.hideOnChange && (o.docChanged || o.selection)) || (s && s(o))
              ? (e = [])
              : t.hideOn && (e = e.filter((e) => !t.hideOn(o, e)))),
          o.docChanged && e.length)
        ) {
          let t = [];
          for (let r of e) {
            let e = o.changes.mapPos(r.pos, -1, n.TrackDel);
            if (e != null) {
              let n = Object.assign(Object.create(null), r);
              (n.pos = e),
                n.end != null && (n.end = o.changes.mapPos(n.end)),
                t.push(n);
            }
          }
          e = t;
        }
        for (let t of o.effects)
          t.is(r) && ((e = t.value), (s = void 0)),
            ((t.is(Xi) && !t.value) || t.value == a) && (e = []);
        return e.length && s && i.set(e, s), e;
      },
      provide: (e) => Bi.from(e),
    }),
    s = ViewPlugin.define(
      (n) => new HoverPlugin(n, e, a, i, r, t.hoverTime || 300),
    );
  return { active: a, extension: [a, s, Hi.of(s), Vi] };
}
function qi(e, t, n, r = {}) {
  var i;
  let a = e.state
  ...
  for (let o of a)
    o.activateHover(e, t, n, (i = r.until) == null ? () => !1 : i);
}
function Ji(e, t) {
  let n = e.plugin(Fi);
  if (!n) return null;
...
function Yi(e) {
  return e.facet(Bi).some((e) => e);
}
const Xi = /* @__PURE__ */ o.define(),
  Zi = /* @__PURE__ */ Xi.of(null);
function Qi(e) {
  return Xi.of(e.active);
}
function $i(e) {
  let t = e.plugin(Fi);
  t && t.maybeMeasure();
}
const ea = /* @__PURE__ */ a.define({
  combine(e) {
    let t, n;
...
const ra = /* @__PURE__ */ ViewPlugin.fromClass(
  class {
    constructor(e) {
      (this.input = e.state.facet(aa)),
        (this.specs = this.input.filter((e) => e)),
        (this.panels = this.specs.map((t) => t(e)));
      let t = e.state.facet(ea);
      (this.top = new PanelGroup(e, !0, t.topContainer)),
        (this.bottom = new PanelGroup(e, !1, t.bottomContainer)),
    ...
    update(e) {
      ...
      this.top.container != t.topContainer &&
        (this.top.sync([]),
        (this.top = new PanelGroup(e.view, !0, t.topContainer))),
        this.bottom.container != t.bottomContainer &&
          (this.bottom.sync([]),
          (this.bottom = new PanelGroup(e.view, !1, t.bottomContainer))),
        this.top.syncClasses(),
        this.bottom.syncClasses();
      let n = e.state.facet(aa);
      if (n != this.input) {
        let t = n.filter((e) => e),
          r = [],
          i = [],
        ...
        for (let n of t) {
          ...
          t < 0
            ? ((s = n(e.view)), o.push(s))
            : ((s = this.panels[t]), s.update && s.update(e)),
            r.push(s),
            (s.top ? i : a).push(s);
        }
        (this.specs = t),
...
const aa = /* @__PURE__ */ a.define({ enables: ra });
function oa(e, t) {
  let n,
    r = new Promise((e) => (n = e)),
    i = (e) => da(e, t, n);
  e.state.field(ca, !1)
    ? e.dispatch({ effects: la.of(i) })
    : e.dispatch({ effects: o.appendConfig.of(ca.init(() => [i])) });
  let a = ua.of(i);
  return {
    close: a,
    result: r.then(
      (t) => (
        (e.win.queueMicrotask || ((t) => e.win.setTimeout(t, 10)))(() => {
          e.state.field(ca).indexOf(i) > -1 && e.dispatch({ effects: a });
        }),
        t
      ),
    ),
...
const ca = /* @__PURE__ */ v.define({
    ...
    update(e, t) {
      for (let n of t.effects)
        n.is(la)
          ? (e = [n.value].concat(e))
          : n.is(ua) && (e = e.filter((e) => e != n.value));
      return e;
    },
    provide: (e) => aa.computeN([e], (t) => t.field(e)),
  }),
  la = /* @__PURE__ */ o.define(),
  ua = /* @__PURE__ */ o.define();
function da(e, t, n) {
  let r = t.content ? t.content(e, () => o(null)) : null;
  if (!r) {
    if (((r = C(`form`)), t.input)) {
      let e = C(`input`, t.input);
      /^(text|password|number|email|tel|url)$/.test(e.type) &&
        e.classList.add(`cm-textfield`),
        e.name || (e.name = `input`),
        r.appendChild(C(`label`, (t.label || ``) + `: `, e));
  ...
  for (let e = 0; e < i.length; e++) {
    ...
    t.addEventListener(`keydown`, (e) => {
      e.keyCode == 27
        ...
        : e.keyCode == 13 && (e.preventDefault(), o(t));
    }),
    ...
    mount: () => {
      if (t.focus) {
        ...
        (e =
          ...
          e && `select` in e ? e.select() : e && `focus` in e && e.focus();
      }
    },
  };
}
class GutterMarker extends e {
  compare(e) {
    return this == e || (this.constructor == e.constructor && this.eq(e));
  }
  eq(e) {
...
(GutterMarker.prototype.elementClass = ``),
  ...
  (GutterMarker.prototype.mapMode = n.TrackBefore),
  (GutterMarker.prototype.startSide = GutterMarker.prototype.endSide = -1),
  (GutterMarker.prototype.point = !0);
const fa = /* @__PURE__ */ a.define(),
  pa = /* @__PURE__ */ a.define(),
  ma = {
    class: ``,
  ...
  ha = /* @__PURE__ */ a.define();
function ga(e) {
  return [va(), ha.of({ ...ma, ...e })];
}
const _a = /* @__PURE__ */ a.define({ combine: (e) => e.some((e) => e) });
function va(e) {
  let t = [ya];
  return e && e.fixed === !1 && t.push(_a.of(!0)), t;
}
const ya = /* @__PURE__ */ ViewPlugin.fromClass(
  class {
    constructor(e) {
      (this.view = e),
        (this.domAfter = null),
        ...
        (this.gutters = e.state
          .facet(ha)
          .map((t) => new SingleGutterView(e, t))),
        (this.fixed = !e.state.facet(_a));
    ...
    update(e) {
      ...
      this.view.state.facet(_a) != !this.fixed &&
    ...
    syncGutters(e) {
      let n = this.dom.nextSibling;
      e && (this.dom.remove(), this.domAfter && this.domAfter.remove());
      let r = t.iter(this.view.state.facet(fa), this.view.viewport.from),
        i = [],
        a = this.gutters.map(
          (e) =>
            new UpdateContext(
      ...
      for (let e of this.view.viewportLineBlocks)
        if ((i.length && (i = []), Array.isArray(e.type))) {
          let t = !0;
          for (let n of e.type)
            if (n.type == E.Text && t) {
              xa(r, i, n.from);
              for (let e of a) e.line(this.view, n, i);
              t = !1;
            } else if (n.widget) for (let e of a) e.widget(this.view, n);
        } else if (e.type == E.Text) {
          xa(r, i, e.from);
          for (let t of a) t.line(this.view, e, i);
        } else if (e.widget) for (let t of a) t.widget(this.view, e);
      for (let e of a) e.finish();
      e &&
        (this.view.scrollDOM.insertBefore(this.dom, n),
        this.domAfter && this.view.scrollDOM.appendChild(this.domAfter));
    }
    updateGutters(e) {
      let n = e.startState.facet(ha),
        r = e.state.facet(ha),
        i =
          e.docChanged ||
          e.heightChanged ||
          e.viewportChanged ||
          !t.eq(
            e.startState.facet(fa),
            e.state.facet(fa),
            e.view.viewport.from,
            e.view.viewport.to,
          );
      if (n == r) for (let t of this.gutters) t.update(e) && (i = !0);
      else {
        i = !0;
        let t = [];
        for (let i of r) {
          let r = n.indexOf(i);
          r < 0
            ? t.push(new SingleGutterView(this.view, i))
            : (this.gutters[r].update(e), t.push(this.gutters[r]));
        }
        for (let e of this.gutters)
          e.dom.remove(), t.indexOf(e) < 0 && e.destroy();
        for (let e of t)
          e.config.side == `after`
            ? this.getDOMAfter().appendChild(e.dom)
            : this.dom.appendChild(e.dom);
    ...
    provide: (e) =>
      EditorView.scrollMargins.of((t) => {
        ...
        let r = n.dom.offsetWidth * t.scaleX,
          i = n.domAfter ? n.domAfter.offsetWidth * t.scaleX : 0;
...
class UpdateContext {
  constructor(e, n, r) {
    (this.gutter = e),
      (this.height = r),
      (this.i = 0),
      (this.cursor = t.iter(e.markers, n.from));
  }
  addElement(e, t, n) {
    let { gutter: r } = this,
    ...
    if (this.i == r.elements.length) {
      let t = new GutterElement(e, a, i, n);
  ...
  line(e, t, n) {
    let r = [];
    xa(this.cursor, r, t.from), n.length && (r = r.concat(n));
    let i = this.gutter.config.lineMarker(e, t, r);
    i && r.unshift(i);
    let a = this.gutter;
    (r.length == 0 && !a.config.renderEmptyElements) ||
      this.addElement(e, t, r);
  }
  widget(e, t) {
    let n = this.gutter.config.widgetMarker(e, t.widget, t),
      r = n ? [n] : null;
    for (let n of e.state.facet(pa)) {
...
class SingleGutterView {
  constructor(e, t) {
    ...
    (this.markers = ba(t.markers(e))),
      t.initialSpacer &&
        ((this.spacer = new GutterElement(e, 0, 0, [t.initialSpacer(e)])),
  ...
  update(e) {
    let n = this.markers;
    if (
      ((this.markers = ba(this.config.markers(e.view))),
    ...
    return (
      !t.eq(this.markers, n, r.from, r.to) ||
...
class GutterElement {
  ...
  update(e, t, n, r) {
    this.height != t && ((this.height = t), (this.dom.style.height = t + `px`)),
      ...
      Sa(this.markers, r) || this.setMarkers(e, r);
  }
  setMarkers(e, t) {
    ...
    for (let i = 0, a = 0; ; ) {
      ...
      if (!s) break;
      s.toDOM &&
        (c ? (r = r.nextSibling) : this.dom.insertBefore(s.toDOM(e), r)),
        c && a++;
    }
...
const Ca = /* @__PURE__ */ a.define(),
  wa = /* @__PURE__ */ a.define(),
  $ = /* @__PURE__ */ a.define({
    combine(e) {
      return _(
        e,
...
function Ta(e, t) {
  return e.state.facet($).formatNumber(t, e.state);
}
const Ea = /* @__PURE__ */ ha.compute([$], (e) => ({
  class: `cm-lineNumbers`,
  renderEmptyElements: !1,
  markers(e) {
    return e.state.facet(Ca);
  },
  lineMarker(e, t, n) {
    return n.some((e) => e.toDOM)
      ? null
      : new NumberMarker(Ta(e, e.state.doc.lineAt(t.from).number));
  },
  widgetMarker: (e, t, n) => {
    for (let r of e.state.facet(wa)) {
      let i = r(e, t, n);
      if (i) return i;
    }
    return null;
  },
  lineMarkerChange: (e) => e.startState.facet($) != e.state.facet($),
  initialSpacer(e) {
    return new NumberMarker(Ta(e, Oa(e.state.doc.lines)));
  },
  updateSpacer(e, t) {
    let n = Ta(t.view, Oa(t.view.state.doc.lines));
    return n == e.number ? e : new NumberMarker(n);
  },
  domEventHandlers: e.facet($).domEventHandlers,
  side: `before`,
}));
function Da(e = {}) {
  return [$.of(e), va(), Ea];
...
const ka = /* @__PURE__ */ new (class extends GutterMarker {
    constructor() {
      super(...arguments), (this.elementClass = `cm-activeLineGutter`);
    }
  })(),
  Aa = /* @__PURE__ */ fa.compute([`selection`], (e) => {
    let n = [],
      r = -1;
    for (let t of e.selection.ranges) {
      let i = e.doc.lineAt(t.head).from;
      i > r && ((r = i), n.push(ka.range(i)));
    }
    return t.of(n);
  });
function ja() {
...
const Na = /* @__PURE__ */ Decoration.mark({ class: `cm-highlightTab` }),
  Pa = /* @__PURE__ */ Decoration.mark({ class: `cm-highlightSpace` }),
  Fa = /* @__PURE__ */ Ma(
    /* @__PURE__ */ new MatchDecorator({
      regexp: /\t| /g,
      decoration: (e) => (e[0] == `	` ? Na : Pa),
      boundary: /\S/,
    }),
  );
function Ia() {
...
const za = {
  ...
  computeOrder: Je,
  moveVisually: Ze,
  clearHeightChangeFlag: Jn,
  getHeightChangeFlag: () => Y,
};
export {
  BidiSpan,
  BlockInfo,
  ...
  za as __test,
  qi as activateHover,
  Qi as closeHoverTooltip,
  Zi as closeHoverTooltips,
  ki as crosshairCursor,
  Gr as drawSelection,
  ti as dropCursor,
  sa as getDialog,
  Kr as getDrawSelectionConfig,
  na as getPanel,
  Ji as getTooltip,
  ga as gutter,
  fa as gutterLineClass,
  pa as gutterWidgetClass,
  va as gutters,
  Yi as hasHoverTooltips,
  _i as highlightActiveLine,
  ja as highlightActiveLineGutter,
  ui as highlightSpecialChars,
  Ra as highlightTrailingWhitespace,
  Ia as highlightWhitespace,
  Ki as hoverTooltip,
  jr as keymap,
  Wr as layer,
  Ca as lineNumberMarkers,
  wa as lineNumberWidgetMarker,
  Da as lineNumbers,
  V as logException,
  ta as panels,
  bi as placeholder,
  Ei as rectangularSelection,
  $i as repositionTooltips,
  Pr as runScopeHandlers,
  gi as scrollPastEnd,
  oa as showDialog,
  aa as showPanel,
  zi as showTooltip,
