// @codemirror/view@6.38.1 downloaded from https://ga.jspm.io/npm:@codemirror/view@6.38.1/dist/index.js
...
import { StyleModule as M } from "style-mod";
import { keyName as x, base as S, shift as C } from "w3c-keyname";
import k from "crelt";
function D(t) {
  let e;
...
function T(t) {
  return t.nodeType == 3
    ? G(t, 0, t.nodeValue.length).getClientRects()
    : t.nodeType == 1
      ? t.getClientRects()
      : [];
}
function V(t, e, i, s) {
  return !!i && (R(t, e, i, s, -1) || R(t, e, i, s, 1));
}
function E(t) {
  for (var e = 0; ; e++) {
    t = t.previousSibling;
...
class DOMSelectionState {
  ...
  setRange(t) {
    ...
    this.set(
      e,
      Math.min(t.anchorOffset, e ? L(e) : 0),
      i,
      Math.min(t.focusOffset, i ? L(i) : 0),
    );
  }
  set(t, e, i, s) {
    this.anchorNode = t;
...
let q;
function G(t, e, i = e) {
  let s = q || (q = document.createRange());
  s.setEnd(t, i);
  s.setStart(t, e);
  return s;
}
...
function U(t, e) {
  for (let i = t, s = e; ; ) {
    ...
    if (i.nodeType == 1 && s > 0) {
      ...
      if (!i.parentNode || B(i)) return null;
      s = E(i);
      i = i.parentNode;
    }
  }
...
class DOMPos {
  ...
  static before(t, e) {
    return new DOMPos(t.parentNode, E(t), e);
  }
  static after(t, e) {
    return new DOMPos(t.parentNode, E(t) + 1, e);
  }
}
const Q = [];
class ContentView {
  ...
  sync(t, e) {
    if (this.flags & 2) {
      ...
      for (let n of this.children) {
        if (n.flags & 7) {
          if (!n.dom && (s = o ? o.nextSibling : i.firstChild)) {
            let t = ContentView.get(s);
            (!t || (!t.parent && t.canReuseDOM(n))) && n.reuseDOM(s);
          }
          n.sync(t, e);
          n.flags &= -8;
        }
        s = o ? o.nextSibling : i.firstChild;
        e && !e.written && e.node == i && s != n.dom && (e.written = true);
        if (n.dom.parentNode == i) while (s && s != n.dom) s = J(s);
        else i.insertBefore(n.dom, s);
        o = n.dom;
      }
      s = o ? o.nextSibling : i.firstChild;
      s && e && e.node == i && (e.written = true);
      while (s) s = J(s);
  ...
  localPosFromDOM(t, e) {
    ...
    while (i && !ContentView.get(i)) i = i.nextSibling;
  ...
  setParent(t) {
    if (this.parent != t) {
      this.parent = t;
      this.flags & 7 && this.markParentsDirty(true);
    }
  }
  setDOM(t) {
    if (this.dom != t) {
...
function Z(t, e, i, s, o, n, r, l, a) {
  let { children: h } = t;
  let c = h.length ? h[e] : null;
  let d = n.length ? n[n.length - 1] : null;
  let f = d ? d.breakAfter : r;
  if (
    !(
      e == s &&
      c &&
      ...
      !f &&
      n.length < 2 &&
      c.merge(i, o, n.length ? d : null, i == 0, l, a)
    )
  ) {
    if (s < h.length) {
      let t = h[s];
      if (
        ...
        (o < t.length ||
          (t.breakAfter &&
            (d === null || d === void 0 ? void 0 : d.breakAfter)))
      ) {
        if (e == s) {
          t = t.split(o);
          o = 0;
        }
        if (!f && d && t.merge(0, o, d, true, 0, a)) n[n.length - 1] = t;
        else {
          (o || (t.children.length && !t.children[0].length)) &&
            t.merge(0, o, null, false, 0, a);
          n.push(t);
        }
      } else
        (t === null || t === void 0 ? void 0 : t.breakAfter) &&
    ...
    if (c) {
      c.breakAfter = r;
      if (i > 0) {
        !r && n.length && c.merge(i, c.length, n[0], false, l, 0)
...
const st = /Edge\/(\d+)/.exec(et.userAgent);
const ot = /MSIE \d/.test(et.userAgent);
const nt = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(et.userAgent);
const rt = !!(ot || nt || st);
const lt = !rt && /gecko\/(\d+)/i.test(et.userAgent);
const at = !rt && /Chrome\/(\d+)/.exec(et.userAgent);
const ht = "webkitFontSmoothing" in it.documentElement.style;
const ct = !rt && /Apple Computer/.test(et.vendor);
const dt = ct && (/Mobile\/\w+/.test(et.userAgent) || et.maxTouchPoints > 2);
var ft = {
  mac: dt || /Mac/.test(et.platform),
  windows: /Win/.test(et.platform),
  linux: /Linux|X11/.test(et.platform),
  ie: rt,
  ie_version: ot ? it.documentMode || 6 : nt ? +nt[1] : st ? +st[1] : 0,
  gecko: lt,
  gecko_version: lt ? +(/Firefox\/(\d+)/.exec(et.userAgent) || [0, 0])[1] : 0,
  chrome: !!at,
  chrome_version: at ? +at[1] : 0,
  ios: dt,
  android: /Android\b/.test(et.userAgent),
  webkit: ht,
  safari: ct,
  webkit_version: ht
    ? +(/\bAppleWebKit\/(\d+)/.exec(et.userAgent) || [0, 0])[1]
    : 0,
  tabSize:
    it.documentElement.style.tabSize != null ? "tab-size" : "-moz-tab-size",
};
const ut = 256;
class TextView extends ContentView {
  ...
  sync(t, e) {
    ...
    if (this.dom.nodeValue != this.text) {
      e && e.node == this.dom && (e.written = true);
...
class MarkView extends ContentView {
  ...
  merge(t, e, i, s, o, n) {
    if (
      ...
      return false;
    tt(this, t, e, i ? i.children.slice() : [], o - 1, n - 1);
    this.markDirty();
    return true;
  }
  split(t) {
    ...
    return new MarkView(this.mark, e, n);
  }
  domAtPos(t) {
    return gt(this, t);
  }
...
class WidgetView extends ContentView {
  ...
  become(t) {
    if (
      ...
      this.widget.compare(t.widget) || this.markDirty(true);
  ...
  get overrideDOMText() {
    if (this.length == 0) return t.empty;
    let e = this;
    while (e.parent) e = e.parent;
    let { view: i } = e,
      s = i && i.state.doc,
      o = this.posAtStart;
    return s ? s.slice(o, o + this.length) : t.empty;
  }
  domAtPos(t) {
  ...
  coordsAt(t, e) {
    ...
    for (let e = n ? s.length - 1 : 0; ; e += n ? -1 : 1) {
      o = s[e];
      if (t > 0 ? e == 0 : e == s.length - 1 || o.top < o.bottom) break;
    }
    return P(o, !n);
  }
  get isEditable() {
...
function mt(t, e, i) {
  ...
  if (
    ...
    o.length &&
    (s = o[o.length - 1]) instanceof MarkView &&
    s.mark.eq(e.mark)
  )
    mt(s, e.children[0], i - 1);
  else {
    o.push(e);
    e.setParent(t);
  }
...
function wt(t, e, i) {
  ...
  function l(t, e) {
    for (let a = 0, h = 0; a < t.children.length && h <= e; a++) {
      let c = t.children[a],
        d = h + c.length;
      if (d >= e)
        if (c.children.length) l(c, e - h);
        else if (
          (!n || (n.isHidden && (i > 0 || bt(n, c)))) &&
          (d > e || (h == d && c.getSide() > 0))
        ) {
          n = c;
          r = e - h;
        } else if (h < e || (h == d && c.getSide() < 0 && !c.isHidden)) {
          s = c;
          o = e - h;
        }
      h = d;
  ...
  l(t, e);
  let a = (i < 0 ? s : n) || s || n;
  return a ? a.coordsAt(Math.max(0, a == s ? o : r), i) : vt(t);
}
function vt(t) {
...
class LineDecoration extends Decoration {
  ...
  eq(t) {
    return (
      ...
      xt(this.spec.attributes, t.spec.attributes)
    );
  }
  range(t, e = t) {
    if (e != t)
...
LineDecoration.prototype.mapMode = s.TrackBefore;
...
class PointDecoration extends Decoration {
  constructor(t, e, i, o, n, r) {
    ...
    this.block = o;
    this.isReplace = r;
    this.mapMode = o ? (e <= 0 ? s.TrackBefore : s.TrackAfter) : s.TrackDel;
  }
  get type() {
...
class LineView extends ContentView {
  ...
  merge(t, e, i, s, o, n) {
    if (i) {
      if (!(i instanceof LineView)) return false;
      this.dom || i.transferDOM(this);
    }
    s && this.setDeco(i ? i.attrs : null);
    tt(this, t, e, i ? i.children.slice() : [], o, n);
    return true;
  }
  split(t) {
    let e = new LineView();
  ...
  addLineDeco(t) {
    let e = t.spec.attributes,
      i = t.spec.class;
    e && (this.attrs = yt(e, this.attrs || {}));
    i && (this.attrs = yt({ class: i }, this.attrs || {}));
  }
  domAtPos(t) {
    return gt(this, t);
  }
  ...
  sync(t, e) {
    ...
    while (s && ContentView.get(s) instanceof MarkView) s = s.lastChild;
    if (
      !s ||
      !this.length ||
      (s.nodeName != "BR" &&
        ((i = ContentView.get(s)) === null || i === void 0
          ? void 0
          : i.isEditable) == false &&
        (!ft.ios || !this.children.some((t) => t instanceof TextView)))
    ) {
  ...
  static find(t, e) {
    for (let i = 0, s = 0; i < t.children.length; i++) {
      let o = t.children[i],
        n = s + o.length;
      if (n >= e) {
        if (o instanceof LineView) return o;
        if (n > e) break;
      }
      s = n + o.breakAfter;
    }
...
class BlockWidgetView extends ContentView {
  ...
  become(t) {
    if (
      ...
      t.widget.compare(this.widget) || this.markDirty(true);
      this.dom && !this.prevWidget && (this.prevWidget = this.widget);
      this.widget = t.widget;
      this.length = t.length;
      this.deco = t.deco;
  ...
  coordsAt(t, e) {
    ...
    return (
      ...
      (this.widget instanceof BlockGapWidget
        ? null
        : P(this.dom.getBoundingClientRect(), this.length ? t == 0 : e <= 0))
    );
  }
  destroy() {
    super.destroy();
...
class ContentBuilder {
  ...
  flushBuffer(t = this.bufferMarks) {
    if (this.pendingBuffer) {
      this.curLine.append(Tt(new WidgetBufferView(-1), t), t.length);
      this.pendingBuffer = 0;
    }
  }
  addBlockWidget(t) {
  ...
  buildText(t, e, i) {
    while (t > 0) {
      ...
      this.getLine().append(
        Tt(new TextView(this.text.slice(this.textOff, this.textOff + s)), e),
        i,
      );
      this.atCursorPos = true;
      this.textOff += s;
  ...
  point(t, e, i, s, o, n) {
    if (this.disallowBlockEffectsFor[n] && i instanceof PointDecoration) {
      if (i.block)
        throw new RangeError(
    ...
    if (i instanceof PointDecoration)
      if (i.block) {
        ...
        this.addBlockWidget(
          new BlockWidgetView(i.widget || NullWidget.block, r, i),
        );
      } else {
        let n = WidgetView.create(
        ...
        this.flushBuffer(s);
        if (l) {
          h.append(Tt(new WidgetBufferView(1), s), o);
          o = s.length + Math.max(0, o - s.length);
        }
        h.append(Tt(n, s), o);
        this.atCursorPos = a;
        this.pendingBuffer = a ? (t < e || o > s.length ? 1 : 2) : 0;
    ...
    if (r) {
      if (this.textOff + r <= this.text.length) this.textOff += r;
      else {
  ...
  static build(t, e, s, o, n) {
    let r = new ContentBuilder(t, e, s, n);
    r.openEnd = i.spans(o, e, s, r);
...
function qt(t, e, i, s, o) {
  for (let n = 0; n <= s.length; n++) {
    ...
    for (let t = r, e = a, s = a; t < l; t++) {
      let o = It[t];
      if (o == 128)
        t < l - 1 && e == It[t + 1] && e & 24 ? (o = It[t] = e) : (It[t] = 256);
      else if (o == 64) {
        let o = t + 1;
        while (o < l && It[o] == 64) o++;
        let n = (t && e == 8) || (o < i && It[o] == 8) ? (s == 1 ? 1 : 8) : 256;
        for (let e = t; e < o; e++) It[e] = n;
        t = o - 1;
      } else o == 8 && s == 1 && (It[t] = 1);
      e = o;
      o & 7 && (s = o);
      ...
      t: for (;;)
        if (h < n.length && u == n[h].from) {
          ...
          if (d) d.push(p);
            ...
            p.from > a && r.push(new BidiSpan(a, p.from, f));
            let e = (p.direction == Et) != !(f % 2);
            Xt(t, e ? s + 1 : s, o, p.inner, p.from, p.to, r);
            a = p.to;
          }
          u = p.to;
        } else {
          if (u == i || (e ? It[u] != l : It[u] == l)) break;
          u++;
        }
      d ? Yt(t, a, u, s + 1, o, d, r) : a < u && r.push(new BidiSpan(a, u, f));
      a = u;
    }
  else
      ...
      t: for (;;)
        if (h && u == n[h - 1].to) {
          ...
          if (d) d.push(p);
            ...
            p.to < a && r.push(new BidiSpan(p.to, a, f));
            let e = (p.direction == Et) != !(f % 2);
            Xt(t, e ? s + 1 : s, o, p.inner, p.from, p.to, r);
            a = p.from;
          }
          ...
          if (u == e || (i ? It[u - 1] != l : It[u - 1] == l)) break;
          u--;
        }
      d ? Yt(t, u, a, s + 1, o, d, r) : u < a && r.push(new BidiSpan(u, a, f));
      a = u;
    }
}
function Xt(t, e, i, s, o, n, r) {
  let l = e % 2 ? 2 : 1;
  qt(t, o, n, s, l);
  Gt(t, o, n, s, l);
  Kt(o, n, s, l);
...
function jt(t, e, i) {
  if (!t) return [new BidiSpan(0, 0, e == Bt ? 1 : 0)];
  if (e == Et && !i.length && !Ft.test(t)) return _t(t.length);
  if (i.length) while (t.length > It.length) It[It.length] = 256;
  let s = [],
    o = e == Et ? 0 : 1;
  Xt(t, o, o, i, 0, t.length, s);
  return s;
}
function _t(t) {
...
function $t(t, e, i, s, r) {
  ...
  let h = BidiSpan.find(
    e,
    a,
    (l = s.bidiLevel) !== null && l !== void 0 ? l : -1,
    s.assoc,
  );
  let c = e[h],
    d = c.side(r, i);
  ...
  let f = o(t.text, a, c.forward(r, i));
  (f < c.from || f > c.to) && (f = d);
  Ut = t.text.slice(Math.min(a, f), Math.max(a, f));
  let u = h == (r ? e.length - 1 : 0) ? null : e[h + (r ? 1 : -1)];
  return u && f == d && u.level + (r ? 0 : 1) < c.level
    ? n.cursor(u.side(!r, i) + t.from, u.forward(r, i) ? 1 : -1, u.level)
    : n.cursor(f + t.from, c.forward(r, i) ? -1 : 1, c.level);
}
function Qt(t, e, i) {
  for (let s = e; s < i; s++) {
    let e = Wt(t.charCodeAt(s));
    if (e == 1) return Et;
    if (e == 2 || e == 4) return Bt;
  }
  return Et;
}
const Jt = r.define();
...
const ne = r.define();
const re = r.define();
const le = r.define({ combine: (t) => t.some((t) => t) });
const ae = r.define({ combine: (t) => t.some((t) => t) });
const he = r.define();
class ScrollTarget {
...
const ce = l.define({ map: (t, e) => t.map(e) });
const de = l.define();
function fe(t, e, i) {
  let s = t.facet(ee);
  s.length
...
const ue = r.define({ combine: (t) => !t.length || t[0] });
let pe = 0;
const ge = r.define({
  combine(t) {
    return t.filter((e, i) => {
...
class ViewPlugin {
  constructor(t, e, i, s, o) {
    ...
    this.extension = this.baseExtensions.concat(
      ge.of({ plugin: this, arg: void 0 }),
    );
  }
  of(t) {
    return this.baseExtensions.concat(ge.of({ plugin: this, arg: t }));
  }
  static define(t, e) {
    const {
      eventHandlers: i,
    ...
    return new ViewPlugin(pe++, t, i, s, (t) => {
      let e = [];
      n &&
        e.push(
          ve.of((e) => {
      ...
      if (this.mustUpdate) {
        ...
        if (this.value.update)
          try {
            ...
            fe(t.state, e, "CodeMirror plugin crashed");
  ...
  static extendWithRanges(t, e) {
    ...
    for (let s = 0, o = 0, n = 0, r = 0; ; s++) {
      ...
      while (o < e.length && e[o] < h) {
        ...
        let n = Math.max(r, t),
          l = Math.min(h, s);
        n <= l && new ChangedRange(n + a, l + a, n, l).addToSet(i);
        if (s > h) break;
        o += 2;
      }
      if (!l) return i;
...
class DocView extends ContentView {
  ...
  constructor(t) {
    ...
    this.updateDeco();
    this.updateInner([new ChangedRange(0, 0, 0, t.state.doc.length)], 0, null);
  }
  update(t) {
    var e;
    ...
    this.view.inputState.composing >= 0 &&
      ...
      (((e = this.domChanged) === null || e === void 0 ? void 0 : e.newSel)
        ...
        : Re(t.changes, this.hasComposition) ||
          t.selectionSet ||
          (s = t.state.selection.main.head));
    let o = s > -1 ? Oe(this.view, t.changes, s) : null;
    this.domChanged = null;
    ...
    let n = this.decorations,
      r = this.updateDeco();
    let l = Ee(n, r, t.changes);
    i = ChangedRange.extendWithRanges(i, l);
  ...
  updateInner(t, e, i) {
    ...
    s.ignore(() => {
      ...
      this.flags &= -8;
      t &&
        (t.written || s.selectionRange.focusNode != t.node) &&
        (this.forceSelection = true);
      this.dom.style.height = "";
    });
  ...
  updateChildren(t, e, i) {
    ...
    for (let t = s.length - 1; ; t--) {
      ...
      let n,
        ...
        l,
        a,
        { fromA: h, toA: c, fromB: d, toB: f } = e;
      if (i && i.range.fromB < f && i.range.toB > d) {
        ...
        if (e.breakAtStart) s.breakAfter = 1;
        else if (
          e.content.length &&
        ...
        t.content.length &&
          s.merge(0, 0, t.content[t.content.length - 1], true, 0, t.openEnd) &&
          t.content.pop();
        n = t.content.concat(s).concat(e.content);
      } else
        ({
          content: n,
          breakAtStart: r,
      ...
      let { i: u, off: p } = o.findPos(c, 1);
      let { i: g, off: m } = o.findPos(h, -1);
      Z(this, g, m, u, p, n, r, l, a);
    }
  ...
  updateEditContextFormatting(t) {
    ...
    for (let e of t.transactions)
      for (let t of e.effects)
        t.is(de) && (this.editContextFormatting = t.value);
  }
  compositionView(t) {
    let e = new TextView(t.text.nodeValue);
    e.flags |= 8;
    for (let { deco: i } of t.marks) e = new MarkView(i, [e], e.length);
    let i = new LineView();
    i.append(e, 0);
    return i;
  }
  ...
  updateSelection(t = false, e = false) {
    ...
    let o =
      !s &&
      !(this.view.state.facet(ue) || this.dom.tabIndex > -1) &&
      O(this.dom, this.view.observer.selectionRange) &&
    ...
    if (ft.gecko && r.empty && !this.hasComposition && De(l)) {
    ...
    if (
      n ||
      !h.focusNode ||
      ((!V(l.node, l.offset, h.anchorNode, h.anchorOffset) ||
        !V(a.node, a.offset, h.focusNode, h.focusOffset)) &&
      ...
      this.view.observer.ignore(() => {
        ...
        if (t)
          if (r.empty) {
            if (ft.gecko) {
              let t = Te(l.node, l.offset);
              if (t && t != 3) {
                let e = (t == 1 ? U : $)(l.node, l.offset);
    ...
    this.impreciseAnchor = l.precise
      ? null
      : new DOMPos(h.anchorNode, h.anchorOffset);
    this.impreciseHead = a.precise
      ? null
      : new DOMPos(h.focusNode, h.focusOffset);
  }
  suppressWidgetCursorChange(t, e) {
    return (
      this.hasComposition &&
      e.empty &&
      V(t.focusNode, t.focusOffset, t.anchorNode, t.anchorOffset) &&
  ...
  enforceCursorAssoc() {
    ...
    let n = LineView.find(this, e.head);
    if (!n) return;
    let r = n.posAtStart;
  ...
  moveToLine(t) {
    ...
    for (let s = t.offset; !e && s < i.childNodes.length; s++) {
      let t = ContentView.get(i.childNodes[s]);
      t instanceof LineView && (e = t.domAtPos(0));
    }
    for (let s = t.offset - 1; !e && s >= 0; s--) {
      let t = ContentView.get(i.childNodes[s]);
      t instanceof LineView && (e = t.domAtPos(t.length));
    }
    return e ? new DOMPos(e.node, e.offset, true) : t;
  }
  nearest(t) {
    for (let e = t; e; ) {
  ...
  coordsAt(t, e) {
    ...
    for (let o = this.length, n = this.children.length - 1; n >= 0; n--) {
      ...
      if (
        ...
        (a < t || r.covers(-1)) &&
        (l > t || r.covers(1)) &&
        (!i || (r instanceof LineView && !(i instanceof LineView && e >= 0)))
      ) {
        i = r;
        s = a;
      } else if (
  ...
  coordsForChar(t) {
    let { i: e, off: i } = this.childPos(t, 1),
      s = this.children[e];
    if (!(s instanceof LineView)) return null;
    while (s.children.length) {
      let { i: t, off: e } = s.childPos(i, 1);
      for (; ; t++) {
        if (t == s.children.length) return null;
        if ((s = s.children[t]).length) break;
      }
      i = e;
    }
    if (!(s instanceof TextView)) return null;
    let n = o(s.text, i);
    if (n == i) return null;
    let r = G(s.dom, i, n).getClientRects();
    for (let t = 0; t < r.length; t++) {
      let e = r[t];
      if (t == r.length - 1 || (e.top < e.bottom && e.left < e.right)) return e;
    }
    return null;
  }
    ...
    for (let t = 0, a = 0; a < this.children.length; a++) {
      ...
      if (t >= i) {
        ...
        if (n) {
          ...
          if (s.length) {
            let e = s[s.length - 1];
            let n = l ? e.right - i.left : i.right - e.left;
            if (n > r) {
              r = n;
              this.minWidth = o;
              this.minWidthFrom = t;
  ...
  measureTextSize() {
    ...
    s.className = "cm-line";
    s.style.width = "99999px";
    s.style.position = "absolute";
    s.textContent = "abc def ghi jkl mno pqr stu";
    this.view.observer.ignore(() => {
      this.dom.appendChild(s);
      let o = T(s.firstChild)[0];
      t = s.getBoundingClientRect().height;
      e = o ? o.width / 27 : 7;
      i = o ? o.height : t;
      s.remove();
    });
    return { lineHeight: t, charWidth: e, textHeight: i };
  }
  childCursor(t = this.length) {
    let e = this.children.length;
    e && (t -= this.children[--e].length);
    return new ChildCursor(this.children, t, e);
  }
  computeBlockGapDeco() {
    let t = [],
  ...
  scrollIntoView(t) {
    ...
    for (let e of this.view.state.facet(he))
      try {
        if (e(this.view, t.range, t)) return true;
      } catch (t) {
        fe(this.view.state, t, "scroll handler");
      }
    let { range: e } = t;
    let i,
...
function Ae(t, e) {
  ...
  let s = U(i.focusNode, i.focusOffset);
  let o = $(i.focusNode, i.focusOffset);
  let n = s || o;
  if (o && s && o.node != s.node) {
    let e = ContentView.get(o.node);
    if (!e || (e instanceof TextView && e.text != o.node.nodeValue)) n = o;
    else if (t.docView.lastCompositionAfterCursor) {
      let t = ContentView.get(s.node);
      !t || (t instanceof TextView && t.text != s.node.nodeValue) || (n = o);
    }
  }
...
function Oe(t, e, i) {
  ...
  let h = new ChangedRange(a.mapPos(n), a.mapPos(r), n, r);
  let c = [];
  for (let e = o.parentNode; ; e = e.parentNode) {
    let i = ContentView.get(e);
    if (i instanceof MarkView) c.push({ node: e, deco: i.mark });
    else {
      if (
        i instanceof LineView ||
        (e.nodeName == "DIV" && e.parentNode == t.contentDOM)
      )
        return { range: h, text: o, marks: c, line: e };
...
let Ve = class DecorationComparator {
  constructor() {
    this.changes = [];
  }
  compareRange(t, e) {
...
function Le(t, e, i = 1) {
  ...
  let r = t.doc.lineAt(e),
    l = e - r.from;
  if (r.length == 0) return n.cursor(e);
  l == 0 ? (i = 1) : l == r.length && (i = -1);
  let a = l,
    h = l;
  i < 0 ? (a = o(r.text, l, false)) : (h = o(r.text, l));
  let c = s(r.text.slice(a, h));
  while (a > 0) {
    let t = o(r.text, a, false);
    if (s(r.text.slice(t, a)) != c) break;
    a = t;
  }
  while (h < r.length) {
    let t = o(r.text, h);
    if (s(r.text.slice(h, t)) != c) break;
    h = t;
  }
  return n.range(a + r.from, h + r.from);
}
function Pe(t, e) {
...
function ze(t, e, i) {
  ...
  for (let f = t.firstChild; f; f = f.nextSibling) {
    ...
    for (let u = 0; u < t.length; u++) {
      let p = t[u];
      o && Ne(o, p) && (p = We(Fe(p, o.bottom), o.top));
      let g = Pe(e, p),
        m = He(i, p);
      if (g == 0 && m == 0) return f.nodeType == 3 ? Ie(f, e, i) : ze(f, e, i);
      if (!s || r > m || (r == m && n > g)) {
        s = f;
        o = p;
        n = g;
        r = m;
        l = !g || (e < p.left ? u > 0 : u < t.length - 1);
      }
      if (g == 0) {
        if (i > p.bottom && (!c || c.bottom < p.bottom)) {
          a = f;
          c = p;
        } else if (i < p.top && (!d || d.top > p.top)) {
          h = f;
          d = p;
        }
      } else
  ...
  if (s.nodeType == 3) return Ie(s, f, i);
  if (l && s.contentEditable != "false") return ze(s, f, i);
  let u =
...
function Ie(t, e, i) {
  ...
  let o = -1,
    ...
    r = 0;
  for (let l = 0; l < s; l++) {
    let s = G(t, l, l + 1).getClientRects();
    for (let a = 0; a < s.length; a++) {
      ...
      if (h.left - 1 <= e && h.right + 1 >= e && c < n) {
        let i = e >= (h.left + h.right) / 2,
          s = i;
        if (ft.chrome || ft.gecko) {
          let e = G(t, l).getBoundingClientRect();
          e.left == h.right && (s = !i);
        }
...
function qe(t, e, i, s = -1) {
  ...
  for (let e = t.viewState.heightOracle.textHeight / 2, o = false; ; ) {
    a = t.elementAtHeight(f);
    if (a.type == kt.Text) break;
    for (;;) {
      f = s > 0 ? a.bottom + e : a.top - e;
      if (f >= 0 && f <= h) break;
  ...
  if (u < t.viewport.from)
    return t.viewport.from == 0 ? 0 : i ? null : Ge(t, r, a, c, d);
  if (u > t.viewport.to)
  ...
  if (!w || !t.docView.dom.contains(w)) {
    let e = LineView.find(t.docView, u);
    if (!e) return f > a.top + a.height / 2 ? a.to : a.from;
    ({ node: w, offset: v } = ze(e.dom, c, d));
  }
...
function Ke(t, e, i) {
  ...
  return G(t, s - 1, s).getBoundingClientRect().right > i;
}
function Ye(t, e, i) {
  if (e != 0) return false;
  for (let e = t; ; ) {
    let t = e.parentNode;
    if (!t || t.nodeType != 1 || t.firstChild != e) return false;
  ...
  let s =
    t.nodeType == 1
      ...
      : G(t, 0, Math.max(t.nodeValue.length, 1)).getBoundingClientRect();
  return i - s.left > 5;
}
function Xe(t, e, i) {
...
function je(t, e, i, s) {
  let o = Xe(t, e.head, e.assoc || -1);
  let r =
    s && o.type == kt.Text && (t.lineWrapping || o.widgetLineBreaks)
      ? t.coordsAtPos(e.assoc < 0 && e.head > o.from ? e.head - 1 : e.head)
      : null;
  if (r) {
    let e = t.dom.getBoundingClientRect();
    let s = t.textDirectionAt(o.from);
    let l = t.posAtCoords({
      x: i == (s == Vt.LTR) ? e.right - 1 : e.left + 1,
      y: (r.top + r.bottom) / 2,
    });
    if (l != null) return n.cursor(l, i ? -1 : 1);
  }
  return n.cursor(i ? o.to : o.from, i ? -1 : 1);
}
function _e(t, e, i, s) {
...
function $e(t, e, i, s) {
  ...
  let c = t.coordsAtPos(o, e.assoc || -1),
    d = t.documentTop;
  if (c) {
    ...
    a == null &&
      (a = Math.min(h.right - h.left, t.defaultCharacterWidth * (o - e.from)));
  ...
  for (let e = 0; ; e += 10) {
    let i = l + (u + e) * r;
    let s = qe(t, { x: f, y: i }, false, r);
    if (i < h.top || i > h.bottom || (r < 0 ? s < o : s > o)) {
      let e = t.docView.coordsForChar(s);
      let o = !e || i < e.top ? -1 : 1;
      return n.cursor(s, o, void 0, a);
    }
  }
}
function Qe(t, e, i) {
...
function Je(t, e, i) {
  let s = Qe(
    t.state.facet(ye).map((e) => e(t)),
    i.from,
    e.head > i.from ? -1 : 1,
  );
  return s == i.from ? i : n.cursor(s, s < i.from ? 1 : -1);
}
const Ze = "￿";
class DOMReader {
  constructor(t, e) {
    this.points = t;
    this.text = "";
    this.lineSeparator = e.facet(d.lineSeparator);
  }
  append(t) {
    this.text += t;
  }
  ...
  findPointInside(t, e) {
    for (let i of this.points)
      (t.nodeType == 3 ? i.node == t : t.contains(i.node)) &&
        (i.pos = this.text.length + (ti(t, i.node, i.offset) ? e : 0));
  }
}
function ti(t, e, i) {
  for (;;) {
    if (!e || i < L(e)) return false;
    if (e == t) return true;
    i = E(e) + 1;
    e = e.parentNode;
  }
...
class DOMChange {
  constructor(t, e, i, s) {
    ...
    if (t.state.readOnly && e > -1) this.newSel = null;
      ...
      let e = o || r ? [] : ni(t);
      let i = new DOMReader(e, t.state);
      i.readRange(this.bounds.startDOM, this.bounds.endDOM);
      this.text = i.text;
      this.newSel = ri(e, this.bounds.from);
    } else {
...
function ei(e, i) {
  ...
  if (i.bounds) {
    let { from: o, to: n } = i.bounds;
    let a = r.from,
      h = null;
    if (l === 8 || (ft.android && i.text.length < n - o)) {
      a = r.to;
      h = "end";
    }
    let c = oi(e.state.doc.sliceString(o, n, Ze), i.text, a - o, h);
    if (c) {
      ft.chrome &&
        l == 13 &&
        c.toB == c.from + 2 &&
        i.text.slice(c.from, c.toB) == Ze + Ze &&
        c.toB--;
      s = {
        from: o + c.from,
        to: o + c.toA,
        insert: t.of(i.text.slice(c.from, c.toB).split(Ze)),
      };
    }
  } else
    o && ((!e.hasFocus && e.state.facet(ue)) || o.main.eq(r)) && (o = null);
  if (!s && !o) return false;
  if (!s && i.typeOver && !r.empty && o && o.main.empty)
    s = { from: r.from, to: r.to, insert: e.state.doc.slice(r.from, r.to) };
  else if (
    (ft.mac || ft.android) &&
    s &&
    s.from == s.to &&
    ...
    o &&
      s.insert.length == 2 &&
      (o = n.single(o.main.anchor - 1, o.main.head - 1));
    s = {
      from: s.from,
      to: s.to,
      insert: t.of([s.insert.toString().replace(".", " ")]),
    };
  } else if (
    s &&
    s.from >= r.from &&
    ...
    s = {
      ...
      insert: e.state.doc
        .slice(r.from, s.from)
        .append(s.insert)
        .append(e.state.doc.slice(s.to, r.to)),
    };
  else if (
    ft.chrome &&
    s &&
    ...
    o && (o = n.single(o.main.anchor - 1, o.main.head - 1));
    s = { from: r.from, to: r.to, insert: t.of([" "]) };
  }
  if (s) return ii(e, s, o, l);
  if (o && !o.main.eq(r)) {
    let t = false,
      i = "select";
    if (e.inputState.lastSelectionTime > Date.now() - 50) {
      e.inputState.lastSelectionOrigin == "select" && (t = true);
...
function ii(t, e, i, s = -1) {
  if (ft.ios && t.inputState.flushIOSKey(e)) return true;
  ...
  let r;
  let l = () => r || (r = si(t, e, i));
  t.state.facet(se).some((i) => i(t, e.from, e.to, n, l)) || t.dispatch(l());
  return true;
}
function si(t, e, i) {
  let s,
  ...
  if (
    ...
    let i = r.from < e.from ? o.sliceDoc(r.from, e.from) : "";
    let n = r.to > e.to ? o.sliceDoc(e.to, r.to) : "";
    s = o.replaceSelection(
      t.state.toText(
        i + e.insert.sliceString(0, void 0, t.state.lineBreak) + n,
      ),
    );
  } else {
    let l = o.changes(e);
    ...
    if (
      ...
      s = o.changeByRange((i) => {
        ...
        if (
          i.to - i.from != u ||
          t.state.sliceDoc(d, s) != h ||
          (i.to >= c.from && i.from <= c.to)
        )
          return { range: i };
        let p = o.changes({ from: d, to: s, insert: e.insert }),
          g = i.to - r.to;
        return {
          changes: p,
          range: a
            ? n.range(Math.max(0, a.anchor + g), Math.max(0, a.head + g))
            : i.map(p),
        };
      });
    } else s = { changes: l, selection: a && o.selection.replaceRange(a) };
  }
  let l = "input.type";
  if (
    t.composing ||
  ...
  return o.update(s, { userEvent: l, scrollIntoView: true });
}
function oi(t, e, i, s) {
...
function ri(t, e) {
  ...
  return i > -1 && s > -1 ? n.single(i + e, s + e) : null;
}
class InputState {
  ...
  constructor(t) {
    ...
    ft.safari && t.contentDOM.addEventListener("input", () => null);
    ft.gecko && Ki(t.contentDOM.ownerDocument);
  }
  handleEvent(t) {
    vi(this.view, t) &&
...
class MouseSelection {
  constructor(t, e, i, s) {
    ...
    this.scrolling = -1;
    this.lastEvent = e;
    this.scrollParents = F(t.contentDOM);
    this.atoms = t.state.facet(ye).map((e) => e(t));
    ...
    this.dragging = !(!wi(t, e) || Ri(e) != 1) && null;
  }
  start(t) {
  ...
  move(t) {
    ...
    let l = Ce(this.view);
    t.clientX - l.left <= s + fi
      ? (e = -ui(s - t.clientX))
      : t.clientX + l.right >= n - fi && (e = ui(t.clientX - n));
    t.clientY - l.top <= o + fi
      ? (i = -ui(o - t.clientY))
      : t.clientY + l.bottom >= r - fi && (i = ui(t.clientY - r));
  ...
  skipAtoms(t) {
    ...
    for (let i = 0; i < t.ranges.length; i++) {
      let s = t.ranges[i],
        o = null;
      if (s.empty) {
        let t = Qe(this.atoms, s.from, 0);
        t != s.from && (o = n.cursor(t, -1));
      } else {
        let t = Qe(this.atoms, s.from, -1);
        let e = Qe(this.atoms, s.to, 1);
        (t == s.from && e == s.to) ||
          (o = n.range(s.from == s.anchor ? t : e, s.from == s.head ? t : e));
      }
      if (o) {
        e || (e = t.ranges.slice());
        e[i] = o;
    ...
    return e ? n.create(e, t.mainIndex) : t;
  }
  select(t) {
    let { view: e } = this,
...
function gi(t, e) {
  let i = t.state.facet(Jt);
  return i.length ? i[0](e) : ft.mac ? e.metaKey : e.ctrlKey;
}
function mi(t, e) {
  let i = t.state.facet(Zt);
  return i.length ? i[0](e) : ft.mac ? !e.altKey : !e.ctrlKey;
}
function wi(t, e) {
...
function vi(t, e) {
  ...
  for (let i, s = e.target; s != t.contentDOM; s = s.parentNode)
    if (
      !s ||
      s.nodeType == 11 ||
      ((i = ContentView.get(s)) && i.ignoreEvent(e))
    )
      return false;
  return true;
}
...
const Mi = (ft.ie && ft.ie_version < 15) || (ft.ios && ft.webkit_version < 604);
function xi(t) {
...
function Ci(t, e) {
  ...
  if (a) {
    ...
    i = s.changeByRange((i) => {
      ...
      t = a.from;
      let h = s.toText((l ? r.line(o++).text : e) + s.lineBreak);
      return {
        changes: { from: a.from, insert: h },
        range: n.cursor(i.from + h.length),
      };
    });
  } else
    i = l
...
bi.mousedown = (t, e) => {
  ...
  let i = null;
  for (let s of t.state.facet(te)) {
    i = s(t, e);
    if (i) break;
  }
  i || e.button != 0 || (i = Li(t, e));
  if (i) {
    let s = !t.hasFocus;
...
function ki(t, e, i, s) {
  if (s == 1) return n.cursor(e, i);
  if (s == 2) return Le(t.state, e, i);
  {
    let i = LineView.find(t.docView, e),
      s = t.state.doc.lineAt(i ? i.posAtEnd : e);
    let o = i ? i.posAtStart : s.from,
      r = i ? i.posAtEnd : s.to;
    r < t.state.doc.length && r == s.to && r++;
    return n.range(o, r);
  }
}
let Di = (t, e, i) =>
...
function Ai(t, e, i, s) {
  let o = LineView.find(t.docView, e);
  if (!o) return 1;
  let n = e - o.posAtStart;
  if (n == 0) return 1;
  if (n == o.length) return -1;
  let r = o.coordsAt(n, -1);
  if (r && Di(i, s, r)) return -1;
  let l = o.coordsAt(n, 1);
  return l && Di(i, s, l) ? 1 : r && r.bottom >= s ? -1 : 1;
}
function Oi(t, e) {
  let i = t.posAtCoords({ x: e.clientX, y: e.clientY }, false);
  return { pos: i, bias: Ai(t, i, e.clientX, e.clientY) };
}
const Ti = ft.ie && ft.ie_version <= 11;
let Vi = null,
  Ei = 0,
  Bi = 0;
function Ri(t) {
...
function Li(t, e) {
  ...
  return {
    ...
    get(e, r, l) {
      let a,
        h = Oi(t, e);
      let c = ki(t, h.pos, h.bias, s);
      if (i.pos != h.pos && !r) {
        let e = ki(t, i.pos, i.bias, s);
        let o = Math.min(e.from, c.from),
          r = Math.max(e.to, c.to);
        c = o < c.from ? n.range(o, r) : n.range(r, o);
      }
      return r
        ? o.replaceRange(o.main.extend(c.from, c.to))
        : l && s == 1 && o.ranges.length > 1 && (a = Pi(o, h.pos))
          ? a
          : l
            ? o.addRange(c)
            : n.create([c]);
...
bi.dragstart = (t, e) => {
  ...
  if (e.dataTransfer) {
    e.dataTransfer.setData(
      "Text",
      Si(t.state, re, t.state.sliceDoc(i.from, i.to)),
    );
...
bi.drop = (t, e) => {
  ...
  if (i && i.length) {
    ...
    let n = () => {
      ++o == i.length &&
        Hi(t, e, s.filter((t) => t != null).join(t.state.lineBreak), false);
    };
...
function Wi(t) {
  ...
  return { text: Si(t, re, e.join(t.lineBreak)), ranges: i, linewise: s };
}
let Fi = null;
bi.copy = bi.cut = (t, e) => {
  let { text: i, ranges: s, linewise: o } = Wi(t.state);
  if (!i && !o) return false;
  Fi = o ? i : null;
  e.type != "cut" ||
    t.state.readOnly ||
    t.dispatch({ changes: s, scrollIntoView: true, userEvent: "delete.cut" });
  let n = Mi ? null : e.clipboardData;
  if (n) {
    n.clearData();
...
function Ii(t, e) {
  let i = [];
  for (let s of t.facet(oe)) {
    let o = s(t, e);
    o && i.push(o);
  }
  return i.length ? t.update({ effects: i, annotations: zi.of(true) }) : null;
}
function qi(t) {
  setTimeout(() => {
    let e = t.hasFocus;
...
bi.beforeinput = (t, e) => {
  ...
  if (e.inputType == "insertReplacementText" && t.observer.editContext) {
    ...
    if (s && o.length) {
      ...
      ii(t, { from: i, to: n, insert: t.state.toText(s) }, null);
      return true;
    }
  }
  let o;
  ...
  ft.ios && e.inputType == "deleteContentForward" && t.observer.flushSoon();
  ft.safari &&
...
const Yi = ["pre-wrap", "normal", "pre-line", "break-spaces"];
let Xi = false;
function ji() {
  Xi = false;
}
class HeightOracle {
  ...
  mustRefreshForWrapping(t) {
    return Yi.indexOf(t) > -1 != this.lineWrapping;
  }
...
class HeightMap {
  ...
  setHeight(t) {
    if (this.height != t) {
      Math.abs(this.height - t) > Ui && (Xi = true);
      this.height = t;
    }
  }
  replace(t, e, i) {
  ...
  applyChanges(t, e, i, s) {
    ...
    for (let r = s.length - 1; r >= 0; r--) {
      ...
      let d = o.lineAt(l, _i.ByPosNoHeight, i.setDoc(e), 0, 0);
      let f = d.to >= a ? d : o.lineAt(a, _i.ByPosNoHeight, i, 0, 0);
      c += f.to - a;
      a = f.to;
      while (r > 0 && d.from <= s[r - 1].toA) {
        ...
        h = s[r - 1].fromB;
        r--;
        l < d.from && (d = o.lineAt(l, _i.ByPosNoHeight, i, 0, 0));
      }
      h += d.from - l;
      l = d.from;
      let u = NodeBuilder.build(i.setDoc(n), t, h, c);
      o = $i(o, o.replace(l, a, u));
    }
...
function $i(t, e) {
  if (t == e) return t;
  t.constructor != e.constructor && (Xi = true);
  return e;
}
...
class HeightMapBlock extends HeightMap {
  ...
  blockAt(t, e, i, s) {
    return new BlockInfo(s, this.length, i, this.height, this.deco || 0);
  }
  lineAt(t, e, i, s, o) {
  ...
  updateHeight(t, e = 0, i = false, s) {
    s && s.from <= e && s.more && this.setHeight(s.heights[s.index++]);
    this.outdated = false;
    return this;
  }
  toString() {
...
class HeightMapText extends HeightMapBlock {
  ...
  blockAt(t, e, i, s) {
    return new BlockInfo(s, this.length, i, this.height, this.breaks);
  }
  replace(t, e, i) {
    let s = i[0];
    if (
      ...
      s instanceof HeightMapGap
        ? (s = new HeightMapText(s.length, this.height))
...
class HeightMapGap extends HeightMap {
  ...
  lineAt(t, e, i, s, o) {
    if (e == _i.ByHeight) return this.blockAt(t, i, s, o);
    if (e == _i.ByPosNoHeight) {
  ...
  updateHeight(t, e = 0, i = false, s) {
    ...
    if (s && s.from <= e + this.length && s.more) {
      ...
      while (n <= o && s.more) {
        ...
        r == -1 ? (r = o) : Math.abs(o - r) >= Ui && (r = -2);
        let l = new HeightMapText(e, o);
        l.outdated = false;
        i.push(l);
        n += e + 1;
      }
      ...
      (r < 0 ||
        Math.abs(l.height - this.height) >= Ui ||
        Math.abs(r - this.heightMetrics(t, e).perLine) >= Ui) &&
        (Xi = true);
      return $i(this, l);
    }
    if (i || this.outdated) {
...
class HeightMapBranch extends HeightMap {
  ...
  forEachLine(t, e, i, s, o, n) {
    ...
    if (this.break) {
      ...
      let a = this.lineAt(l, _i.ByPos, i, s, o);
  ...
  balanced(t, e) {
    ...
    this.left = $i(this.left, t);
    this.right = $i(this.right, e);
...
class NodeBuilder {
  ...
  point(t, e, i) {
    if (t < e || i.heightRelevant) {
      ...
      i.block
        ...
        : (n || o || s >= Ji) && this.addLineDeco(s, o, n);
  ...
  enterLine() {
    ...
    this.pos > t && this.nodes.push(new HeightMapText(this.pos - t, -1));
...
class ViewState {
  constructor(e) {
    ...
    this.stateDeco = e.facet(ve).filter((t) => typeof t != "function");
  ...
  updateViewportLines() {
    ...
    this.heightMap.forEachLine(
      ...
      0,
      (t) => {
        this.viewportLines.push(as(t, this.scaler));
      },
    );
  }
  update(t, e = null) {
    ...
    this.stateDeco = this.state.facet(ve).filter((t) => typeof t != "function");
    let s = t.changedRanges;
    let o = ChangedRange.extendWithRanges(
      s,
      Zi(i, this.stateDeco, t ? t.changes : a.empty(this.state.doc.length)),
    );
    ...
    (this.heightMap.height != n || Xi) && (t.flags |= 2);
    if (r) {
  ...
  measure(e) {
    ...
    let n = s.whiteSpace;
    this.defaultTextDirection = s.direction == "rtl" ? Vt.RTL : Vt.LTR;
    ...
    let d = (parseInt(s.paddingTop) || 0) * this.scaleY;
    let f = (parseInt(s.paddingBottom) || 0) * this.scaleY;
    if (this.paddingTop != d || this.paddingBottom != f) {
      this.paddingTop = d;
      this.paddingBottom = f;
      h |= 18;
    }
    if (this.editorWidth != e.scrollDOM.clientWidth) {
      o.lineWrapping && (a = true);
    ...
    this.scrolledToBottom = _(e.scrollDOM);
    let p = (this.printing ? is : ts)(i, this.paddingTop);
    ...
    if (!this.inView && !this.scrollTarget && !es(e.dom)) return 0;
    let v = l.width;
    if (
    ...
    if (a) {
      ...
      o.mustRefreshForHeights(i) && (r = true);
      if (
        r ||
        (o.lineWrapping && Math.abs(v - this.contentDOMWidth) > o.charWidth)
      ) {
        let {
          lineHeight: t,
          charWidth: s,
        ...
        r = t > 0 && o.refresh(n, t, s, l, Math.max(5, v / s), i);
        if (r) {
      ...
      for (let s of this.viewports) {
        ...
        this.heightMap = (
          r
            ...
            : this.heightMap
        ).updateHeight(o, 0, r, new MeasuredHeights(s.from, n));
      }
      Xi && (h |= 2);
    }
    let b =
    ...
    (this.lineGaps.length || this.viewport.to - this.viewport.from > 4e3) &&
      this.updateLineGaps(this.ensureLineGaps(r ? [] : this.lineGaps, e));
  ...
  getViewport(t, e) {
    ...
    let l = new Viewport(
      s.lineAt(n - i * 1e3, _i.ByHeight, o, 0, 0).from,
      s.lineAt(r + 1e3 * (1 - i), _i.ByHeight, o, 0, 0).to,
    );
    if (e) {
      let { head: t } = e.range;
      if (t < l.from || t > l.to) {
        ...
        n =
          e.y == "center"
            ...
            : e.y == "start" || (e.y == "nearest" && t < l.from)
              ...
              : r.bottom - i;
        l = new Viewport(
          s.lineAt(n - 500, _i.ByHeight, o, 0, 0).from,
          s.lineAt(n + i + 500, _i.ByHeight, o, 0, 0).to,
        );
      }
    }
    return l;
  ...
  mapViewport(t, e) {
    let i = e.mapPos(t.from, -1),
      s = e.mapPos(t.to, 1);
    return new Viewport(
      this.heightMap.lineAt(i, _i.ByPos, this.heightOracle, 0, 0).from,
      this.heightMap.lineAt(s, _i.ByPos, this.heightOracle, 0, 0).to,
    );
  }
    ...
    let a = (s, r, h, c) => {
      ...
      if (!u) {
        if (
          ...
          let t = e.moveToLineBoundary(n.cursor(r), false, true).head;
          t > s && (r = t);
        }
        let t = this.gapSize(h, s, r, c);
        let o = i || t < 2e6 ? t : 2e6;
        u = new LineGap(s, r, t, o);
      }
      l.push(u);
    };
    let h = (e) => {
      if (e.length < r || e.type != kt.Text) return;
      let o = ss(e.from, e.to, this.stateDeco);
      if (o.total < r) return;
  ...
  lineBlockAt(t) {
    return (
      ...
      as(
        this.heightMap.lineAt(t, _i.ByPos, this.heightOracle, 0, 0),
        this.scaler,
      )
    );
  }
...
function os({ total: t, ranges: e }, i) {
...
class BigScaler {
  constructor(t, e, i) {
    ...
    this.viewports = i.map(({ from: i, to: o }) => {
      let n = e.lineAt(i, _i.ByPos, t, 0, 0).top;
      let r = e.lineAt(o, _i.ByPos, t, 0, 0).bottom;
      s += r - n;
...
function as(t, e) {
  ...
  return new BlockInfo(
    ...
    i,
    s - i,
    Array.isArray(t._content) ? t._content.map((t) => as(t, e)) : t._content,
  );
}
const hs = r.define({ combine: (t) => t.join(" ") });
const cs = r.define({ combine: (t) => t.indexOf(true) > -1 });
const ds = M.newName(),
  fs = M.newName(),
  us = M.newName();
const ps = { "&light": "." + fs, "&dark": "." + us };
function gs(t, e, i) {
  return new M(e, {
    finish(e) {
      return /&/.test(e)
...
const vs = ft.ie && ft.ie_version <= 11;
class DOMObserver {
  constructor(t) {
    this.view = t;
    this.active = false;
    ...
    this.observer = new MutationObserver((e) => {
      ...
      ((ft.ie && ft.ie_version <= 11) || (ft.ios && t.composing)) &&
      e.some(
        (t) =>
    ...
    if (
      ...
      !(ft.chrome && ft.chrome_version < 126)
    ) {
  ...
  onSelectionChange(t) {
    ...
    if (i.state.facet(ue) ? i.root.activeElement != this.dom : !O(this.dom, s))
      return;
    let o = s.anchorNode && i.docView.nearest(s.anchorNode);
    o && o.ignoreEvent(t)
      ? e || (this.selectionChanged = false)
      : ((ft.ie && ft.ie_version <= 11) || (ft.android && ft.chrome)) &&
          !i.state.selection.main.empty &&
          s.focusNode &&
          V(s.focusNode, s.focusOffset, s.anchorNode, s.anchorOffset)
        ? this.flushSoon()
        : this.flush(false);
  }
  readSelectionRange() {
  ...
  start() {
    if (!this.active) {
      this.observer.observe(this.dom, ws);
      vs &&
    ...
    if (!this.delayedAndroidKey) {
      let t = () => {
        ...
        if (t) {
          ...
          let e = this.flush();
          !e && t.force && K(this.dom, t.key, t.keyCode);
        }
      };
  ...
  readChange() {
    ...
    let s = this.selectionChanged && O(this.dom, this.selectionRange);
  ...
  readMutation(t) {
    ...
    if (t.type == "childList") {
      let i = bs(e, t.previousSibling || t.target.previousSibling, -1);
      let s = bs(e, t.nextSibling || t.target.nextSibling, 1);
      return {
  ...
  update(t) {
    if (this.editContext) {
      ...
      t.startState.facet(ue) != t.state.facet(ue) &&
        (t.view.contentDOM.editContext = t.state.facet(ue)
...
function ys(t, e) {
  ...
  V(r.node, r.offset, o, n) && ([i, s, o, n] = [o, n, i, s]);
...
class EditContextManager {
  constructor(e) {
    ...
    this.handlers.textupdate = (i) => {
      ...
      let h = { from: l, to: a, insert: t.of(i.text.split("\n")) };
      h.from == this.from && o < this.from
        ? (h.from = o)
        : h.to == this.to && o > this.to && (h.to = o);
      if (h.from != h.to || h.insert.length) {
        (ft.mac || ft.android) &&
          h.from == r - 1 &&
          /^\. ?$/.test(i.text) &&
          e.contentDOM.getAttribute("autocorrect") == "off" &&
          (h = { from: l, to: a, insert: t.of([i.text.replace(".", " ")]) });
        this.pendingContextChange = h;
        if (!e.state.readOnly) {
          let t = this.to - this.from + (h.to - h.from + h.insert.length);
          ii(
            e,
            h,
            n.single(
        ...
        t.main.eq(s) || e.dispatch({ selection: t, userEvent: "select" });
      }
    };
    this.handlers.characterboundsupdate = (t) => {
      let s = [],
        o = null;
      for (
        let i = this.toEditorPos(t.rangeStart),
          n = this.toEditorPos(t.rangeEnd);
        i < n;
        i++
      ) {
        let t = e.coordsForChar(i);
        o =
          (t &&
            new DOMRect(t.left, t.top, t.right - t.left, t.bottom - t.top)) ||
          o ||
          new DOMRect();
        s.push(o);
      }
      i.updateCharacterBounds(t.rangeStart, s);
    };
    this.handlers.textformatupdate = (t) => {
      let i = [];
      for (let e of t.getTextFormats()) {
        let t = e.underlineStyle,
          s = e.underlineThickness;
        if (t != "None" && s != "None") {
          let o = this.toEditorPos(e.rangeStart),
            n = this.toEditorPos(e.rangeEnd);
          if (o < n) {
            let e = `text-decoration: underline ${t == "Dashed" ? "dashed " : t == "Squiggle" ? "wavy " : ""}${s == "Thin" ? 1 : 2}px`;
            i.push(Decoration.mark({ attributes: { style: e } }).range(o, n));
          }
        }
      }
      e.dispatch({ effects: de.of(Decoration.set(i)) });
    };
...
class EditorView {
  ...
  constructor(t = {}) {
    ...
    this._root = t.root || Y(t.parent) || document;
    ...
    this.plugins = this.state.facet(ge).map((t) => new PluginInstance(t));
  ...
  update(t) {
    ...
    if (o.facet(d.phrases) != this.state.facet(d.phrases))
      return this.setState(o);
    e = ViewUpdate.create(this, o, t);
    e.flags |= l;
    ...
    try {
      ...
      for (let e of t) {
        ...
        if (e.scrollIntoView) {
          ...
          f = new ScrollTarget(
            t.empty ? t : n.cursor(t.head, t.head > t.anchor ? -1 : 1),
          );
        }
        for (let t of e.effects) t.is(ce) && (f = t.value.clip(this.state));
      }
      this.viewState.update(e, f);
      ...
      this.state.facet(ke) != this.styleModules && this.mountStyles();
      s = this.updateAttrs();
    ...
    e.startState.facet(hs) != e.state.facet(hs) &&
    ...
    if (!e.empty)
      for (let t of this.state.facet(ie))
        try {
          t(e);
        } catch (t) {
          fe(this.state, t, "update listener");
        }
    (a || c) &&
      Promise.resolve().then(() => {
        a && this.state == a.startState && this.dispatch(a);
        c && !ei(this, c) && h.force && K(this.contentDOM, h.key, h.keyCode);
      });
  }
  setState(t) {
    if (this.updateState != 0)
    ...
    try {
      ...
      this.plugins = t.facet(ge).map((t) => new PluginInstance(t));
    ...
    for (let t of this.plugins) {
      ...
      if (e && e.docViewUpdate)
        try {
          ...
          fe(this.state, t, "doc view update listener");
        }
    }
  }
  measure(t = true) {
    ...
    if (e && !e.empty) for (let t of this.state.facet(ie)) t(e);
  }
  get themeClasses() {
    return (
      ds + " " + (this.state.facet(cs) ? us : fs) + " " + this.state.facet(hs)
    );
  }
  updateAttrs() {
    let t = Cs(this, me, {
  ...
  mountStyles() {
    this.styleModules = this.state.facet(ke);
    let t = this.state.facet(EditorView.cspNonce);
    M.mount(
      this.root,
      this.styleModules.concat(ms).reverse(),
      t ? { nonce: t } : void 0,
    );
  }
  readMeasured() {
  ...
  moveByChar(t, e, i) {
    return Je(this, t, _e(this, t, e, i));
  }
  moveByGroup(t, e) {
    return Je(
      this,
      t,
      _e(this, t, e, (e) => Ue(this, t.head, e)),
    );
  }
  visualLineSide(t, e) {
    let i = this.bidiSpans(t),
      s = this.textDirectionAt(t.from);
    let o = i[e ? i.length - 1 : 0];
    return n.cursor(o.side(e, s) + t.from, o.forward(!e, s) ? 1 : -1);
  }
  moveToLineBoundary(t, e, i = true) {
    return je(this, t, e, i);
  }
  moveVertically(t, e, i) {
    return Je(this, t, $e(this, t, e, i));
  }
  domAtPos(t) {
  ...
  bidiSpans(t) {
    if (t.length > xs) return _t(t.length);
    let e,
    ...
    for (let s of this.bidiCache)
      if (
        s.from == t.from &&
        s.dir == i &&
        (s.fresh || zt(s.isolates, (e = xe(this, t))))
      )
        return s.order;
    e || (e = xe(this, t));
    let s = jt(t.text, i, e);
  ...
  scrollSnapshot() {
    ...
    return ce.of(
      new ScrollTarget(n.cursor(i.from), "start", "start", i.top - t, e, true),
    );
  }
  setTabFocusMode(t) {
    t == null
  ...
  static theme(t, e) {
    let i = M.newName();
    let s = [hs.of(i), ke.of(gs(`.${i}`, t))];
    e && e.dark && s.push(cs.of(true));
    return s;
  }
  static baseTheme(t) {
    return p.lowest(ke.of(gs("." + ds, t, ps)));
  }
  static findFromDOM(t) {
    var e;
    let i = t.querySelector(".cm-content");
    let s = (i && ContentView.get(i)) || ContentView.get(t);
    return (
...
EditorView.styleModule = ke;
EditorView.inputHandler = se;
EditorView.clipboardInputFilter = ne;
EditorView.clipboardOutputFilter = re;
EditorView.scrollHandler = he;
EditorView.focusChangeEffect = oe;
EditorView.perLineTextDirection = le;
EditorView.exceptionSink = ee;
EditorView.updateListener = ie;
EditorView.editable = ue;
EditorView.mouseSelectionStyle = te;
EditorView.dragMovesSelection = Zt;
EditorView.clickAddsSelectionRange = Jt;
EditorView.decorations = ve;
EditorView.outerDecorations = be;
EditorView.atomicRanges = ye;
EditorView.bidiIsolatedRanges = Me;
EditorView.scrollMargins = Se;
EditorView.darkTheme = cs;
EditorView.cspNonce = r.define({ combine: (t) => (t.length ? t[0] : "") });
EditorView.contentAttributes = we;
EditorView.editorAttributes = me;
EditorView.lineWrapping = EditorView.contentAttributes.of({
  class: "cm-lineWrapping",
});
EditorView.announce = l.define();
const xs = 4096;
const Ss = {};
class CachedOrder {
...
const ks = ft.mac ? "mac" : ft.windows ? "win" : ft.linux ? "linux" : "key";
function Ds(t, e) {
  const i = t.split(/-(?!$)/);
  let s = i[i.length - 1];
  s == "Space" && (s = " ");
...
const Os = p.default(
  EditorView.domEventHandlers({
    keydown(t, e) {
      return Ns(Es(e.state), t, e, "editor");
    },
  }),
);
const Ts = r.define({ enables: Os });
const Vs = new WeakMap();
function Es(t) {
  let e = t.facet(Ts);
  let i = Vs.get(e);
  i || Vs.set(e, (i = Ps(e.reduce((t, e) => t.concat(e), []))));
  return i;
}
function Bs(t, e, i) {
  return Ns(Es(t.state), e, t, i);
}
let Rs = null;
const Ls = 4e3;
function Ps(t, e = ks) {
  ...
  let n = (t, s, n, r, l) => {
    ...
    for (let e = 1; e < d.length; e++) {
      ...
      c[i] ||
        (c[i] = {
          ...
          run: [
            (e) => {
              let s = (Rs = { view: e, prefix: i, scope: t });
              setTimeout(() => {
                Rs == s && (Rs = null);
              }, Ls);
              return true;
    ...
    n && u.run.push(n);
    r && (u.preventDefault = true);
    l && (u.stopPropagation = true);
  };
  for (let s of t) {
    ...
    if (s.any)
      for (let e of t) {
        ...
        let { any: o } = s;
        for (let e in t) t[e].run.push((t) => o(t, Hs));
      }
    let o = s[e] || s.key;
    if (o)
      for (let e of t) {
  ...
  if (w) {
    f(w[l + As(o, e, !r)])
      ...
      : !r ||
          ...
          (ft.windows && e.ctrlKey && e.altKey) ||
          (ft.mac && e.altKey && !e.ctrlKey) ||
          !(u = S[e.keyCode]) ||
          u == o
        ? r && e.shiftKey && f(w[l + As(o, e, true)]) && (a = true)
        : (f(w[l + As(u, e, true)]) ||
            (e.shiftKey &&
              (p = C[e.keyCode]) != o &&
              p != u &&
...
function zs(t, e, i) {
  ...
  let f = l.right - (c ? parseInt(c.paddingRight) : 0);
  let u = Xe(t, s, 1),
    p = Xe(t, o, -1);
  let g = u.type == kt.Text ? u : null;
  let m = p.type == kt.Text ? p : null;
  g && (t.lineWrapping || u.widgetLineBreaks) && (g = Fs(t, s, 1, g));
  m && (t.lineWrapping || p.widgetLineBreaks) && (m = Fs(t, o, -1, m));
  if (g && m && g.from == m.from && g.to == m.to) return v(b(i.from, i.to, g));
  {
    ...
    (u.widgetLineBreaks > 1 && e.bottom + t.defaultLineHeight / 2 < s.top)
      ? o.push(w(d, e.bottom, f, s.top))
      : e.bottom < s.top &&
        t.elementAtHeight((e.bottom + s.top) / 2).type == kt.Text &&
  ...
  function b(e, i, s) {
    ...
    function a(e, i, a, h, c) {
      ...
      if (u && p) {
        ...
        c == Vt.LTR
          ? l.push(n && i ? d : u.left, n && h ? f : p.right)
          : l.push(!n && h ? d : p.left, !n && i ? f : u.right);
      }
    }
...
class LayerView {
  ...
  update(t) {
    t.startState.facet(qs) != t.state.facet(qs) && this.setOrder(t.state);
...
const qs = r.define();
function Gs(t) {
  return [ViewPlugin.define((e) => new LayerView(e, t)), qs.of(t)];
}
const Ks = r.define({
  combine(t) {
    return w(
...
function Ys(t = {}) {
  return [Ks.of(t), _s, $s, Qs, ae.of(true)];
}
function Xs(t) {
  return t.facet(Ks);
}
function js(t) {
  return t.startState.facet(Ks) != t.state.facet(Ks);
}
const _s = Gs({
  above: true,
  markers(t) {
    ...
    for (let o of e.selection.ranges) {
      ...
      if (o.empty || i.drawRangeCursor) {
        let e = r
          ? "cm-cursor cm-cursor-primary"
          : "cm-cursor cm-cursor-secondary";
        let i = o.empty ? o : n.cursor(o.head, o.head > o.anchor ? -1 : 1);
...
function Us(t, e) {
  e.style.animationDuration = t.facet(Ks).cursorBlinkRate + "ms";
}
const $s = Gs({
  above: false,
  markers(t) {
  ...
  update(t, e) {
    return t.docChanged || t.selectionSet || t.viewportChanged || js(t);
  },
...
const Zs = v.define({
  ...
  update(t, e) {
    ...
    return e.effects.reduce((t, e) => (e.is(Js) ? e.value : t), t);
  },
});
const to = ViewPlugin.fromClass(
  class {
    constructor(t) {
      this.view = t;
      this.cursor = null;
    ...
    update(t) {
      ...
      if (i == null) {
        ...
        (t.startState.field(Zs) != i || t.docChanged || t.geometryChanged) &&
          this.view.requestMeasure(this.measureReq);
      }
    }
    readPos() {
      let { view: t } = this;
      let e = t.state.field(Zs);
    ...
    setDropPos(t) {
      this.view.state.field(Zs) != t &&
        this.view.dispatch({ effects: Js.of(t) });
    }
  },
  {
    eventObservers: {
...
class MatchDecorator {
  ...
  createDeco(t) {
    let e = new b(),
      i = e.add.bind(e);
    for (let { from: e, to: s } of so(t, this.maxLength))
      io(t.state.doc, this.regexp, e, s, (e, s) => this.addMatch(s, t, e, i));
    return e.finish();
  }
  updateDeco(t, e) {
    let i = 1e9,
    ...
    for (let o of t.visibleRanges) {
      ...
      if (r >= n) {
        ...
        if (i == s) {
          ...
          io(t.state.doc, this.regexp, l, a, (e, i) =>
...
function ao() {
  var t;
  if (lo == null && typeof document != "undefined" && document.body) {
    let e = document.body.style;
    lo = ((t = e.tabSize) !== null && t !== void 0 ? t : e.MozTabSize) != null;
  }
  return lo || false;
}
const ho = r.define({
  combine(t) {
    let e = w(t, { render: null, specialChars: no, addSpecialChars: null });
    (e.replaceTabs = !ao()) &&
...
const po = "•";
function go(t) {
  return t >= 32 ? po : t == 10 ? "␤" : String.fromCharCode(9216 + t);
}
...
function wo() {
  return [
    ...
    we.of((t) => {
      var e;
      return (
        ((e = t.plugin(mo)) === null || e === void 0 ? void 0 : e.attrs) || null
      );
    }),
  ];
}
...
const bo = Decoration.line({ class: "cm-activeLine" });
const yo = ViewPlugin.fromClass(
  class {
    constructor(t) {
...
class Placeholder extends WidgetType {
  ...
  coordsAt(t) {
    let e = t.firstChild ? T(t.firstChild) : [];
    if (!e.length) return null;
    let i = window.getComputedStyle(t.parentNode);
    let s = P(e[0], i.direction != "rtl");
...
function So(t, e, i) {
  ...
  if (e.off > xo || i.off > xo || e.col < 0 || i.col < 0) {
    ...
    for (let e = s; e <= o; e++) {
      let i = t.doc.line(e);
      i.length <= a && r.push(n.range(i.from + l, i.to + a));
    }
  } else {
    ...
    for (let e = s; e <= o; e++) {
      ...
      if (s < 0) r.push(n.cursor(i.to));
        ...
        r.push(n.range(i.from + s, i.from + e));
      }
    }
  }
  return r;
  ...
  return i
    ? {
        ...
        get(e, o, r) {
          let l = ko(t, e);
          if (!l) return s;
          let a = So(t.state, i, l);
          return a.length
            ? r
              ? n.create(a.concat(s.ranges))
              : n.create(a)
            : s;
        },
      }
...
function Ao(t) {
  ...
  return EditorView.mouseSelectionStyle.of((t, i) => (e(i) ? Do(t, i) : null));
}
const Oo = {
  Alt: [18, (t) => !!t.altKey],
  ...
  class {
    ...
    readMeasure() {
      ...
      if (this.position == "fixed" && this.manager.tooltipViews.length) {
        ...
        if (ft.gecko) i = t.offsetParent != this.container.ownerDocument.body;
        else if (t.style.top == Eo && t.style.left == "0px") {
          let e = t.getBoundingClientRect();
    ...
    writeMeasure(t) {
      ...
      for (let l = 0; l < this.manager.tooltips.length; l++) {
        ...
        let p = u ? 7 : 0;
        let g = f.right - f.left,
          m = (e = Po.get(h)) !== null && e !== void 0 ? e : f.bottom - f.top;
        let w = h.offset || Fo,
          v = this.view.textDirection == Vt.LTR;
        let b =
          f.width > s.right - s.left
            ? v
              ? s.left
              : s.right - f.width
            : v
              ? Math.max(
                  s.left,
                  Math.min(d.left - (u ? 14 : 0) + w.x, s.right - g),
                )
              : Math.min(
                  Math.max(s.left, d.left - g + (u ? 14 : 0) - w.x),
                  s.right - g,
                );
        let y = this.above[l];
        !a.strictSide &&
          ...
          (y = this.above[l] = !y);
        let M = (y ? d.top - s.top : s.bottom - d.bottom) - p;
        if (M < m && h.resize !== false) {
          if (M < this.view.defaultLineHeight) {
            c.style.top = Eo;
            continue;
          }
          Po.set(h, m);
          c.style.height = (m = M) / n + "px";
        } else c.style.height && (c.style.height = "");
        let x = y ? d.top - m - p - w.y : d.bottom + p + w.y;
        let S = b + g;
        if (h.overlap !== true)
          for (let t of r)
            t.left < S &&
        ...
        h.overlap !== true &&
          r.push({ left: b, top: x, right: S, bottom: x + m });
    ...
    maybeMeasure() {
      if (this.manager.tooltips.length) {
        ...
        if (this.inView != this.view.inView) {
          ...
          if (!this.inView)
            for (let t of this.manager.tooltipViews) t.dom.style.top = Eo;
        }
      }
    }
  },
...
const Fo = { x: 0, y: 0 };
const zo = r.define({ enables: [Ho, Wo] });
const Io = r.define({ combine: (t) => t.reduce((t, e) => t.concat(e), []) });
...
class HoverPlugin {
  ...
  startHover() {
    ...
    let s,
      o = 1;
    if (i instanceof WidgetView) s = i.posAtStart;
    else {
      s = t.posAtCoords(e);
      if (s == null) return;
  ...
  mousemove(t) {
    ...
    if ((s.length && o && !Ko(o.dom, t)) || this.pending) {
      ...
      if (
        o == n
          ...
          : !Yo(this.view, o, n, t.clientX, t.clientY)
      ) {
...
function Xo(t, e = {}) {
    ...
    update(t, o) {
      if (t.length) {
        ...
        if (o.docChanged) {
          let e = [];
          for (let i of t) {
            let t = o.changes.mapPos(i.pos, -1, s.TrackDel);
            if (t != null) {
              let s = Object.assign(Object.create(null), i);
              s.pos = t;
              s.end != null && (s.end = o.changes.mapPos(s.end));
              e.push(s);
            }
          }
          t = e;
  ...
  return {
    ...
    extension: [
      o,
      ViewPlugin.define((s) => new HoverPlugin(s, t, o, i, e.hoverTime || 300)),
      qo,
    ],
  };
}
...
const en = ViewPlugin.fromClass(
  class {
    constructor(t) {
      this.input = t.state.facet(on);
...
const on = r.define({ enables: en });
function nn(t, e) {
  let i;
  let s = new Promise((t) => (i = t));
  let o = (t) => cn(t, e, i);
  t.state.field(ln, false)
    ? t.dispatch({ effects: an.of(o) })
    : t.dispatch({ effects: l.appendConfig.of(ln.init(() => [o])) });
  let n = hn.of(o);
  return {
    close: n,
    result: s.then((e) => {
      ...
      i(() => {
        t.state.field(ln).indexOf(o) > -1 && t.dispatch({ effects: n });
      });
      return e;
    }),
  };
...
const ln = v.define({
  ...
  update(t, e) {
    for (let i of e.effects)
      i.is(an)
        ? (t = [i.value].concat(t))
        : i.is(hn) && (t = t.filter((t) => t != i.value));
    return t;
  },
  provide: (t) => on.computeN([t], (e) => e.field(t)),
});
const an = l.define();
const hn = l.define();
function cn(t, e, i) {
...
GutterMarker.prototype.mapMode = s.TrackBefore;
...
const pn = r.define();
function gn(t) {
  return [wn(), pn.of({ ...un, ...t })];
}
const mn = r.define({ combine: (t) => t.some((t) => t) });
function wn(t) {
  let e = [vn];
  t && t.fixed === false && e.push(mn.of(true));
  return e;
}
const vn = ViewPlugin.fromClass(
  class {
    constructor(t) {
      this.view = t;
      this.domAfter = null;
      ...
      this.gutters = t.state.facet(pn).map((e) => new SingleGutterView(t, e));
      this.fixed = !t.state.facet(mn);
    ...
    update(t) {
      ...
      if (this.view.state.facet(mn) != !this.fixed) {
    ...
    syncGutters(t) {
      ...
      let s = i.iter(this.view.state.facet(dn), this.view.viewport.from);
      let o = [];
    ...
    updateGutters(t) {
      ...
      let o =
        ...
        t.viewportChanged ||
        !i.eq(
          t.startState.facet(dn),
          t.state.facet(dn),
          t.view.viewport.from,
          t.view.viewport.to,
        );
      if (e == s) for (let e of this.gutters) e.update(t) && (o = true);
      else {
        o = true;
        let i = [];
        for (let o of s) {
          let s = e.indexOf(o);
          if (s < 0) i.push(new SingleGutterView(this.view, o));
          else {
            this.gutters[s].update(t);
            i.push(this.gutters[s]);
          }
        }
        for (let t of this.gutters) {
          t.dom.remove();
          i.indexOf(t) < 0 && t.destroy();
        }
        for (let t of i)
          t.config.side == "after"
            ? this.getDOMAfter().appendChild(t.dom)
...
class UpdateContext {
  constructor(t, e, s) {
    ...
    this.height = s;
    this.i = 0;
    this.cursor = i.iter(t.markers, e.from);
  }
  addElement(t, e, i) {
    let { gutter: s } = this,
...
class SingleGutterView {
  ...
  update(t) {
    let e = this.markers;
    this.markers = bn(this.config.markers(t.view));
    ...
    return (
      !i.eq(this.markers, e, s.from, s.to) ||
...
class GutterElement {
  ...
  update(t, e, i, s) {
    ...
    Mn(this.markers, s) || this.setMarkers(t, s);
  }
  setMarkers(t, e) {
...
function kn(t, e) {
  return t.state.facet(Cn).formatNumber(e, t.state);
}
const Dn = pn.compute([Cn], (t) => ({
  ...
  lineMarker(t, e, i) {
    return i.some((t) => t.toDOM)
      ? null
      : new NumberMarker(kn(t, t.state.doc.lineAt(e.from).number));
  },
  widgetMarker: (t, e, i) => {
    for (let s of t.state.facet(Sn)) {
      let o = s(t, e, i);
      if (o) return o;
    }
    return null;
  },
  lineMarkerChange: (t) => t.startState.facet(Cn) != t.state.facet(Cn),
  initialSpacer(t) {
    return new NumberMarker(kn(t, On(t.state.doc.lines)));
  },
  updateSpacer(t, e) {
    let i = kn(e.view, On(e.view.state.doc.lines));
    return i == t.number ? t : new NumberMarker(i);
  },
  domEventHandlers: t.facet(Cn).domEventHandlers,
  side: "before",
}));
function An(t = {}) {
  return [Cn.of(t), wn(), Dn];
}
function On(t) {
  let e = 9;
  while (e < t) e = e * 10 + 9;
...
const Vn = dn.compute(["selection"], (t) => {
  let e = [],
    s = -1;
  for (let i of t.selection.ranges) {
    let o = t.doc.lineAt(i.head).from;
    if (o > s) {
      s = o;
      e.push(Tn.range(o));
    }
...
const Rn = Decoration.mark({ class: "cm-highlightTab" });
const Ln = Decoration.mark({ class: "cm-highlightSpace" });
const Pn = Bn(
  new MatchDecorator({
    regexp: /\t| /g,
    decoration: (t) => (t[0] == "\t" ? Rn : Ln),
    boundary: /\S/,
  }),
);
function Hn() {
...
const Fn = {
  ...
  computeOrder: jt,
  moveVisually: $t,
  clearHeightChangeFlag: ji,
  getHeightChangeFlag: () => Xi,
};
export {
  BidiSpan,
  BlockInfo,
  ...
  WidgetType,
  Fn as __test,
  $o as closeHoverTooltips,
  Vo as crosshairCursor,
  Ys as drawSelection,
  eo as dropCursor,
  rn as getDialog,
  Xs as getDrawSelectionConfig,
  tn as getPanel,
  jo as getTooltip,
  gn as gutter,
  dn as gutterLineClass,
  fn as gutterWidgetClass,
  wn as gutters,
  _o as hasHoverTooltips,
  vo as highlightActiveLine,
  En as highlightActiveLineGutter,
  co as highlightSpecialChars,
  Wn as highlightTrailingWhitespace,
  Hn as highlightWhitespace,
  Xo as hoverTooltip,
  Ts as keymap,
  Gs as layer,
  xn as lineNumberMarkers,
  Sn as lineNumberWidgetMarker,
  An as lineNumbers,
  fe as logException,
  Zo as panels,
  Mo as placeholder,
  Ao as rectangularSelection,
  Qo as repositionTooltips,
  Bs as runScopeHandlers,
  wo as scrollPastEnd,
  nn as showDialog,
  on as showPanel,
  zo as showTooltip,
