...
class Text {
  ...
  replace(t, e, n) {
    ...
    return TextNode.from(i, this.length - (e - t) + n.length);
  }
  append(t) {
...
class TextLeaf extends Text {
  ...
  decompose(t, e, s, r) {
    ...
    if (r & 1) {
      let t = s.pop();
      let e = n(o.text, t.text.slice(), 0, o.length);
      if (e.length <= 32) s.push(new TextLeaf(e, t.length + o.length));
      else {
        let t = e.length >> 1;
        s.push(new TextLeaf(e.slice(0, t)), new TextLeaf(e.slice(t)));
      }
    } else s.push(o);
  }
  replace(t, e, r) {
    if (!(r instanceof TextLeaf)) return super.replace(t, e, r);
    [t, e] = s(this, t, e);
    let o = n(this.text, n(r.text, i(this.text, 0, t)), e);
    let a = this.length + r.length - (e - t);
    return o.length <= 32
      ? new TextLeaf(o, a)
      : TextNode.from(TextLeaf.split(o, []), a);
  }
  ...
  static split(t, e) {
    ...
    for (let s of t) {
      ...
      i += s.length + 1;
      if (n.length == 32) {
        e.push(new TextLeaf(n, i));
        n = [];
        i = -1;
      }
    }
    i > -1 && e.push(new TextLeaf(n, i));
    return e;
  }
}
class TextNode extends Text {
  ...
  decompose(t, e, n, i) {
    for (let s = 0, r = 0; r <= e && s < this.children.length; s++) {
      let o = this.children[s],
        a = r + o.length;
      if (t <= a && e >= r) {
        let s = i & ((r <= t ? 1 : 0) | (a >= e ? 2 : 0));
        r >= t && a <= e && !s ? n.push(o) : o.decompose(t - r, e - r, n, s);
      }
      r = a + 1;
    }
  }
    ...
    if (n.lines < this.lines)
      for (let i = 0, s = 0; i < this.children.length; i++) {
        ...
        if (t >= s && e <= o) {
          ...
          let h = this.lines - r.lines + a.lines;
          if (a.lines < h >> 4 && a.lines > h >> 6) {
            let s = this.children.slice();
            s[i] = a;
            return new TextNode(s, this.length - (e - t) + n.length);
          }
  ...
  scanIdentical(t, e) {
    ...
    for (; ; i += e, s += e) {
      ...
      let a = this.children[i],
        h = t.children[s];
      if (a != h) return n + a.scanIdentical(h, e);
      n += a.length + 1;
    }
  }
  static from(t, e = t.reduce((t, e) => t + e.length + 1, -1)) {
    ...
    function c(t) {
      let e;
      if (t.lines > s && t instanceof TextNode) for (let e of t.children) c(e);
      else if (t.lines > r && (a > r || !a)) {
        f();
        o.push(t);
      } else if (
        t instanceof TextLeaf &&
        a &&
        (e = l[l.length - 1]) instanceof TextLeaf &&
        t.lines + e.lines <= 32
      ) {
        a += t.lines;
        h += t.length + 1;
        l[l.length - 1] = new TextLeaf(
    ...
    function f() {
      if (a != 0) {
        o.push(l.length == 1 ? l[0] : TextNode.from(l, h));
        h = -1;
        a = l.length = 0;
      }
    }
    for (let e of t) c(e);
    f();
    return o.length == 1 ? o[0] : new TextNode(o, e);
  }
}
...
function n(t, e, n = 0, i = 1e9) {
  for (let s = 0, r = 0, o = true; r < t.length && s <= i; r++) {
    let a = t[r],
      h = s + a.length;
    if (h >= n) {
      h > i && (a = a.slice(0, i - s));
  ...
  nextInner(t, e) {
    ...
    for (;;) {
      ...
      let i = this.nodes[n],
        s = this.offsets[n],
        r = s >> 1;
      let o = i instanceof TextLeaf ? i.text.length : i.children.length;
      if (r == (e > 0 ? o : 0)) {
        if (n == 0) {
          this.done = true;
          this.value = "";
...
function h(t, e) {
  ...
  if (!a(n) || e + 1 == t.length) return n;
  let i = t.charCodeAt(e + 1);
  return o(i) ? i - 56320 + ((n - 55296) << 10) + 65536 : n;
}
function l(t) {
  if (t <= 65535) return String.fromCharCode(t);
  t -= 65536;
  return String.fromCharCode(55296 + (t >> 10), 56320 + (t & 1023));
}
function c(t) {
  return t < 65536 ? 1 : 2;
}
...
class ChangeDesc {
  ...
  composeDesc(t) {
    return this.empty ? t : t.empty ? this : S(this, t);
  }
  mapDesc(t, e = false) {
    return t.empty ? this : m(this, t, e);
  }
  mapPos(t, e = -1, n = u.Simple) {
    let i = 0,
      s = 0;
  ...
  touchesRange(t, e = t) {
    for (let n = 0, i = 0; n < this.sections.length && i <= e; ) {
      let s = this.sections[n++],
        r = this.sections[n++],
        o = i + s;
      if (r >= 0 && i <= e && o >= t) return !(i < t && o > e) || "cover";
      i = o;
    }
    return false;
  }
...
class ChangeSet extends ChangeDesc {
  ...
  apply(t) {
    ...
    p(this, (e, n, i, s, r) => (t = t.replace(i, i + (n - e), r)), false);
    return t;
  }
  mapDesc(t, e = false) {
    return m(this, t, e, true);
  }
  invert(t) {
    ...
    for (let i = 0, s = 0; i < e.length; i += 2) {
      ...
      if (o >= 0) {
        ...
        e[i + 1] = r;
        let a = i >> 1;
        while (n.length < a) n.push(Text.empty);
  ...
  compose(t) {
    return this.empty ? t : t.empty ? this : S(this, t, true);
  }
  map(t, e = false) {
    return t.empty ? this : m(this, t, e, true);
  }
  ...
  filter(t) {
    ...
    t: for (let r = 0, o = 0; ; ) {
      ...
      while (o < h) {
        ...
        g(e, t, -1);
        g(i, t, s.ins == -1 ? -1 : s.off == 0 ? s.ins : 0);
        s.forward(t);
        o += t;
      }
    }
  ...
  static of(t, e, n) {
    ...
    function h(t) {
      if (Array.isArray(t)) for (let e of t) h(e);
      else if (t instanceof ChangeSet) {
        if (t.length != e)
          throw new RangeError(
        ...
        let { from: o, to: h = o, insert: l } = t;
        if (o > h || o < 0 || h > e)
          throw new RangeError(
            `Invalid change range ${o} to ${h} (in doc of length ${e})`,
          );
        let c = l
          ? typeof l == "string"
            ? Text.of(l.split(n || f))
...
function d(t, e, n) {
  ...
  if (i < t.length) t[t.length - 1] = t[t.length - 1].append(n);
    ...
    while (t.length < i) t.push(Text.empty);
    t.push(n);
  }
}
function p(t, e, n) {
  ...
  for (let s = 0, r = 0, o = 0; o < t.sections.length; ) {
    ...
    if (h < 0) {
      ...
      for (;;) {
        l += a;
        c += h;
        h && i && (f = f.append(i[(o - 2) >> 1]));
        if (n || o == t.sections.length || t.sections[o + 1] < 0) break;
        a = t.sections[o++];
        h = t.sections[o++];
      }
      e(s, l, r, c, f);
...
function m(t, e, n, i = false) {
  let s = [],
    r = i ? [] : null;
  let o = new SectionIter(t),
    a = new SectionIter(e);
  for (let t = -1; ; ) {
    ...
    if (o.ins == -1 && a.ins == -1) {
      ...
      (o.ins < 0 ||
        t == o.i ||
        (o.off == 0 && (a.len < o.len || (a.len == o.len && !n))))
    ) {
      let e = a.len;
      g(s, a.ins, -1);
      while (e) {
        let n = Math.min(o.len, e);
        if (o.ins >= 0 && t < o.i && o.len <= n) {
          g(s, 0, o.ins);
          r && d(r, s, o.text);
          t = o.i;
        }
      ...
      }
      {
        ...
        while (n)
          if (a.ins == -1) {
            ...
            if (!(a.ins == 0 && a.len < n)) break;
            n -= a.len;
            a.next();
          }
        g(s, e, t < o.i ? o.ins : 0);
        r && t < o.i && d(r, s, o.text);
        t = o.i;
        o.forward(o.len - n);
      }
    }
    ...
    if (r.ins == 0) {
      ...
      if (r.done || o.done) throw new Error("Mismatched change set lengths");
      {
        ...
        if (r.ins == -1) {
          ...
          g(i, r.off ? 0 : r.len, e, t);
          s && d(s, i, r.textBit(e));
        } else {
          g(i, r.off ? 0 : r.len, o.off ? 0 : o.ins, t);
          s && !o.off && d(s, i, o.text);
        }
        t = (r.ins > e || (o.ins >= 0 && o.len > e)) && (t || i.length > n);
        r.forward2(e);
        o.forward(e);
      }
    } else {
...
class SectionIter {
  ...
  textBit(t) {
    ...
    return n >= e.length && !t
      ? Text.empty
      : e[n].slice(this.off, t == null ? void 0 : this.off + t);
  }
  forward(t) {
...
class SelectionRange {
  ...
  map(t, e = -1) {
    let n, i;
    if (this.empty) n = i = t.mapPos(this.from, e);
    else {
  ...
  static create(t, e, n) {
    return new SelectionRange(t, e, n);
  }
}
class EditorSelection {
  ...
  static range(t, e, n, i) {
    ...
    return e < t
      ...
      : SelectionRange.create(t, e, (e > t ? 8 : 0) | s);
  }
  ...
  dynamicSlot(t) {
    ...
    for (let n of this.dependencies)
      n == "doc"
        ...
        : n == "selection"
          ? (h = true)
          : (((e = t[n.id]) !== null && e !== void 0 ? e : 1) & 1) == 0 &&
            l.push(t[n.id]);
    return {
      create(t) {
        t.values[r] = n(t);
      ...
      update(t, e) {
        if (
          ...
          let e = n(t);
          if (o ? !y(e, t.values[r], i) : !i(e, t.values[r])) {
            t.values[r] = e;
            return 1;
          }
        }
...
function E(t, e, n) {
  ...
  return {
    ...
    update(t, n) {
      if (!k(t, r)) return 0;
      let i = a(t);
      if (e.compare(i, t.values[o])) return 0;
      t.values[o] = i;
      return 1;
    },
    reconfigure(t, s) {
      let r = k(t, i);
      let h = s.config.facets[e.id],
        l = s.facet(e);
      if (h && !r && w(n, h)) {
        t.values[o] = l;
        return 0;
...
const T = Facet.define({ static: true });
class StateField {
  constructor(t, e, n, i, s) {
    this.id = t;
    this.createF = e;
  ...
  static define(t) {
    ...
    t.provide && (e.provides = t.provide(e));
    return e;
  }
  create(t) {
    let e = t.facet(T).find((t) => t.field == this);
    return ((e === null || e === void 0 ? void 0 : e.create) || this.createF)(
      t,
    );
  }
  slot(t) {
    ...
    return {
      ...
      reconfigure: (t, n) => {
        let i,
          ...
          r = n.facet(T);
        if (
          (i = s.find((t) => t.field == this)) &&
          i != r.find((t) => t.field == this)
        ) {
          t.values[e] = i.create(t);
          return 1;
        }
  ...
  init(t) {
    return [this, T.of({ field: this, create: t })];
  }
  get extension() {
    return this;
  }
}
const C = { lowest: 4, low: 3, default: 2, high: 1, highest: 0 };
function I(t) {
...
class Configuration {
  ...
  static resolve(t, e, n) {
    ...
    let l = n === null || n === void 0 ? void 0 : n.config.facets;
    for (let t in s) {
      let e = s[t],
        i = e[0].facet;
      let r = (l && l[t]) || [];
      if (e.every((t) => t.type == 0)) {
        o[i.id] = (a.length << 1) | 1;
        if (w(r, e)) a.push(n.facet(i));
        else {
          let t = i.combine(e.map((t) => t.value));
          a.push(n && i.compare(t, n.facet(i)) ? n.facet(i) : t);
        }
      } else {
        for (let t of e)
          if (t.type == 0) {
    ...
    let c = h.map((t) => t(o));
    return new Configuration(t, r, c, o, a, s);
  }
}
function P(t, e, n) {
  let i = [[], [], [], [], []];
  ...
  function r(t, o) {
    ...
    if (a != null) {
      ...
      let e = i[a].indexOf(t);
      e > -1 && i[a].splice(e, 1);
      t instanceof CompartmentInstance && n.delete(t.compartment);
    }
    s.set(t, o);
    if (Array.isArray(t)) for (let e of t) r(e, o);
      ...
      r(i, o);
    } else if (t instanceof PrecExtension) r(t.inner, t.prec);
    else if (t instanceof StateField) {
      i[o].push(t);
      t.provides && r(t.provides, o);
    } else if (t instanceof FacetProvider) {
      i[o].push(t);
      t.facet.extensions && r(t.facet.extensions, C.default);
    } else {
      let e = t.extension;
      if (!e)
        throw new Error(
...
const M = Facet.define();
const L = Facet.define({ combine: (t) => t.some((t) => t), static: true });
const F = Facet.define({
  combine: (t) => (t.length ? t[0] : void 0),
  static: true,
});
const O = Facet.define();
const N = Facet.define();
const D = Facet.define();
const B = Facet.define({ combine: (t) => !!t.length && t[0] });
class Annotation {
  constructor(t, e) {
    this.type = t;
    this.value = e;
  ...
  return {
    changes:
      e.changes instanceof ChangeSet
        ? e.changes
        : ChangeSet.of(e.changes || [], n, t.facet(F)),
    selection:
      i &&
...
function j(t, e, n) {
  let i = $(t, e.length ? e[0] : {}, t.doc.length);
  e.length && e[0].filter === false && (n = false);
  for (let s = 1; s < e.length; s++) {
    e[s].filter === false && (n = false);
    let r = !!e[s].sequential;
    i = V(i, $(t, e[s], r ? i.changes.newLength : t.doc.length), r);
  }
...
function z(t) {
  let e = t.startState;
  let n = true;
  for (let i of e.facet(O)) {
    let e = i(t);
    if (e === false) {
      n = false;
      break;
    }
    Array.isArray(e) && (n = n === true ? e : J(n, e));
  }
  if (n !== true) {
    let i, s;
    if (n === false) {
      s = t.changes.invertedDesc;
      i = ChangeSet.empty(e.doc.length);
    } else {
    ...
    t = Transaction.create(
      ...
      StateEffect.mapEffects(t.effects, s),
      t.annotations,
      t.scrollIntoView,
    );
  }
...
function q(t) {
  ...
  for (let s = n.length - 1; s >= 0; s--) {
    ...
    r &&
      ...
      (i = V(i, $(e, r, t.changes.newLength), true));
  }
  return i == t
    ? t
    : Transaction.create(
...
const _ = [];
function H(t) {
  return t == null ? _ : Array.isArray(t) ? t : [t];
}
var W = (function (t) {
  t[(t.Word = 0)] = "Word";
  t[(t.Space = 1)] = "Space";
...
let G;
try {
  G = new RegExp("[\\p{Alphabetic}\\p{Number}_]", "u");
} catch (t) {}
function K(t) {
  if (G) return G.test(t);
  for (let e = 0; e < t.length; e++) {
    let n = t[e];
    if (
      /\w/.test(n) ||
      (n > "" && (n.toUpperCase() != n.toLowerCase() || U.test(n)))
    )
      return true;
  }
  return false;
...
function Q(t) {
  return (e) => {
    if (!/\S/.test(e)) return W.Space;
    if (K(e)) return W.Word;
    for (let n = 0; n < t.length; n++) if (e.indexOf(t[n]) > -1) return W.Word;
    return W.Other;
  };
}
class EditorState {
  constructor(t, e, n, i, s, r) {
    ...
    this.computeSlot = s;
    r && (r._state = this);
    for (let t = 0; t < this.config.dynamicSlots.length; t++) b(this, t << 1);
  ...
  applyTransaction(t) {
    ...
    for (let s of t.effects)
      if (s.is(Compartment.reconfigure)) {
        ...
        e = null;
        n = H(n).concat(s.value);
      }
    let s;
    if (e) s = t.startState.values.slice();
    else {
      e = Configuration.resolve(n, i, this);
      let t = new EditorState(
        e,
        this.doc,
        this.selection,
    ...
    let r = t.startState.facet(L) ? t.newSelection : t.newSelection.asSingle();
    new EditorState(e, t.newDoc, r, s, (e, n) => n.update(e, t), t);
  }
  replaceSelection(t) {
  ...
  changeByRange(t) {
    ...
    for (let n = 1; n < e.ranges.length; n++) {
      let o = t(e.ranges[n]);
      let a = this.changes(o.changes),
        h = a.map(i);
      for (let t = 0; t < n; t++) s[t] = s[t].map(h);
      let l = i.mapDesc(a, true);
      s.push(o.range.map(l));
      i = i.compose(h);
  ...
  changes(t = []) {
    return t instanceof ChangeSet
      ? t
      : ChangeSet.of(t, this.doc.length, this.facet(EditorState.lineSeparator));
  }
  toText(t) {
    return Text.of(t.split(this.facet(EditorState.lineSeparator) || f));
  }
  ...
  static create(t = {}) {
    ...
    let n =
      t.doc instanceof Text
        ? t.doc
        : Text.of(
            (t.doc || "").split(e.staticFacet(EditorState.lineSeparator) || f),
          );
    let i = t.selection
  ...
  wordAt(t) {
    ...
    while (o > 0) {
      let t = r(e, o, false);
      if (s(e.slice(t, o)) != W.Word) break;
      o = t;
    }
    while (a < i) {
      let t = r(e, a);
      if (s(e.slice(a, t)) != W.Word) break;
      a = t;
    }
    return o == a ? null : EditorSelection.range(o + n, a + n);
  }
}
EditorState.allowMultipleSelections = L;
EditorState.tabSize = Facet.define({ combine: (t) => (t.length ? t[0] : 4) });
EditorState.lineSeparator = F;
EditorState.readOnly = B;
...
EditorState.languageData = M;
EditorState.changeFilter = O;
EditorState.transactionFilter = N;
EditorState.transactionExtender = D;
...
function X(t, e, n = {}) {
  ...
  for (let t in e) i[t] === void 0 && (i[t] = e[t]);
  return i;
}
class RangeValue {
  eq(t) {
...
RangeValue.prototype.mapMode = u.TrackDel;
function Y(t, e) {
...
class Chunk {
  ...
  findIndex(t, e, n, i = 0) {
    ...
    for (let r = i, o = s.length; ; ) {
      ...
      let i = (r + o) >> 1;
      let a =
        s[i] - t || (n ? this.value[i].endSide : this.value[i].startSide) - e;
  ...
  map(t, e) {
    ...
    for (let a = 0; a < this.value.length; a++) {
      let h,
        ...
        u = this.to[a] + t;
      if (f == u) {
        let t = e.mapPos(f, c.startSide, c.mapMode);
        if (t == null) continue;
        h = l = t;
        if (c.startSide != c.endSide) {
          l = e.mapPos(f, c.endSide);
          if (l < h) continue;
        }
      } else {
        h = e.mapPos(f, c.startSide);
        l = e.mapPos(u, c.endSide);
        if (h > l || (h == l && c.startSide > 0 && c.endSide <= 0)) continue;
      }
      if (!((l - h || c.endSide - c.startSide) < 0)) {
        r < 0 && (r = h);
        c.point && (o = Math.max(o, l - h));
        n.push(c);
        i.push(h - r);
        s.push(l - r);
      }
...
class RangeSet {
  ...
  update(t) {
    ...
    n && (e = e.slice().sort(Z));
    if (this.isEmpty) return e.length ? RangeSet.of(e) : this;
    let o = new LayerCursor(this, null, -1).goto(0),
      a = 0,
      h = [];
    let l = new RangeSetBuilder();
    while (o.value || a < e.length)
      if (
        a < e.length &&
        (o.from - e[a].from || o.startSide - e[a].value.startSide) >= 0
      ) {
        let t = e[a++];
        l.addInner(t.from, t.to, t.value) || h.push(t);
      } else if (
        o.rangeIndex == 1 &&
        ...
        l.addChunk(this.chunkPos[o.chunkIndex], this.chunk[o.chunkIndex])
      )
        o.nextChunk();
      else {
        (!r || i > o.to || s < o.from || r(o.from, o.to, o.value)) &&
          (l.addInner(o.from, o.to, o.value) ||
  ...
  map(t) {
    ...
    for (let s = 0; s < this.chunk.length; s++) {
      let r = this.chunkPos[s],
        o = this.chunk[s];
      let a = t.touchesRange(r, r + o.length);
      if (a === false) {
    ...
    return e.length == 0 ? s : new RangeSet(n, e, s || RangeSet.empty, i);
  }
  between(t, e, n) {
    if (!this.isEmpty) {
  ...
  static compare(t, e, n, i, s = -1) {
    ...
    let o = e.filter((t) => t.maxPoint > 0 || (!t.isEmpty && t.maxPoint >= s));
    let a = et(r, o, n);
    let h = new SpanCursor(r, a, s);
    let l = new SpanCursor(o, a, s);
    n.iterGaps((t, e, n) => it(h, t, l, e, n, i));
    n.empty && n.length == 0 && it(h, 0, l, 0, 0, i);
  }
  static eq(t, e, n = 0, i) {
    i == null && (i = 999999999);
    ...
    let o = et(s, r);
    let a = new SpanCursor(s, o, 0).goto(n),
      h = new SpanCursor(r, o, 0).goto(n);
    for (;;) {
      if (
        a.to != h.to ||
        !st(a.active, h.active) ||
        (a.point && (!h.point || !Y(a.point, h.point)))
      )
        return false;
      if (a.to > i) return true;
      a.next();
      h.next();
    }
  }
  ...
  static of(t, e = false) {
    ...
    for (let i of t instanceof Range ? [t] : e ? tt(t) : t)
...
function tt(t) {
  if (t.length > 1)
    for (let e = t[0], n = 1; n < t.length; n++) {
      let i = t[n];
      if (Z(e, i) > 0) return t.slice().sort(Z);
      e = i;
    }
  return t;
}
...
class RangeSetBuilder {
  ...
  add(t, e, n) {
    this.addInner(t, e, n) ||
      (this.nextLayer || (this.nextLayer = new RangeSetBuilder())).add(t, e, n);
  }
  addInner(t, e, n) {
  ...
  for (let t of e)
    for (let e = 0; e < t.chunk.length; e++) {
      ...
      r == null ||
        ...
        (n === null || n === void 0
          ? void 0
          : n.touchesRange(r, r + t.chunk[e].length)) ||
        s.add(t.chunk[e]);
    }
  return s;
}
...
class HeapCursor {
  ...
  goto(t, e = -1e9) {
    ...
    for (let t = this.heap.length >> 1; t >= 0; t--) nt(this.heap, t);
    this.next();
    return this;
  }
  forward(t, e) {
...
class SpanCursor {
  ...
  removeActive(t) {
    ...
    this.minActive = at(this.active, this.activeTo);
  }
  addActive(t) {
    let e = 0,
    ...
    while (
      ...
      e++;
    ot(this.active, e, n);
    ot(this.activeTo, e, i);
    ot(this.activeRank, e, s);
    t && ot(t, e, this.cursor.from);
    this.minActive = at(this.active, this.activeTo);
  }
  next() {
    let t = this.to,
...
function it(t, e, n, i, s, r) {
  ...
  for (let e = false; ; ) {
    ...
    let c = s < 0 ? t.to + h : n.to,
      f = Math.min(c, o);
    let u = t.point || n.point;
    if (u) {
      (t.point &&
        n.point &&
        Y(t.point, n.point) &&
        st(t.activeForPoint(t.to), n.activeForPoint(n.to))) ||
        r.comparePoint(a, f, t.point, n.point);
      e = false;
    } else {
      e && r.boundChange(a);
      f > a &&
        !st(t.active, n.active) &&
        r.compareRange(a, f, t.active, n.active);
      l && f < o && (i || t.openEnd(c) != n.openEnd(c)) && (e = true);
    }
    if (c > o) break;
    a = c;
    s <= 0 && t.next();
...
function st(t, e) {
  ...
  for (let n = 0; n < t.length; n++)
    if (t[n] != e[n] && !Y(t[n], e[n])) return false;
  return true;
}
function rt(t, e) {
